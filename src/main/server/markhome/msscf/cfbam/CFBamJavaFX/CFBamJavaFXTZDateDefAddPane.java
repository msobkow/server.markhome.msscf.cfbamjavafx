// Description: Java 11 JavaFX Add Pane implementation for TZDateDef.
...
/**
 *	CFBamJavaFXTZDateDefAddPane JavaFX Add Pane implementation
 *	for TZDateDef.
 */
public class CFBamJavaFXTZDateDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTZDateDefPaneCommon
{
	...
	public CFBamJavaFXTZDateDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
