// Description: Java 11 JavaFX Element TabPane implementation for DateCol.
...
/**
 *	CFBamJavaFXDateColEltTabPane JavaFX Element TabPane implementation
 *	for DateCol.
 */
public class CFBamJavaFXDateColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDateColPaneCommon
{
	...
	public CFBamJavaFXDateColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDateColObj focus = (ICFBamDateColObj)getJavaFXFocusAsDateCol();
			if( focus != null ) {
