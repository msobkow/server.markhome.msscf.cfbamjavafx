// Description: Java 11 JavaFX Element TabPane implementation for TextType.
...
/**
 *	CFBamJavaFXTextTypeEltTabPane JavaFX Element TabPane implementation
 *	for TextType.
 */
public class CFBamJavaFXTextTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTextTypePaneCommon
{
	...
	public CFBamJavaFXTextTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTextTypeObj focus = (ICFBamTextTypeObj)getJavaFXFocusAsTextType();
			if( focus != null ) {
