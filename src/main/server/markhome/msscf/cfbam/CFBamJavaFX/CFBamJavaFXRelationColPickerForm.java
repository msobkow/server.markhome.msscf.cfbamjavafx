// Description: Java 11 JavaFX Picker Form implementation for RelationCol.
...
/**
 *	CFBamJavaFXRelationColPickerForm JavaFX Picker Form implementation
 *	for RelationCol.
 */
public class CFBamJavaFXRelationColPickerForm
	...
	ICFForm
{
	...
	public CFBamJavaFXRelationColPickerForm( ICFFormManager formManager,
		...
		ICFBamJavaFXRelationColChosen whenChosen )
	{
		...
		javafxPickerPane = argSchema.getRelationColFactory().newPickerPane( cfFormManager, argFocus, argContainer, argDataCollection, whenChosen );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXRelationColPaneCommon)javafxPickerPane).setJavaFXFocus( (ICFBamRelationColObj)value );
	}
	...
	public Collection<ICFBamRelationColObj> getJavaFXDataCollection() {
		ICFBamJavaFXRelationColPaneList jplPicker = (ICFBamJavaFXRelationColPaneList)javafxPickerPane;
		Collection<ICFBamRelationColObj> cltn = jplPicker.getJavaFXDataCollection();
		return( cltn );
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( javafxPickerPane != null ) {
			ICFBamJavaFXRelationColPaneCommon jpanelCommon = (ICFBamJavaFXRelationColPaneCommon)javafxPickerPane;
