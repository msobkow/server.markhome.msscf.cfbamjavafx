// Description: Java 11 JavaFX Ask Delete Pane implementation for EnumTag.
...
/**
 *	CFBamJavaFXEnumTagAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for EnumTag.
 */
public class CFBamJavaFXEnumTagAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXEnumTagPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete EnumTag";
	...
	public CFBamJavaFXEnumTagAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this EnumTag?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamEnumTagObj obj = getJavaFXFocusAsEnumTag();
					ICFBamEnumTagEditObj editObj = (ICFBamEnumTagEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsEnumTag( ICFBamEnumTagObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXEnumTagPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXEnumTagPaneCommon)attrPane).setPaneMode( value );
		}
	}
