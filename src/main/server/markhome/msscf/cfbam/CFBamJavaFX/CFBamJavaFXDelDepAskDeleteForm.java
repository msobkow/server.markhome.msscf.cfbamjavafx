// Description: Java 11 JavaFX Ask Delete Pane implementation for DelDep.
...
/**
 *	CFBamJavaFXDelDepAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DelDep.
 */
public class CFBamJavaFXDelDepAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDelDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DelDep";
	...
	public CFBamJavaFXDelDepAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelDepObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DelDep?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDelDepObj obj = getJavaFXFocusAsDelDep();
					ICFBamDelDepEditObj editObj = (ICFBamDelDepEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsDelDep( ICFBamDelDepObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDelDepPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
