// Description: Java 11 JavaFX Ask Delete Pane implementation for StringDef.
...
/**
 *	CFBamJavaFXStringDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for StringDef.
 */
public class CFBamJavaFXStringDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXStringDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete StringDef";
	...
	public CFBamJavaFXStringDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this StringDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamStringDefObj obj = getJavaFXFocusAsStringDef();
					ICFBamStringDefEditObj editObj = (ICFBamStringDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsStringDef( ICFBamStringDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXStringDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXStringDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
