// Description: Java 11 JavaFX Add Pane implementation for NmTokenCol.
...
/**
 *	CFBamJavaFXNmTokenColAddPane JavaFX Add Pane implementation
 *	for NmTokenCol.
 */
public class CFBamJavaFXNmTokenColAddPane
extends CFSplitPane
implements ICFBamJavaFXNmTokenColPaneCommon
{
	...
	public CFBamJavaFXNmTokenColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
