// Description: Java 11 JavaFX Ask Delete Pane implementation for BlobType.
...
/**
 *	CFBamJavaFXBlobTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for BlobType.
 */
public class CFBamJavaFXBlobTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXBlobTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete BlobType";
	...
	public CFBamJavaFXBlobTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this BlobType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamBlobTypeObj obj = getJavaFXFocusAsBlobType();
					ICFBamBlobTypeEditObj editObj = (ICFBamBlobTypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getBlobTypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsBlobType( ICFBamBlobTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXBlobTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXBlobTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
