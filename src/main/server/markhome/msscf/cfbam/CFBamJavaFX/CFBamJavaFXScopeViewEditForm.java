// Description: Java 11 JavaFX View/Edit Form implementation for Scope.
...
/**
 *	CFBamJavaFXScopeViewEditForm JavaFX View/Edit Form implementation
 *	for Scope.
 */
public class CFBamJavaFXScopeViewEditForm
extends CFBorderPane
implements ICFBamJavaFXScopePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Scope";
	...
	public CFBamJavaFXScopeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamScopeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getScopeFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamScopeObj focus = getJavaFXFocusAsScope();
		if( focus != null ) {
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXScopePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsScope() != null ) {
							if( null == getJavaFXFocusAsScope().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXScopePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXScopePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
