// Description: Java 11 JavaFX Add Form implementation for BoolType.
...
/**
 *	CFBamJavaFXBoolTypeAddForm JavaFX Add Form implementation
 *	for BoolType.
 */
public class CFBamJavaFXBoolTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXBoolTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add BoolType";
	...
	public CFBamJavaFXBoolTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getBoolTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXBoolTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getBoolTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBoolTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
