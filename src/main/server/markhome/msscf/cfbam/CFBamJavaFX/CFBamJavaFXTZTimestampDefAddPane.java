// Description: Java 11 JavaFX Add Pane implementation for TZTimestampDef.
...
/**
 *	CFBamJavaFXTZTimestampDefAddPane JavaFX Add Pane implementation
 *	for TZTimestampDef.
 */
public class CFBamJavaFXTZTimestampDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTZTimestampDefPaneCommon
{
	...
	public CFBamJavaFXTZTimestampDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
