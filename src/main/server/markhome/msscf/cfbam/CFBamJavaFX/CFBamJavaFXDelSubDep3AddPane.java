// Description: Java 11 JavaFX Add Pane implementation for DelSubDep3.
...
/**
 *	CFBamJavaFXDelSubDep3AddPane JavaFX Add Pane implementation
 *	for DelSubDep3.
 */
public class CFBamJavaFXDelSubDep3AddPane
extends CFSplitPane
implements ICFBamJavaFXDelSubDep3PaneCommon
{
	...
	public CFBamJavaFXDelSubDep3AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep3Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep3PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
