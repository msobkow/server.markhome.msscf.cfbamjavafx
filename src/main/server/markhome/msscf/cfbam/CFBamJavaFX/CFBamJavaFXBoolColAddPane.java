// Description: Java 11 JavaFX Add Pane implementation for BoolCol.
...
/**
 *	CFBamJavaFXBoolColAddPane JavaFX Add Pane implementation
 *	for BoolCol.
 */
public class CFBamJavaFXBoolColAddPane
extends CFSplitPane
implements ICFBamJavaFXBoolColPaneCommon
{
	...
	public CFBamJavaFXBoolColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
