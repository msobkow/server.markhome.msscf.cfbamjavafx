// Description: Java 11 JavaFX View/Edit Pane implementation for NmTokensDef.
...
/**
 *	CFBamJavaFXNmTokensDefViewEditPane JavaFX View/Edit Pane implementation
 *	for NmTokensDef.
 */
public class CFBamJavaFXNmTokensDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNmTokensDefPaneCommon
{
	...
	public CFBamJavaFXNmTokensDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
