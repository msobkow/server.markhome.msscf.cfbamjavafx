// Description: Java 11 JavaFX Ask Delete Pane implementation for Chain.
...
/**
 *	CFBamJavaFXChainAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Chain.
 */
public class CFBamJavaFXChainAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXChainPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Chain";
	...
	public CFBamJavaFXChainAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamChainObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Chain?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamChainObj obj = getJavaFXFocusAsChain();
					ICFBamChainEditObj editObj = (ICFBamChainEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsChain( ICFBamChainObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXChainPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXChainPaneCommon)attrPane).setPaneMode( value );
		}
	}
