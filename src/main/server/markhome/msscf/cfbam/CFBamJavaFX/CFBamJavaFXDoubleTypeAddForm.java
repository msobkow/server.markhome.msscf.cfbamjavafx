// Description: Java 11 JavaFX Add Form implementation for DoubleType.
...
/**
 *	CFBamJavaFXDoubleTypeAddForm JavaFX Add Form implementation
 *	for DoubleType.
 */
public class CFBamJavaFXDoubleTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXDoubleTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DoubleType";
	...
	public CFBamJavaFXDoubleTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDoubleTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDoubleTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDoubleTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDoubleTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
