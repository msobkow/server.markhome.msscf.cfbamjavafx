// Description: Java 11 JavaFX Add Pane implementation for TextCol.
...
/**
 *	CFBamJavaFXTextColAddPane JavaFX Add Pane implementation
 *	for TextCol.
 */
public class CFBamJavaFXTextColAddPane
extends CFSplitPane
implements ICFBamJavaFXTextColPaneCommon
{
	...
	public CFBamJavaFXTextColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
