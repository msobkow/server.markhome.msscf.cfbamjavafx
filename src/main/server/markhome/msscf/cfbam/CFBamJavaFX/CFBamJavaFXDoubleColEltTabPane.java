// Description: Java 11 JavaFX Element TabPane implementation for DoubleCol.
...
/**
 *	CFBamJavaFXDoubleColEltTabPane JavaFX Element TabPane implementation
 *	for DoubleCol.
 */
public class CFBamJavaFXDoubleColEltTabPane
extends CFTabPane
implements ICFBamJavaFXDoubleColPaneCommon
{
	...
	public CFBamJavaFXDoubleColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDoubleColObj focus = (ICFBamDoubleColObj)getJavaFXFocusAsDoubleCol();
			if( focus != null ) {
