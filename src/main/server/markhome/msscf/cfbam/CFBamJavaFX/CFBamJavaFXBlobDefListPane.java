// Description: Java 11 JavaFX List of Obj Pane implementation for BlobDef.
...
/**
 *	CFBamJavaFXBlobDefListPane JavaFX List of Obj Pane implementation
 *	for BlobDef.
 */
public class CFBamJavaFXBlobDefListPane
extends CFBorderPane
implements ICFBamJavaFXBlobDefPaneList
{
	public static String S_FormName = "List BlobDef";
	...
	public CFBamJavaFXBlobDefListPane( ICFFormManager formManager,
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							...
							if( "a80b".equals( classCode ) ) {
								CFBorderPane frame = javafxSchema.getBlobDefFactory().newViewEditForm( cfFormManager, selectedInstance, getViewEditClosedCallback(), false );
				...
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						if( selectedInstance != null ) {
							String classCode = selectedInstance.getClassCode();
							if( "a80b".equals( classCode ) ) {
								CFBorderPane frame = javafxSchema.getBlobDefFactory().newAskDeleteForm( cfFormManager, selectedInstance, getDeleteCallback() );
								((ICFBamJavaFXBlobDefPaneCommon)frame).setPaneMode( CFPane.PaneMode.View );
								cfFormManager.pushForm( frame );
							}
							else if( "a80c".equals( classCode ) ) {
