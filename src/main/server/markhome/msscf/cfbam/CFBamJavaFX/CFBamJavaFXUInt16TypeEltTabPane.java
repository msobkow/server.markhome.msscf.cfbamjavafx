// Description: Java 11 JavaFX Element TabPane implementation for UInt16Type.
...
/**
 *	CFBamJavaFXUInt16TypeEltTabPane JavaFX Element TabPane implementation
 *	for UInt16Type.
 */
public class CFBamJavaFXUInt16TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt16TypePaneCommon
{
	...
	public CFBamJavaFXUInt16TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt16TypeObj focus = (ICFBamUInt16TypeObj)getJavaFXFocusAsUInt16Type();
			if( focus != null ) {
