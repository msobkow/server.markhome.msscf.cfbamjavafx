// Description: Java 11 JavaFX Ask Delete Pane implementation for TZDateCol.
...
/**
 *	CFBamJavaFXTZDateColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZDateCol.
 */
public class CFBamJavaFXTZDateColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZDateColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZDateCol";
	...
	public CFBamJavaFXTZDateColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZDateCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZDateColObj obj = getJavaFXFocusAsTZDateCol();
					ICFBamTZDateColEditObj editObj = (ICFBamTZDateColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZDateCol( ICFBamTZDateColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZDateColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
