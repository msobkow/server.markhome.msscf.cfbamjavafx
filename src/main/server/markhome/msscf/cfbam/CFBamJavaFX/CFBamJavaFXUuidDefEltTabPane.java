// Description: Java 11 JavaFX Element TabPane implementation for UuidDef.
...
/**
 *	CFBamJavaFXUuidDefEltTabPane JavaFX Element TabPane implementation
 *	for UuidDef.
 */
public class CFBamJavaFXUuidDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuidDefPaneCommon
{
	...
	public CFBamJavaFXUuidDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuidDefObj focus = (ICFBamUuidDefObj)getJavaFXFocusAsUuidDef();
			if( focus != null ) {
