// Description: Java 11 JavaFX View/Edit Pane implementation for DelSubDep1.
...
/**
 *	CFBamJavaFXDelSubDep1ViewEditPane JavaFX View/Edit Pane implementation
 *	for DelSubDep1.
 */
public class CFBamJavaFXDelSubDep1ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDelSubDep1PaneCommon
{
	...
	public CFBamJavaFXDelSubDep1ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep1Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep1PaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep1PaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep1PaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
