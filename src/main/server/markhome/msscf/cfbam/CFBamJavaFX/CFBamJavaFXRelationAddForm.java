// Description: Java 11 JavaFX Add Form implementation for Relation.
...
/**
 *	CFBamJavaFXRelationAddForm JavaFX Add Form implementation
 *	for Relation.
 */
public class CFBamJavaFXRelationAddForm
extends CFBorderPane
implements ICFBamJavaFXRelationPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Relation";
	...
	public CFBamJavaFXRelationAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getRelationFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXRelationPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getRelationFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXRelationPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
