// Description: Java 11 JavaFX View/Edit Pane implementation for BlobDef.
...
/**
 *	CFBamJavaFXBlobDefViewEditPane JavaFX View/Edit Pane implementation
 *	for BlobDef.
 */
public class CFBamJavaFXBlobDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXBlobDefPaneCommon
{
	...
	public CFBamJavaFXBlobDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobDefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getBlobDefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBlobDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXBlobDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
