// Description: Java 11 JavaFX View/Edit Form implementation for DelSubDep3.
...
/**
 *	CFBamJavaFXDelSubDep3ViewEditForm JavaFX View/Edit Form implementation
 *	for DelSubDep3.
 */
public class CFBamJavaFXDelSubDep3ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DelSubDep3";
	...
	public CFBamJavaFXDelSubDep3ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep3Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getDelSubDep3Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamDelSubDep3Obj focus = getJavaFXFocusAsDelSubDep3();
		if( focus != null ) {
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelSubDep3PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDelSubDep3() != null ) {
							if( null == getJavaFXFocusAsDelSubDep3().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsDelSubDep3();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep3PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep3PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
