// Description: Java 11 JavaFX Ask Delete Pane implementation for PopTopDep.
...
/**
 *	CFBamJavaFXPopTopDepAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for PopTopDep.
 */
public class CFBamJavaFXPopTopDepAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXPopTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete PopTopDep";
	...
	public CFBamJavaFXPopTopDepAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopTopDepObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this PopTopDep?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamPopTopDepObj obj = getJavaFXFocusAsPopTopDep();
					ICFBamPopTopDepEditObj editObj = (ICFBamPopTopDepEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsPopTopDep( ICFBamPopTopDepObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXPopTopDepPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXPopTopDepPaneCommon)attrPane).setPaneMode( value );
		}
	}
