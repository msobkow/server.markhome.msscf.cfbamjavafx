// Description: Java 11 JavaFX Element TabPane implementation for UInt64Def.
...
/**
 *	CFBamJavaFXUInt64DefEltTabPane JavaFX Element TabPane implementation
 *	for UInt64Def.
 */
public class CFBamJavaFXUInt64DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt64DefPaneCommon
{
	...
	public CFBamJavaFXUInt64DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt64DefObj focus = (ICFBamUInt64DefObj)getJavaFXFocusAsUInt64Def();
			if( focus != null ) {
