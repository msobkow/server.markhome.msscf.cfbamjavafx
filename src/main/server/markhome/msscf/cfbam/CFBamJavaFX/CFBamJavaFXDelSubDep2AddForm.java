// Description: Java 11 JavaFX Add Form implementation for DelSubDep2.
...
/**
 *	CFBamJavaFXDelSubDep2AddForm JavaFX Add Form implementation
 *	for DelSubDep2.
 */
public class CFBamJavaFXDelSubDep2AddForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DelSubDep2";
	...
	public CFBamJavaFXDelSubDep2AddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep2Obj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDelSubDep2Factory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelSubDep2PaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDelSubDep2Factory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep2PaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep2PaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
