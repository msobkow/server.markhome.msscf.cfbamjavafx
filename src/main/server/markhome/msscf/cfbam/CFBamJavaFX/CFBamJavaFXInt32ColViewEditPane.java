// Description: Java 11 JavaFX View/Edit Pane implementation for Int32Col.
...
/**
 *	CFBamJavaFXInt32ColViewEditPane JavaFX View/Edit Pane implementation
 *	for Int32Col.
 */
public class CFBamJavaFXInt32ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt32ColPaneCommon
{
	...
	public CFBamJavaFXInt32ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getInt32ColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32ColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt32ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt32ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
