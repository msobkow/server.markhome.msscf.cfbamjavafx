// Description: Java 11 JavaFX Add Pane implementation for UuidGen.
...
/**
 *	CFBamJavaFXUuidGenAddPane JavaFX Add Pane implementation
 *	for UuidGen.
 */
public class CFBamJavaFXUuidGenAddPane
extends CFSplitPane
implements ICFBamJavaFXUuidGenPaneCommon
{
	...
	public CFBamJavaFXUuidGenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidGenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidGenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
