// Description: Java 11 JavaFX Add Form implementation for TZDateType.
...
/**
 *	CFBamJavaFXTZDateTypeAddForm JavaFX Add Form implementation
 *	for TZDateType.
 */
public class CFBamJavaFXTZDateTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXTZDateTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZDateType";
	...
	public CFBamJavaFXTZDateTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZDateTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZDateTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZDateTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
