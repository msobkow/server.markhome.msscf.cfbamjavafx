// Description: Java 11 JavaFX Add Form implementation for PopTopDep.
...
/**
 *	CFBamJavaFXPopTopDepAddForm JavaFX Add Form implementation
 *	for PopTopDep.
 */
public class CFBamJavaFXPopTopDepAddForm
extends CFBorderPane
implements ICFBamJavaFXPopTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add PopTopDep";
	...
	public CFBamJavaFXPopTopDepAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getPopTopDepFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXPopTopDepPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getPopTopDepFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopTopDepPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopTopDepPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
