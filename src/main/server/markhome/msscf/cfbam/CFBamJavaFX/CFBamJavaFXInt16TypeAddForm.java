// Description: Java 11 JavaFX Add Form implementation for Int16Type.
...
/**
 *	CFBamJavaFXInt16TypeAddForm JavaFX Add Form implementation
 *	for Int16Type.
 */
public class CFBamJavaFXInt16TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXInt16TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int16Type";
	...
	public CFBamJavaFXInt16TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt16TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt16TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt16TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt16TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
