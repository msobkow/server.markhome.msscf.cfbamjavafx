// Description: Java 11 JavaFX Add Pane implementation for ClearSubDep1.
...
/**
 *	CFBamJavaFXClearSubDep1AddPane JavaFX Add Pane implementation
 *	for ClearSubDep1.
 */
public class CFBamJavaFXClearSubDep1AddPane
extends CFSplitPane
implements ICFBamJavaFXClearSubDep1PaneCommon
{
	...
	public CFBamJavaFXClearSubDep1AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep1Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep1PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
