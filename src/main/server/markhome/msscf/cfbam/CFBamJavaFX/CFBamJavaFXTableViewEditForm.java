// Description: Java 11 JavaFX View/Edit Form implementation for Table.
...
/**
 *	CFBamJavaFXTableViewEditForm JavaFX View/Edit Form implementation
 *	for Table.
 */
public class CFBamJavaFXTableViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTablePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Table";
	...
	public CFBamJavaFXTableViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTableObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getTableFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTablePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamTableObj argFocus = (ICFBamTableObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTableObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTable() != null ) {
							if( null == getJavaFXFocusAsTable().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTablePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTablePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
