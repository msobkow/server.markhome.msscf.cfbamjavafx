// Description: Java 11 JavaFX Add Pane implementation for SchemaDef.
...
/**
 *	CFBamJavaFXSchemaDefAddPane JavaFX Add Pane implementation
 *	for SchemaDef.
 */
public class CFBamJavaFXSchemaDefAddPane
extends CFSplitPane
implements ICFBamJavaFXSchemaDefPaneCommon
{
	...
	public CFBamJavaFXSchemaDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
