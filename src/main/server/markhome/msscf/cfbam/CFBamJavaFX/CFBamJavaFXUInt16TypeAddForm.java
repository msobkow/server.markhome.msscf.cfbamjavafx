// Description: Java 11 JavaFX Add Form implementation for UInt16Type.
...
/**
 *	CFBamJavaFXUInt16TypeAddForm JavaFX Add Form implementation
 *	for UInt16Type.
 */
public class CFBamJavaFXUInt16TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXUInt16TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UInt16Type";
	...
	public CFBamJavaFXUInt16TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUInt16TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt16TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUInt16TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt16TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
