// Description: Java 11 JavaFX Add Pane implementation for SchemaRef.
...
/**
 *	CFBamJavaFXSchemaRefAddPane JavaFX Add Pane implementation
 *	for SchemaRef.
 */
public class CFBamJavaFXSchemaRefAddPane
extends CFSplitPane
implements ICFBamJavaFXSchemaRefPaneCommon
{
	...
	public CFBamJavaFXSchemaRefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaRefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
