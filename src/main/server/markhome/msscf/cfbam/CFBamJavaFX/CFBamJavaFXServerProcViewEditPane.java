// Description: Java 11 JavaFX View/Edit Pane implementation for ServerProc.
...
/**
 *	CFBamJavaFXServerProcViewEditPane JavaFX View/Edit Pane implementation
 *	for ServerProc.
 */
public class CFBamJavaFXServerProcViewEditPane
extends CFSplitPane
implements ICFBamJavaFXServerProcPaneCommon
{
	...
	public CFBamJavaFXServerProcViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerProcObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerProcPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerProcPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXServerProcPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
