// Description: Java 11 JavaFX Element TabPane implementation for TokenType.
...
/**
 *	CFBamJavaFXTokenTypeEltTabPane JavaFX Element TabPane implementation
 *	for TokenType.
 */
public class CFBamJavaFXTokenTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTokenTypePaneCommon
{
	...
	public CFBamJavaFXTokenTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTokenTypeObj focus = (ICFBamTokenTypeObj)getJavaFXFocusAsTokenType();
			if( focus != null ) {
