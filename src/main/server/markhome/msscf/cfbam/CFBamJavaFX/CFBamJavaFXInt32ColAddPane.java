// Description: Java 11 JavaFX Add Pane implementation for Int32Col.
...
/**
 *	CFBamJavaFXInt32ColAddPane JavaFX Add Pane implementation
 *	for Int32Col.
 */
public class CFBamJavaFXInt32ColAddPane
extends CFSplitPane
implements ICFBamJavaFXInt32ColPaneCommon
{
	...
	public CFBamJavaFXInt32ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
