// Description: Java 11 JavaFX Ask Delete Pane implementation for Int16Type.
...
/**
 *	CFBamJavaFXInt16TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int16Type.
 */
public class CFBamJavaFXInt16TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt16TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int16Type";
	...
	public CFBamJavaFXInt16TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int16Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt16TypeObj obj = getJavaFXFocusAsInt16Type();
					ICFBamInt16TypeEditObj editObj = (ICFBamInt16TypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getInt16TypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsInt16Type( ICFBamInt16TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt16TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt16TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
