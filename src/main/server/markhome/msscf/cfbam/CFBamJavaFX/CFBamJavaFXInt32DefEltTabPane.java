// Description: Java 11 JavaFX Element TabPane implementation for Int32Def.
...
/**
 *	CFBamJavaFXInt32DefEltTabPane JavaFX Element TabPane implementation
 *	for Int32Def.
 */
public class CFBamJavaFXInt32DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXInt32DefPaneCommon
{
	...
	public CFBamJavaFXInt32DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamInt32DefObj focus = (ICFBamInt32DefObj)getJavaFXFocusAsInt32Def();
			if( focus != null ) {
