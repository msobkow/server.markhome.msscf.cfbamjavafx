// Description: Java 11 JavaFX View/Edit Pane implementation for Int64Def.
...
/**
 *	CFBamJavaFXInt64DefViewEditPane JavaFX View/Edit Pane implementation
 *	for Int64Def.
 */
public class CFBamJavaFXInt64DefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt64DefPaneCommon
{
	...
	public CFBamJavaFXInt64DefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64DefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getInt64DefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64DefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt64DefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt64DefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
