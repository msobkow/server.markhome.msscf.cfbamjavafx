// Description: Java 11 JavaFX Attribute Pane implementation for UInt16Type.
...
/**
 *	CFBamJavaFXUInt16TypeAttrPane JavaFX Attribute Pane implementation
 *	for UInt16Type.
 */
public class CFBamJavaFXUInt16TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt16TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUInt16TypeObj cur = getJavaFXFocusAsUInt16Type();
				if( cur != null ) {
					ICFBamUInt16TypeEditObj editObj = (ICFBamUInt16TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUInt16TypeObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXUInt16TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamUInt16TypeObj getEffJavaFXFocus() {
		ICFBamUInt16TypeObj eff = (ICFBamUInt16TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUInt16TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUInt16TypeObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamUInt16TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUInt16TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUInt16TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUInt16TypeObj)editObj.create();
