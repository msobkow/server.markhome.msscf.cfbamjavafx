// Description: Java 11 JavaFX Ask Delete Pane implementation for ServerObjFunc.
...
/**
 *	CFBamJavaFXServerObjFuncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ServerObjFunc.
 */
public class CFBamJavaFXServerObjFuncAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXServerObjFuncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ServerObjFunc";
	...
	public CFBamJavaFXServerObjFuncAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerObjFuncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ServerObjFunc?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamServerObjFuncObj obj = getJavaFXFocusAsServerObjFunc();
					ICFBamServerObjFuncEditObj editObj = (ICFBamServerObjFuncEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsServerObjFunc( ICFBamServerObjFuncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXServerObjFuncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXServerObjFuncPaneCommon)attrPane).setPaneMode( value );
		}
	}
