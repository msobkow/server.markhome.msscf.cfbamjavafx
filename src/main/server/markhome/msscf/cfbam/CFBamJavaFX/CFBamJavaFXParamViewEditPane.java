// Description: Java 11 JavaFX View/Edit Pane implementation for Param.
...
/**
 *	CFBamJavaFXParamViewEditPane JavaFX View/Edit Pane implementation
 *	for Param.
 */
public class CFBamJavaFXParamViewEditPane
extends CFSplitPane
implements ICFBamJavaFXParamPaneCommon
{
	...
	public CFBamJavaFXParamViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamParamObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXParamPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
