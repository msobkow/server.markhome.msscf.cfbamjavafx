// Description: Java 11 JavaFX Ask Delete Pane implementation for NmTokensCol.
...
/**
 *	CFBamJavaFXNmTokensColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NmTokensCol.
 */
public class CFBamJavaFXNmTokensColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNmTokensColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NmTokensCol";
	...
	public CFBamJavaFXNmTokensColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NmTokensCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNmTokensColObj obj = getJavaFXFocusAsNmTokensCol();
					ICFBamNmTokensColEditObj editObj = (ICFBamNmTokensColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNmTokensCol( ICFBamNmTokensColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokensColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokensColPaneCommon)attrPane).setPaneMode( value );
		}
	}
