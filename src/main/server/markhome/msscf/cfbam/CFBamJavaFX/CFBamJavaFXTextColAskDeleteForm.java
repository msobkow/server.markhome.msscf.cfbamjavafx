// Description: Java 11 JavaFX Ask Delete Pane implementation for TextCol.
...
/**
 *	CFBamJavaFXTextColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TextCol.
 */
public class CFBamJavaFXTextColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTextColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TextCol";
	...
	public CFBamJavaFXTextColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TextCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTextColObj obj = getJavaFXFocusAsTextCol();
					ICFBamTextColEditObj editObj = (ICFBamTextColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTextColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTextCol( ICFBamTextColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTextColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTextColPaneCommon)attrPane).setPaneMode( value );
		}
	}
