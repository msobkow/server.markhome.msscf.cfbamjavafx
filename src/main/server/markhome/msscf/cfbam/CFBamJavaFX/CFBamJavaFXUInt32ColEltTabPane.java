// Description: Java 11 JavaFX Element TabPane implementation for UInt32Col.
...
/**
 *	CFBamJavaFXUInt32ColEltTabPane JavaFX Element TabPane implementation
 *	for UInt32Col.
 */
public class CFBamJavaFXUInt32ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt32ColPaneCommon
{
	...
	public CFBamJavaFXUInt32ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt32ColObj focus = (ICFBamUInt32ColObj)getJavaFXFocusAsUInt32Col();
			if( focus != null ) {
