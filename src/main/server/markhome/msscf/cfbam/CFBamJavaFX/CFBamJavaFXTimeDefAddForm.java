// Description: Java 11 JavaFX Add Form implementation for TimeDef.
...
/**
 *	CFBamJavaFXTimeDefAddForm JavaFX Add Form implementation
 *	for TimeDef.
 */
public class CFBamJavaFXTimeDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTimeDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TimeDef";
	...
	public CFBamJavaFXTimeDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTimeDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTimeDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTimeDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimeDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
