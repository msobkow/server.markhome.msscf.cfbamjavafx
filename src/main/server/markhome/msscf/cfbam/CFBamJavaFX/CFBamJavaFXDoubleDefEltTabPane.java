// Description: Java 11 JavaFX Element TabPane implementation for DoubleDef.
...
/**
 *	CFBamJavaFXDoubleDefEltTabPane JavaFX Element TabPane implementation
 *	for DoubleDef.
 */
public class CFBamJavaFXDoubleDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDoubleDefPaneCommon
{
	...
	public CFBamJavaFXDoubleDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDoubleDefObj focus = (ICFBamDoubleDefObj)getJavaFXFocusAsDoubleDef();
			if( focus != null ) {
