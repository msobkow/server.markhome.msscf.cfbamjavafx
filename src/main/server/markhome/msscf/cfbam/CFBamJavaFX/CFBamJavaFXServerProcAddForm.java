// Description: Java 11 JavaFX Add Form implementation for ServerProc.
...
/**
 *	CFBamJavaFXServerProcAddForm JavaFX Add Form implementation
 *	for ServerProc.
 */
public class CFBamJavaFXServerProcAddForm
extends CFBorderPane
implements ICFBamJavaFXServerProcPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ServerProc";
	...
	public CFBamJavaFXServerProcAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerProcObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getServerProcFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXServerProcPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getServerProcFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerProcPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerProcPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
