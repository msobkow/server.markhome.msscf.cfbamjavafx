// Description: Java 11 JavaFX Ask Delete Pane implementation for Value.
...
/**
 *	CFBamJavaFXValueAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Value.
 */
public class CFBamJavaFXValueAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXValuePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Value";
	...
	public CFBamJavaFXValueAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamValueObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Value?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamValueObj obj = getJavaFXFocusAsValue();
					ICFBamValueEditObj editObj = (ICFBamValueEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getValueFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsValue( ICFBamValueObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXValuePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXValuePaneCommon)attrPane).setPaneMode( value );
		}
	}
