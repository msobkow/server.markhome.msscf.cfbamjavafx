// Description: Java 11 JavaFX Ask Delete Pane implementation for BlobDef.
...
/**
 *	CFBamJavaFXBlobDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for BlobDef.
 */
public class CFBamJavaFXBlobDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXBlobDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete BlobDef";
	...
	public CFBamJavaFXBlobDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this BlobDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamBlobDefObj obj = getJavaFXFocusAsBlobDef();
					ICFBamBlobDefEditObj editObj = (ICFBamBlobDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsBlobDef( ICFBamBlobDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXBlobDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXBlobDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
