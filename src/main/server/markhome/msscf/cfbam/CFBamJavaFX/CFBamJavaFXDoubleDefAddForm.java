// Description: Java 11 JavaFX Add Form implementation for DoubleDef.
...
/**
 *	CFBamJavaFXDoubleDefAddForm JavaFX Add Form implementation
 *	for DoubleDef.
 */
public class CFBamJavaFXDoubleDefAddForm
extends CFBorderPane
implements ICFBamJavaFXDoubleDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DoubleDef";
	...
	public CFBamJavaFXDoubleDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDoubleDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDoubleDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDoubleDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDoubleDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
