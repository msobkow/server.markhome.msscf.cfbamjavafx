// Description: Java 11 JavaFX View/Edit Pane implementation for TimeType.
...
/**
 *	CFBamJavaFXTimeTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for TimeType.
 */
public class CFBamJavaFXTimeTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTimeTypePaneCommon
{
	...
	public CFBamJavaFXTimeTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeTypeObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTimeTypeFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimeTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTimeTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
