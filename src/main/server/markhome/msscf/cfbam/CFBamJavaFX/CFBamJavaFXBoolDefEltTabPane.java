// Description: Java 11 JavaFX Element TabPane implementation for BoolDef.
...
/**
 *	CFBamJavaFXBoolDefEltTabPane JavaFX Element TabPane implementation
 *	for BoolDef.
 */
public class CFBamJavaFXBoolDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXBoolDefPaneCommon
{
	...
	public CFBamJavaFXBoolDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamBoolDefObj focus = (ICFBamBoolDefObj)getJavaFXFocusAsBoolDef();
			if( focus != null ) {
