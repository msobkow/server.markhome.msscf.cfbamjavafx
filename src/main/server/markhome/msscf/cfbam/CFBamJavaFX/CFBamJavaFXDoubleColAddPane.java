// Description: Java 11 JavaFX Add Pane implementation for DoubleCol.
...
/**
 *	CFBamJavaFXDoubleColAddPane JavaFX Add Pane implementation
 *	for DoubleCol.
 */
public class CFBamJavaFXDoubleColAddPane
extends CFSplitPane
implements ICFBamJavaFXDoubleColPaneCommon
{
	...
	public CFBamJavaFXDoubleColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
