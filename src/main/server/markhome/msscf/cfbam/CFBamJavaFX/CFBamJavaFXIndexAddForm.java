// Description: Java 11 JavaFX Add Form implementation for Index.
...
/**
 *	CFBamJavaFXIndexAddForm JavaFX Add Form implementation
 *	for Index.
 */
public class CFBamJavaFXIndexAddForm
extends CFBorderPane
implements ICFBamJavaFXIndexPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Index";
	...
	public CFBamJavaFXIndexAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getIndexFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXIndexPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getIndexFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXIndexPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXIndexPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
