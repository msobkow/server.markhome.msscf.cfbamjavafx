// Description: Java 11 JavaFX Add Form implementation for PopDep.
...
/**
 *	CFBamJavaFXPopDepAddForm JavaFX Add Form implementation
 *	for PopDep.
 */
public class CFBamJavaFXPopDepAddForm
extends CFBorderPane
implements ICFBamJavaFXPopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add PopDep";
	...
	public CFBamJavaFXPopDepAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getPopDepFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXPopDepPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getPopDepFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopDepPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopDepPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
