// Description: Java 11 JavaFX Ask Delete Pane implementation for TZTimestampCol.
...
/**
 *	CFBamJavaFXTZTimestampColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZTimestampCol.
 */
public class CFBamJavaFXTZTimestampColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZTimestampColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZTimestampCol";
	...
	public CFBamJavaFXTZTimestampColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZTimestampCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZTimestampColObj obj = getJavaFXFocusAsTZTimestampCol();
					ICFBamTZTimestampColEditObj editObj = (ICFBamTZTimestampColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZTimestampCol( ICFBamTZTimestampColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimestampColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimestampColPaneCommon)attrPane).setPaneMode( value );
		}
	}
