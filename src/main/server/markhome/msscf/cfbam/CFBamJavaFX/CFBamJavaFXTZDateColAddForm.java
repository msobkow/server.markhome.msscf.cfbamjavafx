// Description: Java 11 JavaFX Add Form implementation for TZDateCol.
...
/**
 *	CFBamJavaFXTZDateColAddForm JavaFX Add Form implementation
 *	for TZDateCol.
 */
public class CFBamJavaFXTZDateColAddForm
extends CFBorderPane
implements ICFBamJavaFXTZDateColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZDateCol";
	...
	public CFBamJavaFXTZDateColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTZDateColObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxAddPane = argSchema.getTZDateColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamTZDateColObj focus = getJavaFXFocusAsTZDateCol();
		if( focus != null ) {
			ICFBamTZDateColEditObj editObj = (ICFBamTZDateColEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZDateColPaneCommon)javafxAddPane).setJavaFXFocus( value );
		ICFBamTZDateColObj argFocus = (ICFBamTZDateColObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTZDateColObj)argFocus.read( true );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						focus = getJavaFXFocusAsTZDateCol();
						CFBorderPane frame = javafxSchema.getTZDateColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
