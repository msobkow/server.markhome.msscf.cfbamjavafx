// Description: Java 11 JavaFX Ask Delete Pane implementation for UuidGen.
...
/**
 *	CFBamJavaFXUuidGenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UuidGen.
 */
public class CFBamJavaFXUuidGenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuidGenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UuidGen";
	...
	public CFBamJavaFXUuidGenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidGenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UuidGen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuidGenObj obj = getJavaFXFocusAsUuidGen();
					ICFBamUuidGenEditObj editObj = (ICFBamUuidGenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getUuidGenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsUuidGen( ICFBamUuidGenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuidGenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUuidGenPaneCommon)attrPane).setPaneMode( value );
		}
	}
