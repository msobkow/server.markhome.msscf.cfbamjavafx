// Description: Java 11 JavaFX Add Pane implementation for NmTokensType.
...
/**
 *	CFBamJavaFXNmTokensTypeAddPane JavaFX Add Pane implementation
 *	for NmTokensType.
 */
public class CFBamJavaFXNmTokensTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXNmTokensTypePaneCommon
{
	...
	public CFBamJavaFXNmTokensTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
