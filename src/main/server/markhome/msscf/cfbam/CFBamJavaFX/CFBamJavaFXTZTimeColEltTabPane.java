// Description: Java 11 JavaFX Element TabPane implementation for TZTimeCol.
...
/**
 *	CFBamJavaFXTZTimeColEltTabPane JavaFX Element TabPane implementation
 *	for TZTimeCol.
 */
public class CFBamJavaFXTZTimeColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZTimeColPaneCommon
{
	...
	public CFBamJavaFXTZTimeColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZTimeColObj focus = (ICFBamTZTimeColObj)getJavaFXFocusAsTZTimeCol();
			if( focus != null ) {
