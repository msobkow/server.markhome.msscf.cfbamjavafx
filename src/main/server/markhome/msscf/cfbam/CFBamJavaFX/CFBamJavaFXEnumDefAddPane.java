// Description: Java 11 JavaFX Add Pane implementation for EnumDef.
...
/**
 *	CFBamJavaFXEnumDefAddPane JavaFX Add Pane implementation
 *	for EnumDef.
 */
public class CFBamJavaFXEnumDefAddPane
extends CFSplitPane
implements ICFBamJavaFXEnumDefPaneCommon
{
	...
	public CFBamJavaFXEnumDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
