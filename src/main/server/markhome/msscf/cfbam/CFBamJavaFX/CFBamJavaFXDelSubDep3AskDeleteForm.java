// Description: Java 11 JavaFX Ask Delete Pane implementation for DelSubDep3.
...
/**
 *	CFBamJavaFXDelSubDep3AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DelSubDep3.
 */
public class CFBamJavaFXDelSubDep3AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DelSubDep3";
	...
	public CFBamJavaFXDelSubDep3AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep3Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DelSubDep3?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDelSubDep3Obj obj = getJavaFXFocusAsDelSubDep3();
					ICFBamDelSubDep3EditObj editObj = (ICFBamDelSubDep3EditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDelSubDep3Factory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDelSubDep3( ICFBamDelSubDep3Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDelSubDep3PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDelSubDep3PaneCommon)attrPane).setPaneMode( value );
		}
	}
