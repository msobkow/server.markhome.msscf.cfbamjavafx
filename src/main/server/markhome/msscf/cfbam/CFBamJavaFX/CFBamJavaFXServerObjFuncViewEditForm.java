// Description: Java 11 JavaFX View/Edit Form implementation for ServerObjFunc.
...
/**
 *	CFBamJavaFXServerObjFuncViewEditForm JavaFX View/Edit Form implementation
 *	for ServerObjFunc.
 */
public class CFBamJavaFXServerObjFuncViewEditForm
extends CFBorderPane
implements ICFBamJavaFXServerObjFuncPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit ServerObjFunc";
	...
	public CFBamJavaFXServerObjFuncViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerObjFuncObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getServerObjFuncFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXServerObjFuncPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsServerObjFunc() != null ) {
							if( null == getJavaFXFocusAsServerObjFunc().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerObjFuncPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerObjFuncPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
