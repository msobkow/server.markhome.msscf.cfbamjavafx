// Description: Java 11 JavaFX Add Pane implementation for Int64Def.
...
/**
 *	CFBamJavaFXInt64DefAddPane JavaFX Add Pane implementation
 *	for Int64Def.
 */
public class CFBamJavaFXInt64DefAddPane
extends CFSplitPane
implements ICFBamJavaFXInt64DefPaneCommon
{
	...
	public CFBamJavaFXInt64DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
