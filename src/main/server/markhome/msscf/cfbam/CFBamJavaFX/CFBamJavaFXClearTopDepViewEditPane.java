// Description: Java 11 JavaFX View/Edit Pane implementation for ClearTopDep.
...
/**
 *	CFBamJavaFXClearTopDepViewEditPane JavaFX View/Edit Pane implementation
 *	for ClearTopDep.
 */
public class CFBamJavaFXClearTopDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXClearTopDepPaneCommon
{
	...
	public CFBamJavaFXClearTopDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearTopDepPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearTopDepPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXClearTopDepPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
