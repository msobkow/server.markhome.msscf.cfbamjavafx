// Description: Java 11 JavaFX View/Edit Pane implementation for Int64Type.
...
/**
 *	CFBamJavaFXInt64TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for Int64Type.
 */
public class CFBamJavaFXInt64TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt64TypePaneCommon
{
	...
	public CFBamJavaFXInt64TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt64TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt64TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
