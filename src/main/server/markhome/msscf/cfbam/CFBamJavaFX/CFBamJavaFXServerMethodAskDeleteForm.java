// Description: Java 11 JavaFX Ask Delete Pane implementation for ServerMethod.
...
/**
 *	CFBamJavaFXServerMethodAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ServerMethod.
 */
public class CFBamJavaFXServerMethodAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXServerMethodPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ServerMethod";
	...
	public CFBamJavaFXServerMethodAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerMethodObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ServerMethod?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamServerMethodObj obj = getJavaFXFocusAsServerMethod();
					ICFBamServerMethodEditObj editObj = (ICFBamServerMethodEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsServerMethod( ICFBamServerMethodObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXServerMethodPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
