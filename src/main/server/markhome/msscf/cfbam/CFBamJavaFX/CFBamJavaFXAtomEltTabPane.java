// Description: Java 11 JavaFX Element TabPane implementation for Atom.
...
/**
 *	CFBamJavaFXAtomEltTabPane JavaFX Element TabPane implementation
 *	for Atom.
 */
public class CFBamJavaFXAtomEltTabPane
extends CFTabPane
implements ICFBamJavaFXAtomPaneCommon
{
	...
	public CFBamJavaFXAtomEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamAtomObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamAtomObj focus = (ICFBamAtomObj)getJavaFXFocusAsAtom();
			if( focus != null ) {
