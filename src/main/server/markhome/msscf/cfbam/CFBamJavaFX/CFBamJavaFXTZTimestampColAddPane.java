// Description: Java 11 JavaFX Add Pane implementation for TZTimestampCol.
...
/**
 *	CFBamJavaFXTZTimestampColAddPane JavaFX Add Pane implementation
 *	for TZTimestampCol.
 */
public class CFBamJavaFXTZTimestampColAddPane
extends CFSplitPane
implements ICFBamJavaFXTZTimestampColPaneCommon
{
	...
	public CFBamJavaFXTZTimestampColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
