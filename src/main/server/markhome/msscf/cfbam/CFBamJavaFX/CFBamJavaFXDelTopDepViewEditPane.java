// Description: Java 11 JavaFX View/Edit Pane implementation for DelTopDep.
...
/**
 *	CFBamJavaFXDelTopDepViewEditPane JavaFX View/Edit Pane implementation
 *	for DelTopDep.
 */
public class CFBamJavaFXDelTopDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDelTopDepPaneCommon
{
	...
	public CFBamJavaFXDelTopDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getDelTopDepFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelTopDepPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelTopDepPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDelTopDepPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
