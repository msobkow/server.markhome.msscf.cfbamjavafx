// Description: Java 11 JavaFX Element TabPane implementation for TZDateDef.
...
/**
 *	CFBamJavaFXTZDateDefEltTabPane JavaFX Element TabPane implementation
 *	for TZDateDef.
 */
public class CFBamJavaFXTZDateDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZDateDefPaneCommon
{
	...
	public CFBamJavaFXTZDateDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZDateDefObj focus = (ICFBamTZDateDefObj)getJavaFXFocusAsTZDateDef();
			if( focus != null ) {
