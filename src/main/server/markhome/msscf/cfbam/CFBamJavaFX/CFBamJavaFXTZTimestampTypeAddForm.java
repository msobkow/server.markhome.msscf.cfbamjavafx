// Description: Java 11 JavaFX Add Form implementation for TZTimestampType.
...
/**
 *	CFBamJavaFXTZTimestampTypeAddForm JavaFX Add Form implementation
 *	for TZTimestampType.
 */
public class CFBamJavaFXTZTimestampTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXTZTimestampTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZTimestampType";
	...
	public CFBamJavaFXTZTimestampTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZTimestampTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZTimestampTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZTimestampTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimestampTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
