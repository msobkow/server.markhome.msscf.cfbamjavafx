// Description: Java 11 JavaFX View/Edit Pane implementation for RelationCol.
...
/**
 *	CFBamJavaFXRelationColViewEditPane JavaFX View/Edit Pane implementation
 *	for RelationCol.
 */
public class CFBamJavaFXRelationColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXRelationColPaneCommon
{
	...
	public CFBamJavaFXRelationColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationColPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
