// Description: Java 11 JavaFX Add Form implementation for DelSubDep1.
...
/**
 *	CFBamJavaFXDelSubDep1AddForm JavaFX Add Form implementation
 *	for DelSubDep1.
 */
public class CFBamJavaFXDelSubDep1AddForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DelSubDep1";
	...
	public CFBamJavaFXDelSubDep1AddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep1Obj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDelSubDep1Factory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelSubDep1PaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDelSubDep1Factory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep1PaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep1PaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
