// Description: Java 11 JavaFX View/Edit Pane implementation for UInt16Type.
...
/**
 *	CFBamJavaFXUInt16TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt16Type.
 */
public class CFBamJavaFXUInt16TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt16TypePaneCommon
{
	...
	public CFBamJavaFXUInt16TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt16TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt16TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
