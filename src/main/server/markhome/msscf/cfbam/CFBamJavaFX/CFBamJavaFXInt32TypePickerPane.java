// Description: Java 11 JavaFX Picker of Obj Pane implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypePickerPane JavaFX Pick Obj Pane implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypePickerPane
extends CFBorderPane
implements ICFBamJavaFXInt32TypePaneList
{
	public static String S_FormName = "Choose Int32Type";
	...
	protected ICFBamJavaFXInt32TypeChosen invokeWhenChosen = null;
	protected ICFBamSchemaDefObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXInt32TypePickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseInt32Type( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseInt32Type( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
