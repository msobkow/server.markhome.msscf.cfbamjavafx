// Description: Java 11 JavaFX Add Form implementation for ClearSubDep1.
...
/**
 *	CFBamJavaFXClearSubDep1AddForm JavaFX Add Form implementation
 *	for ClearSubDep1.
 */
public class CFBamJavaFXClearSubDep1AddForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ClearSubDep1";
	...
	public CFBamJavaFXClearSubDep1AddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep1Obj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getClearSubDep1Factory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearSubDep1PaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getClearSubDep1Factory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep1PaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep1PaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
