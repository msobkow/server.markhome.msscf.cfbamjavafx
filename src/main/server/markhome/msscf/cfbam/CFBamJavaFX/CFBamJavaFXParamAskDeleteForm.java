// Description: Java 11 JavaFX Ask Delete Pane implementation for Param.
...
/**
 *	CFBamJavaFXParamAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Param.
 */
public class CFBamJavaFXParamAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXParamPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Param";
	...
	public CFBamJavaFXParamAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamParamObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Param?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamParamObj obj = getJavaFXFocusAsParam();
					ICFBamParamEditObj editObj = (ICFBamParamEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsParam( ICFBamParamObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXParamPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXParamPaneCommon)attrPane).setPaneMode( value );
		}
	}
