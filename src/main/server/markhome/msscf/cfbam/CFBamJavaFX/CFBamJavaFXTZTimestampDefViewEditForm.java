// Description: Java 11 JavaFX View/Edit Form implementation for TZTimestampDef.
...
/**
 *	CFBamJavaFXTZTimestampDefViewEditForm JavaFX View/Edit Form implementation
 *	for TZTimestampDef.
 */
public class CFBamJavaFXTZTimestampDefViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTZTimestampDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TZTimestampDef";
	...
	public CFBamJavaFXTZTimestampDefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampDefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getTZTimestampDefFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZTimestampDefPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTZTimestampDef() != null ) {
							if( null == getJavaFXFocusAsTZTimestampDef().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsTZTimestampDef();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampDefPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimestampDefPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
