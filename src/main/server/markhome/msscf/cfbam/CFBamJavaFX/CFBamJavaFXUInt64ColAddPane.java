// Description: Java 11 JavaFX Add Pane implementation for UInt64Col.
...
/**
 *	CFBamJavaFXUInt64ColAddPane JavaFX Add Pane implementation
 *	for UInt64Col.
 */
public class CFBamJavaFXUInt64ColAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt64ColPaneCommon
{
	...
	public CFBamJavaFXUInt64ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
