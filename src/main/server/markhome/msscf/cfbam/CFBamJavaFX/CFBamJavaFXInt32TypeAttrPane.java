// Description: Java 11 JavaFX Attribute Pane implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypeAttrPane JavaFX Attribute Pane implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXInt32TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamInt32TypeObj cur = getJavaFXFocusAsInt32Type();
				if( cur != null ) {
					ICFBamInt32TypeEditObj editObj = (ICFBamInt32TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamInt32TypeObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXInt32TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamInt32TypeObj getEffJavaFXFocus() {
		ICFBamInt32TypeObj eff = (ICFBamInt32TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamInt32TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamInt32TypeObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamInt32TypeObj focus = getJavaFXFocusAsInt32Type();
		ICFBamInt32TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamInt32TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamInt32TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamInt32TypeObj)editObj.create();
