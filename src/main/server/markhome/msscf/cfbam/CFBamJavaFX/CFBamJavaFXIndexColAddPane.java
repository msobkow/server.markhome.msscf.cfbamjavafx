// Description: Java 11 JavaFX Add Pane implementation for IndexCol.
...
/**
 *	CFBamJavaFXIndexColAddPane JavaFX Add Pane implementation
 *	for IndexCol.
 */
public class CFBamJavaFXIndexColAddPane
extends CFSplitPane
implements ICFBamJavaFXIndexColPaneCommon
{
	...
	public CFBamJavaFXIndexColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXIndexColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
