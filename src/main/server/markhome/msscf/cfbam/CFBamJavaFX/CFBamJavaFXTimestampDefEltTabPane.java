// Description: Java 11 JavaFX Element TabPane implementation for TimestampDef.
...
/**
 *	CFBamJavaFXTimestampDefEltTabPane JavaFX Element TabPane implementation
 *	for TimestampDef.
 */
public class CFBamJavaFXTimestampDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXTimestampDefPaneCommon
{
	...
	public CFBamJavaFXTimestampDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTimestampDefObj focus = (ICFBamTimestampDefObj)getJavaFXFocusAsTimestampDef();
			if( focus != null ) {
