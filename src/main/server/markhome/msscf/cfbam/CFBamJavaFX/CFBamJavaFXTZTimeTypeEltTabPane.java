// Description: Java 11 JavaFX Element TabPane implementation for TZTimeType.
...
/**
 *	CFBamJavaFXTZTimeTypeEltTabPane JavaFX Element TabPane implementation
 *	for TZTimeType.
 */
public class CFBamJavaFXTZTimeTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZTimeTypePaneCommon
{
	...
	public CFBamJavaFXTZTimeTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZTimeTypeObj focus = (ICFBamTZTimeTypeObj)getJavaFXFocusAsTZTimeType();
			if( focus != null ) {
