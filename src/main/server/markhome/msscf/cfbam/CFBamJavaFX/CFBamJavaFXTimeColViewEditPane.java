// Description: Java 11 JavaFX View/Edit Pane implementation for TimeCol.
...
/**
 *	CFBamJavaFXTimeColViewEditPane JavaFX View/Edit Pane implementation
 *	for TimeCol.
 */
public class CFBamJavaFXTimeColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTimeColPaneCommon
{
	...
	public CFBamJavaFXTimeColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTimeColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimeColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTimeColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
