// Description: Java 11 JavaFX Element TabPane implementation for TimeDef.
...
/**
 *	CFBamJavaFXTimeDefEltTabPane JavaFX Element TabPane implementation
 *	for TimeDef.
 */
public class CFBamJavaFXTimeDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXTimeDefPaneCommon
{
	...
	public CFBamJavaFXTimeDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTimeDefObj focus = (ICFBamTimeDefObj)getJavaFXFocusAsTimeDef();
			if( focus != null ) {
