// Description: Java 11 JavaFX View/Edit Pane implementation for EnumDef.
...
/**
 *	CFBamJavaFXEnumDefViewEditPane JavaFX View/Edit Pane implementation
 *	for EnumDef.
 */
public class CFBamJavaFXEnumDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXEnumDefPaneCommon
{
	...
	public CFBamJavaFXEnumDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumDefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getEnumDefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXEnumDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXEnumDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
