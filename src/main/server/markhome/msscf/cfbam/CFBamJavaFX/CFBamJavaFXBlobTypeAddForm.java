// Description: Java 11 JavaFX Add Form implementation for BlobType.
...
/**
 *	CFBamJavaFXBlobTypeAddForm JavaFX Add Form implementation
 *	for BlobType.
 */
public class CFBamJavaFXBlobTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXBlobTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add BlobType";
	...
	public CFBamJavaFXBlobTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getBlobTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXBlobTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getBlobTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBlobTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
