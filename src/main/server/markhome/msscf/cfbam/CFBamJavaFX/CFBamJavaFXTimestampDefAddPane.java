// Description: Java 11 JavaFX Add Pane implementation for TimestampDef.
...
/**
 *	CFBamJavaFXTimestampDefAddPane JavaFX Add Pane implementation
 *	for TimestampDef.
 */
public class CFBamJavaFXTimestampDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTimestampDefPaneCommon
{
	...
	public CFBamJavaFXTimestampDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
