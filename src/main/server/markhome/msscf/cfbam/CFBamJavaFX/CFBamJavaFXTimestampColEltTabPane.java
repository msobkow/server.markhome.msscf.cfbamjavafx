// Description: Java 11 JavaFX Element TabPane implementation for TimestampCol.
...
/**
 *	CFBamJavaFXTimestampColEltTabPane JavaFX Element TabPane implementation
 *	for TimestampCol.
 */
public class CFBamJavaFXTimestampColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTimestampColPaneCommon
{
	...
	public CFBamJavaFXTimestampColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTimestampColObj focus = (ICFBamTimestampColObj)getJavaFXFocusAsTimestampCol();
			if( focus != null ) {
