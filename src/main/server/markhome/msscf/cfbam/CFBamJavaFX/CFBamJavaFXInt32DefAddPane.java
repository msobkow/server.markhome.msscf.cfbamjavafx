// Description: Java 11 JavaFX Add Pane implementation for Int32Def.
...
/**
 *	CFBamJavaFXInt32DefAddPane JavaFX Add Pane implementation
 *	for Int32Def.
 */
public class CFBamJavaFXInt32DefAddPane
extends CFSplitPane
implements ICFBamJavaFXInt32DefPaneCommon
{
	...
	public CFBamJavaFXInt32DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
