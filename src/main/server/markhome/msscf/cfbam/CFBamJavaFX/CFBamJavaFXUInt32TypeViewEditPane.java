// Description: Java 11 JavaFX View/Edit Pane implementation for UInt32Type.
...
/**
 *	CFBamJavaFXUInt32TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt32Type.
 */
public class CFBamJavaFXUInt32TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt32TypePaneCommon
{
	...
	public CFBamJavaFXUInt32TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt32TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt32TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
