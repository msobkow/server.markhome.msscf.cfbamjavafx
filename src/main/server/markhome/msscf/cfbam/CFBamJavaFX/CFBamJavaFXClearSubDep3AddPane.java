// Description: Java 11 JavaFX Add Pane implementation for ClearSubDep3.
...
/**
 *	CFBamJavaFXClearSubDep3AddPane JavaFX Add Pane implementation
 *	for ClearSubDep3.
 */
public class CFBamJavaFXClearSubDep3AddPane
extends CFSplitPane
implements ICFBamJavaFXClearSubDep3PaneCommon
{
	...
	public CFBamJavaFXClearSubDep3AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep3Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep3PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
