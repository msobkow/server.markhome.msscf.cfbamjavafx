// Description: Java 11 JavaFX Ask Delete Pane implementation for DelSubDep2.
...
/**
 *	CFBamJavaFXDelSubDep2AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DelSubDep2.
 */
public class CFBamJavaFXDelSubDep2AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DelSubDep2";
	...
	public CFBamJavaFXDelSubDep2AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep2Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DelSubDep2?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDelSubDep2Obj obj = getJavaFXFocusAsDelSubDep2();
					ICFBamDelSubDep2EditObj editObj = (ICFBamDelSubDep2EditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsDelSubDep2( ICFBamDelSubDep2Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDelSubDep2PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDelSubDep2PaneCommon)attrPane).setPaneMode( value );
		}
	}
