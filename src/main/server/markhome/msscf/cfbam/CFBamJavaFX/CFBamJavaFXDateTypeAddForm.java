// Description: Java 11 JavaFX Add Form implementation for DateType.
...
/**
 *	CFBamJavaFXDateTypeAddForm JavaFX Add Form implementation
 *	for DateType.
 */
public class CFBamJavaFXDateTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXDateTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DateType";
	...
	public CFBamJavaFXDateTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDateTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDateTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDateTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDateTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
