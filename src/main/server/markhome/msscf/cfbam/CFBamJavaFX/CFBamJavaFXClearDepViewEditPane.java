// Description: Java 11 JavaFX View/Edit Pane implementation for ClearDep.
...
/**
 *	CFBamJavaFXClearDepViewEditPane JavaFX View/Edit Pane implementation
 *	for ClearDep.
 */
public class CFBamJavaFXClearDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXClearDepPaneCommon
{
	...
	public CFBamJavaFXClearDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearDepPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
