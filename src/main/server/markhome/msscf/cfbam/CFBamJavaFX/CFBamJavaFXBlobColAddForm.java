// Description: Java 11 JavaFX Add Form implementation for BlobCol.
...
/**
 *	CFBamJavaFXBlobColAddForm JavaFX Add Form implementation
 *	for BlobCol.
 */
public class CFBamJavaFXBlobColAddForm
extends CFBorderPane
implements ICFBamJavaFXBlobColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add BlobCol";
	...
	public CFBamJavaFXBlobColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getBlobColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXBlobColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getBlobColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBlobColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
