// Description: Java 11 JavaFX Add Form implementation for RelationCol.
...
/**
 *	CFBamJavaFXRelationColAddForm JavaFX Add Form implementation
 *	for RelationCol.
 */
public class CFBamJavaFXRelationColAddForm
extends CFBorderPane
implements ICFBamJavaFXRelationColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add RelationCol";
	...
	public CFBamJavaFXRelationColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getRelationColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXRelationColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getRelationColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXRelationColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
