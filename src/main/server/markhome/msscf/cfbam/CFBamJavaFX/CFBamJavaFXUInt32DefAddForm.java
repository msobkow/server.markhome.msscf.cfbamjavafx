// Description: Java 11 JavaFX Add Form implementation for UInt32Def.
...
/**
 *	CFBamJavaFXUInt32DefAddForm JavaFX Add Form implementation
 *	for UInt32Def.
 */
public class CFBamJavaFXUInt32DefAddForm
extends CFBorderPane
implements ICFBamJavaFXUInt32DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UInt32Def";
	...
	public CFBamJavaFXUInt32DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUInt32DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt32DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUInt32DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt32DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
