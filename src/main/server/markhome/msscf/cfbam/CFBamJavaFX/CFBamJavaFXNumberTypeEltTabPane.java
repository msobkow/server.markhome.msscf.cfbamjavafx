// Description: Java 11 JavaFX Element TabPane implementation for NumberType.
...
/**
 *	CFBamJavaFXNumberTypeEltTabPane JavaFX Element TabPane implementation
 *	for NumberType.
 */
public class CFBamJavaFXNumberTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXNumberTypePaneCommon
{
	...
	public CFBamJavaFXNumberTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNumberTypeObj focus = (ICFBamNumberTypeObj)getJavaFXFocusAsNumberType();
			if( focus != null ) {
