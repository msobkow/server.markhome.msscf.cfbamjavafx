// Description: Java 11 JavaFX Add Pane implementation for Int64Type.
...
/**
 *	CFBamJavaFXInt64TypeAddPane JavaFX Add Pane implementation
 *	for Int64Type.
 */
public class CFBamJavaFXInt64TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXInt64TypePaneCommon
{
	...
	public CFBamJavaFXInt64TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
