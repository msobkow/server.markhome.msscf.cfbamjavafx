// Description: Java 11 JavaFX Add Pane implementation for Table.
...
/**
 *	CFBamJavaFXTableAddPane JavaFX Add Pane implementation
 *	for Table.
 */
public class CFBamJavaFXTableAddPane
extends CFSplitPane
implements ICFBamJavaFXTablePaneCommon
{
	...
	public CFBamJavaFXTableAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTablePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
