// Description: Java 11 JavaFX View/Edit Pane implementation for EnumType.
...
/**
 *	CFBamJavaFXEnumTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for EnumType.
 */
public class CFBamJavaFXEnumTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXEnumTypePaneCommon
{
	...
	public CFBamJavaFXEnumTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getEnumTypeFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXEnumTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXEnumTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
