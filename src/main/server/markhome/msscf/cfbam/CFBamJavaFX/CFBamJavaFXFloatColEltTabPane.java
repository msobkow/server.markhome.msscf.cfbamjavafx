// Description: Java 11 JavaFX Element TabPane implementation for FloatCol.
...
/**
 *	CFBamJavaFXFloatColEltTabPane JavaFX Element TabPane implementation
 *	for FloatCol.
 */
public class CFBamJavaFXFloatColEltTabPane
extends CFTabPane
implements ICFBamJavaFXFloatColPaneCommon
{
	...
	public CFBamJavaFXFloatColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamFloatColObj focus = (ICFBamFloatColObj)getJavaFXFocusAsFloatCol();
			if( focus != null ) {
