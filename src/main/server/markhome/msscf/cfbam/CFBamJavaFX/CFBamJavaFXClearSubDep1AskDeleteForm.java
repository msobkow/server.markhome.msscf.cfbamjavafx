// Description: Java 11 JavaFX Ask Delete Pane implementation for ClearSubDep1.
...
/**
 *	CFBamJavaFXClearSubDep1AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ClearSubDep1.
 */
public class CFBamJavaFXClearSubDep1AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ClearSubDep1";
	...
	public CFBamJavaFXClearSubDep1AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep1Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ClearSubDep1?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamClearSubDep1Obj obj = getJavaFXFocusAsClearSubDep1();
					ICFBamClearSubDep1EditObj editObj = (ICFBamClearSubDep1EditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsClearSubDep1( ICFBamClearSubDep1Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXClearSubDep1PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXClearSubDep1PaneCommon)attrPane).setPaneMode( value );
		}
	}
