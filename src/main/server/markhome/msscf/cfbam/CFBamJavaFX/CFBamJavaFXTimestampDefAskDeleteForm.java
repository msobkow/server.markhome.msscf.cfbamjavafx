// Description: Java 11 JavaFX Ask Delete Pane implementation for TimestampDef.
...
/**
 *	CFBamJavaFXTimestampDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TimestampDef.
 */
public class CFBamJavaFXTimestampDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTimestampDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TimestampDef";
	...
	public CFBamJavaFXTimestampDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TimestampDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTimestampDefObj obj = getJavaFXFocusAsTimestampDef();
					ICFBamTimestampDefEditObj editObj = (ICFBamTimestampDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTimestampDef( ICFBamTimestampDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTimestampDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTimestampDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
