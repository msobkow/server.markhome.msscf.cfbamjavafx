// Description: Java 11 JavaFX Add Form implementation for TextType.
...
/**
 *	CFBamJavaFXTextTypeAddForm JavaFX Add Form implementation
 *	for TextType.
 */
public class CFBamJavaFXTextTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXTextTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TextType";
	...
	public CFBamJavaFXTextTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTextTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTextTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTextTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTextTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
