// Description: Java 11 JavaFX Add Form implementation for StringCol.
...
/**
 *	CFBamJavaFXStringColAddForm JavaFX Add Form implementation
 *	for StringCol.
 */
public class CFBamJavaFXStringColAddForm
extends CFBorderPane
implements ICFBamJavaFXStringColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add StringCol";
	...
	public CFBamJavaFXStringColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getStringColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXStringColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getStringColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXStringColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
