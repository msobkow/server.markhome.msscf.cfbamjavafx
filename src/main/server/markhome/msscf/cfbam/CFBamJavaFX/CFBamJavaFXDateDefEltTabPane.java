// Description: Java 11 JavaFX Element TabPane implementation for DateDef.
...
/**
 *	CFBamJavaFXDateDefEltTabPane JavaFX Element TabPane implementation
 *	for DateDef.
 */
public class CFBamJavaFXDateDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXDateDefPaneCommon
{
	...
	public CFBamJavaFXDateDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDateDefObj focus = (ICFBamDateDefObj)getJavaFXFocusAsDateDef();
			if( focus != null ) {
