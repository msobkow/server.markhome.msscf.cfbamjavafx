// Description: Java 11 JavaFX Attribute Pane implementation for ClearSubDep3.
...
/**
 *	CFBamJavaFXClearSubDep3AttrPane JavaFX Attribute Pane implementation
 *	for ClearSubDep3.
 */
public class CFBamJavaFXClearSubDep3AttrPane
extends CFGridPane
implements ICFBamJavaFXClearSubDep3PaneCommon
{
	...
	implements ICFBamJavaFXRelationChosen
	{
		...
		public void choseRelation( ICFBamRelationObj value ) {
			if( javafxReferenceLookupRelation != null ) {
				ICFBamClearSubDep3Obj cur = getJavaFXFocusAsClearSubDep3();
				if( cur != null ) {
					ICFBamClearSubDep3EditObj editObj = (ICFBamClearSubDep3EditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamClearSubDep3Obj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXClearSubDep3AttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep3Obj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamClearSubDep3Obj getEffJavaFXFocus() {
		ICFBamClearSubDep3Obj eff = (ICFBamClearSubDep3Obj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamClearSubDep3Obj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamClearSubDep3Obj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamClearSubDep3EditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamClearSubDep3EditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamClearSubDep3EditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamClearSubDep3Obj)editObj.create();
