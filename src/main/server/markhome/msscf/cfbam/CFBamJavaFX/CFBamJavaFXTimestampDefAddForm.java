// Description: Java 11 JavaFX Add Form implementation for TimestampDef.
...
/**
 *	CFBamJavaFXTimestampDefAddForm JavaFX Add Form implementation
 *	for TimestampDef.
 */
public class CFBamJavaFXTimestampDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTimestampDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TimestampDef";
	...
	public CFBamJavaFXTimestampDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTimestampDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTimestampDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTimestampDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimestampDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
