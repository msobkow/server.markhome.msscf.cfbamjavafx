// Description: Java 11 JavaFX View/Edit Pane implementation for NumberCol.
...
/**
 *	CFBamJavaFXNumberColViewEditPane JavaFX View/Edit Pane implementation
 *	for NumberCol.
 */
public class CFBamJavaFXNumberColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNumberColPaneCommon
{
	...
	public CFBamJavaFXNumberColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNumberColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNumberColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
