// Description: Java 11 JavaFX Ask Delete Pane implementation for SchemaRef.
...
/**
 *	CFBamJavaFXSchemaRefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SchemaRef.
 */
public class CFBamJavaFXSchemaRefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXSchemaRefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete SchemaRef";
	...
	public CFBamJavaFXSchemaRefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this SchemaRef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamSchemaRefObj obj = getJavaFXFocusAsSchemaRef();
					ICFBamSchemaRefEditObj editObj = (ICFBamSchemaRefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSchemaRef( ICFBamSchemaRefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaRefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
