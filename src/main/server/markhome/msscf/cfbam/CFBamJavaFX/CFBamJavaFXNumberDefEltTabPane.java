// Description: Java 11 JavaFX Element TabPane implementation for NumberDef.
...
/**
 *	CFBamJavaFXNumberDefEltTabPane JavaFX Element TabPane implementation
 *	for NumberDef.
 */
public class CFBamJavaFXNumberDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXNumberDefPaneCommon
{
	...
	public CFBamJavaFXNumberDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNumberDefObj focus = (ICFBamNumberDefObj)getJavaFXFocusAsNumberDef();
			if( focus != null ) {
