// Description: Java 11 JavaFX View/Edit Form implementation for PopSubDep2.
...
/**
 *	CFBamJavaFXPopSubDep2ViewEditForm JavaFX View/Edit Form implementation
 *	for PopSubDep2.
 */
public class CFBamJavaFXPopSubDep2ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXPopSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit PopSubDep2";
	...
	public CFBamJavaFXPopSubDep2ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep2Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamPopSubDep2Obj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getPopSubDep2Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamPopSubDep2EditObj editObj = (ICFBamPopSubDep2EditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXPopSubDep2PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamPopSubDep2Obj argFocus = (ICFBamPopSubDep2Obj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamPopSubDep2Obj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsPopSubDep2() != null ) {
							if( null == getJavaFXFocusAsPopSubDep2().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsPopSubDep2();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopSubDep2PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopSubDep2PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
