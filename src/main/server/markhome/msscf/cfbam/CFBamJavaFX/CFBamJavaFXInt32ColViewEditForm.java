// Description: Java 11 JavaFX View/Edit Form implementation for Int32Col.
...
/**
 *	CFBamJavaFXInt32ColViewEditForm JavaFX View/Edit Form implementation
 *	for Int32Col.
 */
public class CFBamJavaFXInt32ColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXInt32ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Int32Col";
	...
	public CFBamJavaFXInt32ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamInt32ColObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getInt32ColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt32ColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamInt32ColObj argFocus = (ICFBamInt32ColObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamInt32ColObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsInt32Col() != null ) {
							if( null == getJavaFXFocusAsInt32Col().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32ColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt32ColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
