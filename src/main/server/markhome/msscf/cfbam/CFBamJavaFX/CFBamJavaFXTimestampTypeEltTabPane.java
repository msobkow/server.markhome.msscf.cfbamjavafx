// Description: Java 11 JavaFX Element TabPane implementation for TimestampType.
...
/**
 *	CFBamJavaFXTimestampTypeEltTabPane JavaFX Element TabPane implementation
 *	for TimestampType.
 */
public class CFBamJavaFXTimestampTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTimestampTypePaneCommon
{
	...
	public CFBamJavaFXTimestampTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTimestampTypeObj focus = (ICFBamTimestampTypeObj)getJavaFXFocusAsTimestampType();
			if( focus != null ) {
