// Description: Java 11 JavaFX Ask Delete Pane implementation for NumberCol.
...
/**
 *	CFBamJavaFXNumberColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NumberCol.
 */
public class CFBamJavaFXNumberColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNumberColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NumberCol";
	...
	public CFBamJavaFXNumberColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NumberCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNumberColObj obj = getJavaFXFocusAsNumberCol();
					ICFBamNumberColEditObj editObj = (ICFBamNumberColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNumberCol( ICFBamNumberColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNumberColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNumberColPaneCommon)attrPane).setPaneMode( value );
		}
	}
