// Description: Java 11 JavaFX Ask Delete Pane implementation for TimeType.
...
/**
 *	CFBamJavaFXTimeTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TimeType.
 */
public class CFBamJavaFXTimeTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTimeTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TimeType";
	...
	public CFBamJavaFXTimeTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TimeType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTimeTypeObj obj = getJavaFXFocusAsTimeType();
					ICFBamTimeTypeEditObj editObj = (ICFBamTimeTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTimeType( ICFBamTimeTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTimeTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
