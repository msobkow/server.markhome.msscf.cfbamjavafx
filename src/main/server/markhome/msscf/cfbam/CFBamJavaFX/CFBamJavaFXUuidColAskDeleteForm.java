// Description: Java 11 JavaFX Ask Delete Pane implementation for UuidCol.
...
/**
 *	CFBamJavaFXUuidColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UuidCol.
 */
public class CFBamJavaFXUuidColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuidColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UuidCol";
	...
	public CFBamJavaFXUuidColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UuidCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuidColObj obj = getJavaFXFocusAsUuidCol();
					ICFBamUuidColEditObj editObj = (ICFBamUuidColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUuidCol( ICFBamUuidColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuidColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
