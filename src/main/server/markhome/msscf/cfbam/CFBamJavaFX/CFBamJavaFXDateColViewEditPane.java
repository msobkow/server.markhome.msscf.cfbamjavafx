// Description: Java 11 JavaFX View/Edit Pane implementation for DateCol.
...
/**
 *	CFBamJavaFXDateColViewEditPane JavaFX View/Edit Pane implementation
 *	for DateCol.
 */
public class CFBamJavaFXDateColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDateColPaneCommon
{
	...
	public CFBamJavaFXDateColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getDateColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDateColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDateColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
