// Description: Java 11 JavaFX Add Pane implementation for PopSubDep3.
...
/**
 *	CFBamJavaFXPopSubDep3AddPane JavaFX Add Pane implementation
 *	for PopSubDep3.
 */
public class CFBamJavaFXPopSubDep3AddPane
extends CFSplitPane
implements ICFBamJavaFXPopSubDep3PaneCommon
{
	...
	public CFBamJavaFXPopSubDep3AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep3Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopSubDep3PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
