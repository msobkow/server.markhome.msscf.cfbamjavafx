// Description: Java 11 JavaFX Add Form implementation for TableCol.
...
/**
 *	CFBamJavaFXTableColAddForm JavaFX Add Form implementation
 *	for TableCol.
 */
public class CFBamJavaFXTableColAddForm
extends CFBorderPane
implements ICFBamJavaFXTableColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TableCol";
	...
	public CFBamJavaFXTableColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTableColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTableColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTableColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTableColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTableColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
