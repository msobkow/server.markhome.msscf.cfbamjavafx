// Description: Java 11 JavaFX Add Pane implementation for FloatDef.
...
/**
 *	CFBamJavaFXFloatDefAddPane JavaFX Add Pane implementation
 *	for FloatDef.
 */
public class CFBamJavaFXFloatDefAddPane
extends CFSplitPane
implements ICFBamJavaFXFloatDefPaneCommon
{
	...
	public CFBamJavaFXFloatDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXFloatDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
