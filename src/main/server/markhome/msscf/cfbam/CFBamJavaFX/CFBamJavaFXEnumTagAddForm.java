// Description: Java 11 JavaFX Add Form implementation for EnumTag.
...
/**
 *	CFBamJavaFXEnumTagAddForm JavaFX Add Form implementation
 *	for EnumTag.
 */
public class CFBamJavaFXEnumTagAddForm
extends CFBorderPane
implements ICFBamJavaFXEnumTagPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add EnumTag";
	...
	public CFBamJavaFXEnumTagAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getEnumTagFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXEnumTagPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getEnumTagFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTagPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXEnumTagPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
