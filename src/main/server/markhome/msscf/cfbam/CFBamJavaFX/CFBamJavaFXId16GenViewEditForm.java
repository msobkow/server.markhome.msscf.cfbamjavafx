// Description: Java 11 JavaFX View/Edit Form implementation for Id16Gen.
...
/**
 *	CFBamJavaFXId16GenViewEditForm JavaFX View/Edit Form implementation
 *	for Id16Gen.
 */
public class CFBamJavaFXId16GenViewEditForm
extends CFBorderPane
implements ICFBamJavaFXId16GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Id16Gen";
	...
	public CFBamJavaFXId16GenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId16GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamId16GenObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getId16GenFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamId16GenEditObj editObj = (ICFBamId16GenEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXId16GenPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamId16GenObj argFocus = (ICFBamId16GenObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamId16GenObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsId16Gen() != null ) {
							if( null == getJavaFXFocusAsId16Gen().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId16GenPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId16GenPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
