// Description: Java 11 JavaFX Add Form implementation for TZTimeDef.
...
/**
 *	CFBamJavaFXTZTimeDefAddForm JavaFX Add Form implementation
 *	for TZTimeDef.
 */
public class CFBamJavaFXTZTimeDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTZTimeDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZTimeDef";
	...
	public CFBamJavaFXTZTimeDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZTimeDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZTimeDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZTimeDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
