// Description: Java 11 JavaFX Add Form implementation for PopSubDep3.
...
/**
 *	CFBamJavaFXPopSubDep3AddForm JavaFX Add Form implementation
 *	for PopSubDep3.
 */
public class CFBamJavaFXPopSubDep3AddForm
extends CFBorderPane
implements ICFBamJavaFXPopSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "Add PopSubDep3";
	...
	public CFBamJavaFXPopSubDep3AddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep3Obj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getPopSubDep3Factory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXPopSubDep3PaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getPopSubDep3Factory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopSubDep3PaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopSubDep3PaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
