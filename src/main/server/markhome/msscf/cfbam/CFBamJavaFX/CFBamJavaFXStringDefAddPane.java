// Description: Java 11 JavaFX Add Pane implementation for StringDef.
...
/**
 *	CFBamJavaFXStringDefAddPane JavaFX Add Pane implementation
 *	for StringDef.
 */
public class CFBamJavaFXStringDefAddPane
extends CFSplitPane
implements ICFBamJavaFXStringDefPaneCommon
{
	...
	public CFBamJavaFXStringDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
