// Description: Java 11 JavaFX Element TabPane implementation for TextCol.
...
/**
 *	CFBamJavaFXTextColEltTabPane JavaFX Element TabPane implementation
 *	for TextCol.
 */
public class CFBamJavaFXTextColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTextColPaneCommon
{
	...
	public CFBamJavaFXTextColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTextColObj focus = (ICFBamTextColObj)getJavaFXFocusAsTextCol();
			if( focus != null ) {
