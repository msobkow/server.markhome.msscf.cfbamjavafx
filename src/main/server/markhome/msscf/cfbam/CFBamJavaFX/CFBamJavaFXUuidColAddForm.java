// Description: Java 11 JavaFX Add Form implementation for UuidCol.
...
/**
 *	CFBamJavaFXUuidColAddForm JavaFX Add Form implementation
 *	for UuidCol.
 */
public class CFBamJavaFXUuidColAddForm
extends CFBorderPane
implements ICFBamJavaFXUuidColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UuidCol";
	...
	public CFBamJavaFXUuidColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuidColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuidColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuidColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuidColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
