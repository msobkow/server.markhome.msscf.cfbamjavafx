// Description: Java 11 JavaFX Add Pane implementation for UuidDef.
...
/**
 *	CFBamJavaFXUuidDefAddPane JavaFX Add Pane implementation
 *	for UuidDef.
 */
public class CFBamJavaFXUuidDefAddPane
extends CFSplitPane
implements ICFBamJavaFXUuidDefPaneCommon
{
	...
	public CFBamJavaFXUuidDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
