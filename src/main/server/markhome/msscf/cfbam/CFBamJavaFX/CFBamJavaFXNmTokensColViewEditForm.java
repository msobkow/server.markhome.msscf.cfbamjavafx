// Description: Java 11 JavaFX View/Edit Form implementation for NmTokensCol.
...
/**
 *	CFBamJavaFXNmTokensColViewEditForm JavaFX View/Edit Form implementation
 *	for NmTokensCol.
 */
public class CFBamJavaFXNmTokensColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXNmTokensColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit NmTokensCol";
	...
	public CFBamJavaFXNmTokensColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getNmTokensColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokensColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsNmTokensCol() != null ) {
							if( null == getJavaFXFocusAsNmTokensCol().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
