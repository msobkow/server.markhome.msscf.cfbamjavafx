// Description: Java 11 JavaFX Add Pane implementation for UInt32Def.
...
/**
 *	CFBamJavaFXUInt32DefAddPane JavaFX Add Pane implementation
 *	for UInt32Def.
 */
public class CFBamJavaFXUInt32DefAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt32DefPaneCommon
{
	...
	public CFBamJavaFXUInt32DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
