// Description: Java 11 JavaFX Element TabPane implementation for Id64Gen.
...
/**
 *	CFBamJavaFXId64GenEltTabPane JavaFX Element TabPane implementation
 *	for Id64Gen.
 */
public class CFBamJavaFXId64GenEltTabPane
extends CFTabPane
implements ICFBamJavaFXId64GenPaneCommon
{
	...
	public CFBamJavaFXId64GenEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamId64GenObj focus = (ICFBamId64GenObj)getJavaFXFocusAsId64Gen();
			if( focus != null ) {
