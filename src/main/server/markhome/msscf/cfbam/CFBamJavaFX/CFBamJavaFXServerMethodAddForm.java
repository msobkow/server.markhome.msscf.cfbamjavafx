// Description: Java 11 JavaFX Add Form implementation for ServerMethod.
...
/**
 *	CFBamJavaFXServerMethodAddForm JavaFX Add Form implementation
 *	for ServerMethod.
 */
public class CFBamJavaFXServerMethodAddForm
extends CFBorderPane
implements ICFBamJavaFXServerMethodPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ServerMethod";
	...
	public CFBamJavaFXServerMethodAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerMethodObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getServerMethodFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerMethodPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerMethodPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
