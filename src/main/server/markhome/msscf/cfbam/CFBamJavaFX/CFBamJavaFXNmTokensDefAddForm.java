// Description: Java 11 JavaFX Add Form implementation for NmTokensDef.
...
/**
 *	CFBamJavaFXNmTokensDefAddForm JavaFX Add Form implementation
 *	for NmTokensDef.
 */
public class CFBamJavaFXNmTokensDefAddForm
extends CFBorderPane
implements ICFBamJavaFXNmTokensDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NmTokensDef";
	...
	public CFBamJavaFXNmTokensDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNmTokensDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokensDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNmTokensDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
