// Description: Java 11 JavaFX Add Pane implementation for TimestampType.
...
/**
 *	CFBamJavaFXTimestampTypeAddPane JavaFX Add Pane implementation
 *	for TimestampType.
 */
public class CFBamJavaFXTimestampTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXTimestampTypePaneCommon
{
	...
	public CFBamJavaFXTimestampTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
