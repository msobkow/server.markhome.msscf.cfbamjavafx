// Description: Java 11 JavaFX Add Pane implementation for TokenDef.
...
/**
 *	CFBamJavaFXTokenDefAddPane JavaFX Add Pane implementation
 *	for TokenDef.
 */
public class CFBamJavaFXTokenDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTokenDefPaneCommon
{
	...
	public CFBamJavaFXTokenDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
