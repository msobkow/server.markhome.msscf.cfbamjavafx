// Description: Java 11 JavaFX Ask Delete Pane implementation for ServerProc.
...
/**
 *	CFBamJavaFXServerProcAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ServerProc.
 */
public class CFBamJavaFXServerProcAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXServerProcPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ServerProc";
	...
	public CFBamJavaFXServerProcAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerProcObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ServerProc?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamServerProcObj obj = getJavaFXFocusAsServerProc();
					ICFBamServerProcEditObj editObj = (ICFBamServerProcEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsServerProc( ICFBamServerProcObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXServerProcPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXServerProcPaneCommon)attrPane).setPaneMode( value );
		}
	}
