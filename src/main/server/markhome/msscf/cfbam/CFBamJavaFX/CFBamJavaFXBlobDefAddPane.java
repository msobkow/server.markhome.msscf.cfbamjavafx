// Description: Java 11 JavaFX Add Pane implementation for BlobDef.
...
/**
 *	CFBamJavaFXBlobDefAddPane JavaFX Add Pane implementation
 *	for BlobDef.
 */
public class CFBamJavaFXBlobDefAddPane
extends CFSplitPane
implements ICFBamJavaFXBlobDefPaneCommon
{
	...
	public CFBamJavaFXBlobDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
