// Description: Java 11 JavaFX Attribute Pane implementation for TableCol.
...
implements ICFBamJavaFXTableColPaneCommon
{
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			if( refTable == null ) {
				CFConsole.message( "You must specify a Containing Table before selecting a Column Data Type" );
				return;
			}
			ICFBamSchemaDefObj refSchemaDef = refTable.getRequiredContainerSchemaDef( javafxIsInitializing );
			if( refSchemaDef == null ) {
				CFConsole.message( "You must specify a Containing Schema Definition before selecting a Column Data Type" );
				return;
			}
