// Description: Java 11 JavaFX View/Edit Form implementation for Int16Type.
...
/**
 *	CFBamJavaFXInt16TypeViewEditForm JavaFX View/Edit Form implementation
 *	for Int16Type.
 */
public class CFBamJavaFXInt16TypeViewEditForm
extends CFBorderPane
implements ICFBamJavaFXInt16TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Int16Type";
	...
	public CFBamJavaFXInt16TypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamInt16TypeObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getInt16TypeFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamInt16TypeEditObj editObj = (ICFBamInt16TypeEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt16TypePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamInt16TypeObj argFocus = (ICFBamInt16TypeObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamInt16TypeObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsInt16Type() != null ) {
							if( null == getJavaFXFocusAsInt16Type().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsInt16Type();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16TypePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt16TypePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
