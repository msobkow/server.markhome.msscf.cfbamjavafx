// Description: Java 11 JavaFX Element TabPane implementation for Int64Def.
...
/**
 *	CFBamJavaFXInt64DefEltTabPane JavaFX Element TabPane implementation
 *	for Int64Def.
 */
public class CFBamJavaFXInt64DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXInt64DefPaneCommon
{
	...
	public CFBamJavaFXInt64DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamInt64DefObj focus = (ICFBamInt64DefObj)getJavaFXFocusAsInt64Def();
			if( focus != null ) {
