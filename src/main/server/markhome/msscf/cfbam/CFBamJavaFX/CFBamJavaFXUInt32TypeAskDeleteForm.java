// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt32Type.
...
/**
 *	CFBamJavaFXUInt32TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt32Type.
 */
public class CFBamJavaFXUInt32TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt32TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt32Type";
	...
	public CFBamJavaFXUInt32TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt32Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt32TypeObj obj = getJavaFXFocusAsUInt32Type();
					ICFBamUInt32TypeEditObj editObj = (ICFBamUInt32TypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt32Type( ICFBamUInt32TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt32TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
