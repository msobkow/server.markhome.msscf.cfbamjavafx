// Description: Java 11 JavaFX Add Pane implementation for DoubleDef.
...
/**
 *	CFBamJavaFXDoubleDefAddPane JavaFX Add Pane implementation
 *	for DoubleDef.
 */
public class CFBamJavaFXDoubleDefAddPane
extends CFSplitPane
implements ICFBamJavaFXDoubleDefPaneCommon
{
	...
	public CFBamJavaFXDoubleDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
