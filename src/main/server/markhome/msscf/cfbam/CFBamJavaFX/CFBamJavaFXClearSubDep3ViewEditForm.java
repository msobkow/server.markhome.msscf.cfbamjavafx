// Description: Java 11 JavaFX View/Edit Form implementation for ClearSubDep3.
...
/**
 *	CFBamJavaFXClearSubDep3ViewEditForm JavaFX View/Edit Form implementation
 *	for ClearSubDep3.
 */
public class CFBamJavaFXClearSubDep3ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit ClearSubDep3";
	...
	public CFBamJavaFXClearSubDep3ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep3Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getClearSubDep3Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearSubDep3PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsClearSubDep3() != null ) {
							if( null == getJavaFXFocusAsClearSubDep3().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep3PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep3PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
