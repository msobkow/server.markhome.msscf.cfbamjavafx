// Description: Java 11 JavaFX Ask Delete Pane implementation for Index.
...
/**
 *	CFBamJavaFXIndexAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Index.
 */
public class CFBamJavaFXIndexAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXIndexPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Index";
	...
	public CFBamJavaFXIndexAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Index?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamIndexObj obj = getJavaFXFocusAsIndex();
					ICFBamIndexEditObj editObj = (ICFBamIndexEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsIndex( ICFBamIndexObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXIndexPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
