// Description: Java 11 JavaFX Add Pane implementation for TZTimeType.
...
/**
 *	CFBamJavaFXTZTimeTypeAddPane JavaFX Add Pane implementation
 *	for TZTimeType.
 */
public class CFBamJavaFXTZTimeTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXTZTimeTypePaneCommon
{
	...
	public CFBamJavaFXTZTimeTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
