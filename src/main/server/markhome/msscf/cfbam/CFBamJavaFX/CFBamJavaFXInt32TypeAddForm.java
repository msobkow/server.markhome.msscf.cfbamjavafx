// Description: Java 11 JavaFX Add Form implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypeAddForm JavaFX Add Form implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXInt32TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int32Type";
	...
	public CFBamJavaFXInt32TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt32TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt32TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt32TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt32TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
