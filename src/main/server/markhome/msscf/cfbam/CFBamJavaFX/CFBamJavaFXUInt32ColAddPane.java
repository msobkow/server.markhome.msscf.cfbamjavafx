// Description: Java 11 JavaFX Add Pane implementation for UInt32Col.
...
/**
 *	CFBamJavaFXUInt32ColAddPane JavaFX Add Pane implementation
 *	for UInt32Col.
 */
public class CFBamJavaFXUInt32ColAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt32ColPaneCommon
{
	...
	public CFBamJavaFXUInt32ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
