// Description: Java 11 JavaFX Add Pane implementation for BoolDef.
...
/**
 *	CFBamJavaFXBoolDefAddPane JavaFX Add Pane implementation
 *	for BoolDef.
 */
public class CFBamJavaFXBoolDefAddPane
extends CFSplitPane
implements ICFBamJavaFXBoolDefPaneCommon
{
	...
	public CFBamJavaFXBoolDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
