// Description: Java 11 JavaFX View/Edit Pane implementation for UInt64Col.
...
/**
 *	CFBamJavaFXUInt64ColViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt64Col.
 */
public class CFBamJavaFXUInt64ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt64ColPaneCommon
{
	...
	public CFBamJavaFXUInt64ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64ColPaneCommon)attrPane).setPaneMode( value );
			((ICFBamJavaFXUInt64ColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt64ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt64ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
