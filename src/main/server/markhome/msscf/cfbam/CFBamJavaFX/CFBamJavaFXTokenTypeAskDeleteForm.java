// Description: Java 11 JavaFX Ask Delete Pane implementation for TokenType.
...
/**
 *	CFBamJavaFXTokenTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TokenType.
 */
public class CFBamJavaFXTokenTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTokenTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TokenType";
	...
	public CFBamJavaFXTokenTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TokenType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTokenTypeObj obj = getJavaFXFocusAsTokenType();
					ICFBamTokenTypeEditObj editObj = (ICFBamTokenTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTokenType( ICFBamTokenTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTokenTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTokenTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
