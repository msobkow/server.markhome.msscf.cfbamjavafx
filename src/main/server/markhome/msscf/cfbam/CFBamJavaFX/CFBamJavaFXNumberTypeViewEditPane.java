// Description: Java 11 JavaFX View/Edit Pane implementation for NumberType.
...
/**
 *	CFBamJavaFXNumberTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for NumberType.
 */
public class CFBamJavaFXNumberTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNumberTypePaneCommon
{
	...
	public CFBamJavaFXNumberTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNumberTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNumberTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
