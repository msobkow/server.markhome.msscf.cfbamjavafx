// Description: Java 11 JavaFX Add Form implementation for Value.
...
/**
 *	CFBamJavaFXValueAddForm JavaFX Add Form implementation
 *	for Value.
 */
public class CFBamJavaFXValueAddForm
extends CFBorderPane
implements ICFBamJavaFXValuePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Value";
	...
	public CFBamJavaFXValueAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamValueObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getValueFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXValuePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getValueFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXValuePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXValuePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
