// Description: Java 11 JavaFX Element TabPane implementation for NmTokenDef.
...
/**
 *	CFBamJavaFXNmTokenDefEltTabPane JavaFX Element TabPane implementation
 *	for NmTokenDef.
 */
public class CFBamJavaFXNmTokenDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXNmTokenDefPaneCommon
{
	...
	public CFBamJavaFXNmTokenDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNmTokenDefObj focus = (ICFBamNmTokenDefObj)getJavaFXFocusAsNmTokenDef();
			if( focus != null ) {
