// Description: Java 11 JavaFX Element TabPane implementation for UInt32Type.
...
/**
 *	CFBamJavaFXUInt32TypeEltTabPane JavaFX Element TabPane implementation
 *	for UInt32Type.
 */
public class CFBamJavaFXUInt32TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt32TypePaneCommon
{
	...
	public CFBamJavaFXUInt32TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt32TypeObj focus = (ICFBamUInt32TypeObj)getJavaFXFocusAsUInt32Type();
			if( focus != null ) {
