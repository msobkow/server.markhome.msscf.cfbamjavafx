// Description: Java 11 JavaFX Ask Delete Pane implementation for DelTopDep.
...
/**
 *	CFBamJavaFXDelTopDepAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DelTopDep.
 */
public class CFBamJavaFXDelTopDepAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDelTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DelTopDep";
	...
	public CFBamJavaFXDelTopDepAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DelTopDep?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDelTopDepObj obj = getJavaFXFocusAsDelTopDep();
					ICFBamDelTopDepEditObj editObj = (ICFBamDelTopDepEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsDelTopDep( ICFBamDelTopDepObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDelTopDepPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
