// Description: Java 11 JavaFX Add Form implementation for Atom.
...
/**
 *	CFBamJavaFXAtomAddForm JavaFX Add Form implementation
 *	for Atom.
 */
public class CFBamJavaFXAtomAddForm
extends CFBorderPane
implements ICFBamJavaFXAtomPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Atom";
	...
	public CFBamJavaFXAtomAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamAtomObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getAtomFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXAtomPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getAtomFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXAtomPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXAtomPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
