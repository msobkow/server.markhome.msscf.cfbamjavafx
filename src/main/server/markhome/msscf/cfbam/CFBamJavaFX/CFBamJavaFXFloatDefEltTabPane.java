// Description: Java 11 JavaFX Element TabPane implementation for FloatDef.
...
/**
 *	CFBamJavaFXFloatDefEltTabPane JavaFX Element TabPane implementation
 *	for FloatDef.
 */
public class CFBamJavaFXFloatDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXFloatDefPaneCommon
{
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamFloatDefObj focus = (ICFBamFloatDefObj)getJavaFXFocusAsFloatDef();
			if( focus != null ) {
