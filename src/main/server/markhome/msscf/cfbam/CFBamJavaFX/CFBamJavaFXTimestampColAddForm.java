// Description: Java 11 JavaFX Add Form implementation for TimestampCol.
...
/**
 *	CFBamJavaFXTimestampColAddForm JavaFX Add Form implementation
 *	for TimestampCol.
 */
public class CFBamJavaFXTimestampColAddForm
extends CFBorderPane
implements ICFBamJavaFXTimestampColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TimestampCol";
	...
	public CFBamJavaFXTimestampColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTimestampColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTimestampColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTimestampColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimestampColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
