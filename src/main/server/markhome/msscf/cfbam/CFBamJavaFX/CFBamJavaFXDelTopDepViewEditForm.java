// Description: Java 11 JavaFX View/Edit Form implementation for DelTopDep.
...
/**
 *	CFBamJavaFXDelTopDepViewEditForm JavaFX View/Edit Form implementation
 *	for DelTopDep.
 */
public class CFBamJavaFXDelTopDepViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDelTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DelTopDep";
	...
	public CFBamJavaFXDelTopDepViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelTopDepObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getDelTopDepFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelTopDepPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamDelTopDepObj argFocus = (ICFBamDelTopDepObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelTopDepObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDelTopDep() != null ) {
							if( null == getJavaFXFocusAsDelTopDep().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsDelTopDep();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelTopDepPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelTopDepPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
