// Description: Java 11 JavaFX Add Pane implementation for EnumType.
...
/**
 *	CFBamJavaFXEnumTypeAddPane JavaFX Add Pane implementation
 *	for EnumType.
 */
public class CFBamJavaFXEnumTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXEnumTypePaneCommon
{
	...
	public CFBamJavaFXEnumTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
