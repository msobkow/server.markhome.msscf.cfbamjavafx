// Description: Java 11 JavaFX Ask Delete Pane implementation for TimestampCol.
...
/**
 *	CFBamJavaFXTimestampColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TimestampCol.
 */
public class CFBamJavaFXTimestampColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTimestampColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TimestampCol";
	...
	public CFBamJavaFXTimestampColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TimestampCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTimestampColObj obj = getJavaFXFocusAsTimestampCol();
					ICFBamTimestampColEditObj editObj = (ICFBamTimestampColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTimestampCol( ICFBamTimestampColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTimestampColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTimestampColPaneCommon)attrPane).setPaneMode( value );
		}
	}
