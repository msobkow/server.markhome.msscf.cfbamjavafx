// Description: Java 11 JavaFX Element TabPane implementation for NmTokenCol.
...
/**
 *	CFBamJavaFXNmTokenColEltTabPane JavaFX Element TabPane implementation
 *	for NmTokenCol.
 */
public class CFBamJavaFXNmTokenColEltTabPane
extends CFTabPane
implements ICFBamJavaFXNmTokenColPaneCommon
{
	...
	public CFBamJavaFXNmTokenColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNmTokenColObj focus = (ICFBamNmTokenColObj)getJavaFXFocusAsNmTokenCol();
			if( focus != null ) {
