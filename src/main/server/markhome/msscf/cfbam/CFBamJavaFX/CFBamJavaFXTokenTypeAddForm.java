// Description: Java 11 JavaFX Add Form implementation for TokenType.
...
/**
 *	CFBamJavaFXTokenTypeAddForm JavaFX Add Form implementation
 *	for TokenType.
 */
public class CFBamJavaFXTokenTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXTokenTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TokenType";
	...
	public CFBamJavaFXTokenTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTokenTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTokenTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTokenTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTokenTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
