// Description: Java 11 JavaFX View/Edit Form implementation for TimeCol.
...
/**
 *	CFBamJavaFXTimeColViewEditForm JavaFX View/Edit Form implementation
 *	for TimeCol.
 */
public class CFBamJavaFXTimeColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTimeColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TimeCol";
	...
	public CFBamJavaFXTimeColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getTimeColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTimeColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTimeCol() != null ) {
							if( null == getJavaFXFocusAsTimeCol().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimeColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
