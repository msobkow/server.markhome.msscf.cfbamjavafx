// Description: Java 11 JavaFX Add Pane implementation for UInt64Def.
...
/**
 *	CFBamJavaFXUInt64DefAddPane JavaFX Add Pane implementation
 *	for UInt64Def.
 */
public class CFBamJavaFXUInt64DefAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt64DefPaneCommon
{
	...
	public CFBamJavaFXUInt64DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
