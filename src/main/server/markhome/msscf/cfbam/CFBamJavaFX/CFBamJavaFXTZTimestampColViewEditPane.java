// Description: Java 11 JavaFX View/Edit Pane implementation for TZTimestampCol.
...
/**
 *	CFBamJavaFXTZTimestampColViewEditPane JavaFX View/Edit Pane implementation
 *	for TZTimestampCol.
 */
public class CFBamJavaFXTZTimestampColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZTimestampColPaneCommon
{
	...
	public CFBamJavaFXTZTimestampColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimestampColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZTimestampColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
