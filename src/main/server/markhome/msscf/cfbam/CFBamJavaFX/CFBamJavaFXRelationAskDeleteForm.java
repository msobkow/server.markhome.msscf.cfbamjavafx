// Description: Java 11 JavaFX Ask Delete Pane implementation for Relation.
...
/**
 *	CFBamJavaFXRelationAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Relation.
 */
public class CFBamJavaFXRelationAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXRelationPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Relation";
	...
	public CFBamJavaFXRelationAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Relation?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamRelationObj obj = getJavaFXFocusAsRelation();
					ICFBamRelationEditObj editObj = (ICFBamRelationEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsRelation( ICFBamRelationObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXRelationPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXRelationPaneCommon)attrPane).setPaneMode( value );
		}
	}
