// Description: Java 11 JavaFX Add Pane implementation for Int16Type.
...
/**
 *	CFBamJavaFXInt16TypeAddPane JavaFX Add Pane implementation
 *	for Int16Type.
 */
public class CFBamJavaFXInt16TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXInt16TypePaneCommon
{
	...
	public CFBamJavaFXInt16TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
