// Description: Java 11 JavaFX View/Edit Pane implementation for Relation.
...
/**
 *	CFBamJavaFXRelationViewEditPane JavaFX View/Edit Pane implementation
 *	for Relation.
 */
public class CFBamJavaFXRelationViewEditPane
extends CFSplitPane
implements ICFBamJavaFXRelationPaneCommon
{
	...
	public CFBamJavaFXRelationViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getRelationFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXRelationPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXRelationPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
