// Description: Java 11 JavaFX Element TabPane implementation for ServerMethod.
...
/**
 *	CFBamJavaFXServerMethodEltTabPane JavaFX Element TabPane implementation
 *	for ServerMethod.
 */
public class CFBamJavaFXServerMethodEltTabPane
extends CFTabPane
implements ICFBamJavaFXServerMethodPaneCommon
{
	...
	public CFBamJavaFXServerMethodEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerMethodObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamServerMethodObj focus = (ICFBamServerMethodObj)getJavaFXFocusAsServerMethod();
			if( focus != null ) {
