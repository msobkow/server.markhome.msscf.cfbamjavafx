// Description: Java 11 JavaFX Ask Delete Pane implementation for DelSubDep1.
...
/**
 *	CFBamJavaFXDelSubDep1AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DelSubDep1.
 */
public class CFBamJavaFXDelSubDep1AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DelSubDep1";
	...
	public CFBamJavaFXDelSubDep1AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep1Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DelSubDep1?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDelSubDep1Obj obj = getJavaFXFocusAsDelSubDep1();
					ICFBamDelSubDep1EditObj editObj = (ICFBamDelSubDep1EditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsDelSubDep1( ICFBamDelSubDep1Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDelSubDep1PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDelSubDep1PaneCommon)attrPane).setPaneMode( value );
		}
	}
