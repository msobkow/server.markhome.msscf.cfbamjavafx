// Description: Java 11 JavaFX Element TabPane implementation for BlobType.
...
/**
 *	CFBamJavaFXBlobTypeEltTabPane JavaFX Element TabPane implementation
 *	for BlobType.
 */
public class CFBamJavaFXBlobTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXBlobTypePaneCommon
{
	...
	public CFBamJavaFXBlobTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamBlobTypeObj focus = (ICFBamBlobTypeObj)getJavaFXFocusAsBlobType();
			if( focus != null ) {
