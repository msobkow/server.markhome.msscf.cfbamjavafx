// Description: Java 11 JavaFX Attribute Pane implementation for UInt16Col.
...
/**
 *	CFBamJavaFXUInt16ColAttrPane JavaFX Attribute Pane implementation
 *	for UInt16Col.
 */
public class CFBamJavaFXUInt16ColAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt16ColPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUInt16ColObj cur = getJavaFXFocusAsUInt16Col();
				if( cur != null ) {
					ICFBamUInt16ColEditObj editObj = (ICFBamUInt16ColEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUInt16ColObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXUInt16ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamUInt16ColObj getEffJavaFXFocus() {
		ICFBamUInt16ColObj eff = (ICFBamUInt16ColObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUInt16ColObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUInt16ColObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamUInt16ColObj focus = getJavaFXFocusAsUInt16Col();
		ICFBamUInt16ColEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUInt16ColEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUInt16ColEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUInt16ColObj)editObj.create();
