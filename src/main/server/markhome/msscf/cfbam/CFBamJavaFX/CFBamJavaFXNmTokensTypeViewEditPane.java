// Description: Java 11 JavaFX View/Edit Pane implementation for NmTokensType.
...
/**
 *	CFBamJavaFXNmTokensTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for NmTokensType.
 */
public class CFBamJavaFXNmTokensTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNmTokensTypePaneCommon
{
	...
	public CFBamJavaFXNmTokensTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
