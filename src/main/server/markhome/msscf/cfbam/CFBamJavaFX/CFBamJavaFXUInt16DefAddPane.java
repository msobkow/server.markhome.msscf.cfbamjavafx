// Description: Java 11 JavaFX Add Pane implementation for UInt16Def.
...
/**
 *	CFBamJavaFXUInt16DefAddPane JavaFX Add Pane implementation
 *	for UInt16Def.
 */
public class CFBamJavaFXUInt16DefAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt16DefPaneCommon
{
	...
	public CFBamJavaFXUInt16DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
