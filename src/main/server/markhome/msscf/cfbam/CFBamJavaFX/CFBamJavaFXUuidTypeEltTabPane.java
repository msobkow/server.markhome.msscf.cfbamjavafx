// Description: Java 11 JavaFX Element TabPane implementation for UuidType.
...
/**
 *	CFBamJavaFXUuidTypeEltTabPane JavaFX Element TabPane implementation
 *	for UuidType.
 */
public class CFBamJavaFXUuidTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuidTypePaneCommon
{
	...
	public CFBamJavaFXUuidTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuidTypeObj focus = (ICFBamUuidTypeObj)getJavaFXFocusAsUuidType();
			if( focus != null ) {
