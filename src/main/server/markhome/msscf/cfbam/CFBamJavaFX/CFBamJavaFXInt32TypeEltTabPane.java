// Description: Java 11 JavaFX Element TabPane implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypeEltTabPane JavaFX Element TabPane implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXInt32TypePaneCommon
{
	...
	public CFBamJavaFXInt32TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamInt32TypeObj focus = (ICFBamInt32TypeObj)getJavaFXFocusAsInt32Type();
			if( focus != null ) {
