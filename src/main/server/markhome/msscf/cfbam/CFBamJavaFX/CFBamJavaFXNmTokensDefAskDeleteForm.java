// Description: Java 11 JavaFX Ask Delete Pane implementation for NmTokensDef.
...
/**
 *	CFBamJavaFXNmTokensDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NmTokensDef.
 */
public class CFBamJavaFXNmTokensDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNmTokensDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NmTokensDef";
	...
	public CFBamJavaFXNmTokensDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NmTokensDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNmTokensDefObj obj = getJavaFXFocusAsNmTokensDef();
					ICFBamNmTokensDefEditObj editObj = (ICFBamNmTokensDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNmTokensDef( ICFBamNmTokensDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokensDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokensDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
