// Description: Java 11 JavaFX Add Pane implementation for DoubleType.
...
/**
 *	CFBamJavaFXDoubleTypeAddPane JavaFX Add Pane implementation
 *	for DoubleType.
 */
public class CFBamJavaFXDoubleTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXDoubleTypePaneCommon
{
	...
	public CFBamJavaFXDoubleTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
