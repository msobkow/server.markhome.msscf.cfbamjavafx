// Description: Java 11 JavaFX Add Form implementation for ClearDep.
...
/**
 *	CFBamJavaFXClearDepAddForm JavaFX Add Form implementation
 *	for ClearDep.
 */
public class CFBamJavaFXClearDepAddForm
extends CFBorderPane
implements ICFBamJavaFXClearDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ClearDep";
	...
	public CFBamJavaFXClearDepAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearDepObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getClearDepFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearDepPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getClearDepFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearDepPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearDepPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
