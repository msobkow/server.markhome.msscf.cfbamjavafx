// Description: Java 11 JavaFX Add Pane implementation for NumberDef.
...
/**
 *	CFBamJavaFXNumberDefAddPane JavaFX Add Pane implementation
 *	for NumberDef.
 */
public class CFBamJavaFXNumberDefAddPane
extends CFSplitPane
implements ICFBamJavaFXNumberDefPaneCommon
{
	...
	public CFBamJavaFXNumberDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
