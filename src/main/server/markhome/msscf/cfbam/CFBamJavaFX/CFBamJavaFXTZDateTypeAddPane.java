// Description: Java 11 JavaFX Add Pane implementation for TZDateType.
...
/**
 *	CFBamJavaFXTZDateTypeAddPane JavaFX Add Pane implementation
 *	for TZDateType.
 */
public class CFBamJavaFXTZDateTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXTZDateTypePaneCommon
{
	...
	public CFBamJavaFXTZDateTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
