// Description: Java 11 JavaFX View/Edit Pane implementation for IndexCol.
...
/**
 *	CFBamJavaFXIndexColViewEditPane JavaFX View/Edit Pane implementation
 *	for IndexCol.
 */
public class CFBamJavaFXIndexColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXIndexColPaneCommon
{
	...
	public CFBamJavaFXIndexColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getIndexColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXIndexColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXIndexColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXIndexColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
