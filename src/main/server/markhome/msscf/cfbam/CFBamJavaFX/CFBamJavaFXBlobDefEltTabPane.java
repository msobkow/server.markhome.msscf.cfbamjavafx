// Description: Java 11 JavaFX Element TabPane implementation for BlobDef.
...
/**
 *	CFBamJavaFXBlobDefEltTabPane JavaFX Element TabPane implementation
 *	for BlobDef.
 */
public class CFBamJavaFXBlobDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXBlobDefPaneCommon
{
	...
	public CFBamJavaFXBlobDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamBlobDefObj focus = (ICFBamBlobDefObj)getJavaFXFocusAsBlobDef();
			if( focus != null ) {
