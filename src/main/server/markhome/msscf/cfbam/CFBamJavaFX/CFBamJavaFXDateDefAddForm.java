// Description: Java 11 JavaFX Add Form implementation for DateDef.
...
/**
 *	CFBamJavaFXDateDefAddForm JavaFX Add Form implementation
 *	for DateDef.
 */
public class CFBamJavaFXDateDefAddForm
extends CFBorderPane
implements ICFBamJavaFXDateDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DateDef";
	...
	public CFBamJavaFXDateDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDateDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDateDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDateDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDateDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
