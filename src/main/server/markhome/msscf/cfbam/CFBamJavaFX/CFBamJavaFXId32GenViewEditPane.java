// Description: Java 11 JavaFX View/Edit Pane implementation for Id32Gen.
...
/**
 *	CFBamJavaFXId32GenViewEditPane JavaFX View/Edit Pane implementation
 *	for Id32Gen.
 */
public class CFBamJavaFXId32GenViewEditPane
extends CFSplitPane
implements ICFBamJavaFXId32GenPaneCommon
{
	...
	public CFBamJavaFXId32GenViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId32GenObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getId32GenFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId32GenPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId32GenPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXId32GenPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
