// Description: Java 11 JavaFX Element TabPane implementation for TZTimestampType.
...
/**
 *	CFBamJavaFXTZTimestampTypeEltTabPane JavaFX Element TabPane implementation
 *	for TZTimestampType.
 */
public class CFBamJavaFXTZTimestampTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZTimestampTypePaneCommon
{
	...
	public CFBamJavaFXTZTimestampTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZTimestampTypeObj focus = (ICFBamTZTimestampTypeObj)getJavaFXFocusAsTZTimestampType();
			if( focus != null ) {
