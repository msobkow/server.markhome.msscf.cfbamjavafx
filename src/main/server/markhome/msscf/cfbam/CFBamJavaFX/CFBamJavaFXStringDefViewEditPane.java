// Description: Java 11 JavaFX View/Edit Pane implementation for StringDef.
...
/**
 *	CFBamJavaFXStringDefViewEditPane JavaFX View/Edit Pane implementation
 *	for StringDef.
 */
public class CFBamJavaFXStringDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXStringDefPaneCommon
{
	...
	public CFBamJavaFXStringDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXStringDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXStringDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
