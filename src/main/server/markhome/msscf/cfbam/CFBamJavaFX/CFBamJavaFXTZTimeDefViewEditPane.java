// Description: Java 11 JavaFX View/Edit Pane implementation for TZTimeDef.
...
/**
 *	CFBamJavaFXTZTimeDefViewEditPane JavaFX View/Edit Pane implementation
 *	for TZTimeDef.
 */
public class CFBamJavaFXTZTimeDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZTimeDefPaneCommon
{
	...
	public CFBamJavaFXTZTimeDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
