// Description: Java 11 JavaFX Ask Delete Pane implementation for TextType.
...
/**
 *	CFBamJavaFXTextTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TextType.
 */
public class CFBamJavaFXTextTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTextTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TextType";
	...
	public CFBamJavaFXTextTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TextType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTextTypeObj obj = getJavaFXFocusAsTextType();
					ICFBamTextTypeEditObj editObj = (ICFBamTextTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTextType( ICFBamTextTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTextTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTextTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
