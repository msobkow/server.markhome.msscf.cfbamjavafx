// Description: Java 11 JavaFX Element TabPane implementation for NmTokensType.
...
/**
 *	CFBamJavaFXNmTokensTypeEltTabPane JavaFX Element TabPane implementation
 *	for NmTokensType.
 */
public class CFBamJavaFXNmTokensTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXNmTokensTypePaneCommon
{
	...
	public CFBamJavaFXNmTokensTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNmTokensTypeObj focus = (ICFBamNmTokensTypeObj)getJavaFXFocusAsNmTokensType();
			if( focus != null ) {
