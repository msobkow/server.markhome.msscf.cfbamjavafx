// Description: Java 11 JavaFX Element TabPane implementation for UInt16Col.
...
/**
 *	CFBamJavaFXUInt16ColEltTabPane JavaFX Element TabPane implementation
 *	for UInt16Col.
 */
public class CFBamJavaFXUInt16ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt16ColPaneCommon
{
	...
	public CFBamJavaFXUInt16ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt16ColObj focus = (ICFBamUInt16ColObj)getJavaFXFocusAsUInt16Col();
			if( focus != null ) {
