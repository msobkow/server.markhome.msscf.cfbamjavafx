// Description: Java 11 JavaFX Ask Delete Pane implementation for Id64Gen.
...
/**
 *	CFBamJavaFXId64GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Id64Gen.
 */
public class CFBamJavaFXId64GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXId64GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Id64Gen";
	...
	public CFBamJavaFXId64GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Id64Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamId64GenObj obj = getJavaFXFocusAsId64Gen();
					ICFBamId64GenEditObj editObj = (ICFBamId64GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getId64GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsId64Gen( ICFBamId64GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXId64GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXId64GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
