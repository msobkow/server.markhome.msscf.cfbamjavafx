// Description: Java 11 JavaFX Add Form implementation for UInt32Col.
...
/**
 *	CFBamJavaFXUInt32ColAddForm JavaFX Add Form implementation
 *	for UInt32Col.
 */
public class CFBamJavaFXUInt32ColAddForm
extends CFBorderPane
implements ICFBamJavaFXUInt32ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UInt32Col";
	...
	public CFBamJavaFXUInt32ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUInt32ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt32ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUInt32ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt32ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
