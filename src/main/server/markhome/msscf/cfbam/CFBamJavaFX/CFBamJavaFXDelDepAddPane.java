// Description: Java 11 JavaFX Add Pane implementation for DelDep.
...
/**
 *	CFBamJavaFXDelDepAddPane JavaFX Add Pane implementation
 *	for DelDep.
 */
public class CFBamJavaFXDelDepAddPane
extends CFSplitPane
implements ICFBamJavaFXDelDepPaneCommon
{
	...
	public CFBamJavaFXDelDepAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelDepPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
