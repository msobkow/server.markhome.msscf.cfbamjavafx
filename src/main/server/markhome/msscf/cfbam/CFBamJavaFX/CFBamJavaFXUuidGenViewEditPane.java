// Description: Java 11 JavaFX View/Edit Pane implementation for UuidGen.
...
/**
 *	CFBamJavaFXUuidGenViewEditPane JavaFX View/Edit Pane implementation
 *	for UuidGen.
 */
public class CFBamJavaFXUuidGenViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUuidGenPaneCommon
{
	...
	public CFBamJavaFXUuidGenViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidGenObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getUuidGenFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidGenPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuidGenPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUuidGenPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
