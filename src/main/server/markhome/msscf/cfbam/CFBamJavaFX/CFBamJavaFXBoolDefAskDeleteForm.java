// Description: Java 11 JavaFX Ask Delete Pane implementation for BoolDef.
...
/**
 *	CFBamJavaFXBoolDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for BoolDef.
 */
public class CFBamJavaFXBoolDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXBoolDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete BoolDef";
	...
	public CFBamJavaFXBoolDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this BoolDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamBoolDefObj obj = getJavaFXFocusAsBoolDef();
					ICFBamBoolDefEditObj editObj = (ICFBamBoolDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsBoolDef( ICFBamBoolDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXBoolDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXBoolDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
