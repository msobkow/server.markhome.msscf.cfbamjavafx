// Description: Java 11 JavaFX Add Pane implementation for NmTokenType.
...
/**
 *	CFBamJavaFXNmTokenTypeAddPane JavaFX Add Pane implementation
 *	for NmTokenType.
 */
public class CFBamJavaFXNmTokenTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXNmTokenTypePaneCommon
{
	...
	public CFBamJavaFXNmTokenTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
