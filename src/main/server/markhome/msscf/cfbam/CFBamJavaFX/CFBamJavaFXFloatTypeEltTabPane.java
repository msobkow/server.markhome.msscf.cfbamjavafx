// Description: Java 11 JavaFX Element TabPane implementation for FloatType.
...
/**
 *	CFBamJavaFXFloatTypeEltTabPane JavaFX Element TabPane implementation
 *	for FloatType.
 */
public class CFBamJavaFXFloatTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXFloatTypePaneCommon
{
	...
	public CFBamJavaFXFloatTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamFloatTypeObj focus = (ICFBamFloatTypeObj)getJavaFXFocusAsFloatType();
			if( focus != null ) {
