// Description: Java 11 JavaFX Add Form implementation for Id32Gen.
...
/**
 *	CFBamJavaFXId32GenAddForm JavaFX Add Form implementation
 *	for Id32Gen.
 */
public class CFBamJavaFXId32GenAddForm
extends CFBorderPane
implements ICFBamJavaFXId32GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Id32Gen";
	...
	public CFBamJavaFXId32GenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId32GenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getId32GenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXId32GenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getId32GenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId32GenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId32GenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
