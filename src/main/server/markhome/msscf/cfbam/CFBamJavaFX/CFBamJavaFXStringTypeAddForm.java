// Description: Java 11 JavaFX Add Form implementation for StringType.
...
/**
 *	CFBamJavaFXStringTypeAddForm JavaFX Add Form implementation
 *	for StringType.
 */
public class CFBamJavaFXStringTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXStringTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add StringType";
	...
	public CFBamJavaFXStringTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getStringTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXStringTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getStringTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXStringTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
