// Description: Java 11 JavaFX View/Edit Pane implementation for NmTokensCol.
...
/**
 *	CFBamJavaFXNmTokensColViewEditPane JavaFX View/Edit Pane implementation
 *	for NmTokensCol.
 */
public class CFBamJavaFXNmTokensColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNmTokensColPaneCommon
{
	...
	public CFBamJavaFXNmTokensColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
