// Description: Java 11 JavaFX Attribute Pane implementation for UInt64Type.
...
/**
 *	CFBamJavaFXUInt64TypeAttrPane JavaFX Attribute Pane implementation
 *	for UInt64Type.
 */
public class CFBamJavaFXUInt64TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt64TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUInt64TypeObj cur = getJavaFXFocusAsUInt64Type();
				if( cur != null ) {
					ICFBamUInt64TypeEditObj editObj = (ICFBamUInt64TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUInt64TypeObj focus = getEffJavaFXFocus();
		...
		extends CFUInt64Editor
	{
		public InitValueEditor() {
			super();
			setMinValue( CFBamUInt64DefBuff.INITVALUE_MIN_VALUE );
		...
		extends CFUInt64Editor
	{
		public MinValueEditor() {
			super();
			setMinValue( CFBamUInt64DefBuff.MINVALUE_MIN_VALUE );
		...
		extends CFUInt64Editor
	{
		public MaxValueEditor() {
			super();
			setMinValue( CFBamUInt64DefBuff.MAXVALUE_MIN_VALUE );
	...
	public CFBamJavaFXUInt64TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamUInt64TypeObj getEffJavaFXFocus() {
		ICFBamUInt64TypeObj eff = (ICFBamUInt64TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUInt64TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUInt64TypeObj popObj = getEffJavaFXFocus();
		...
		if( popObj == null ) {
			getJavaFXEditorInitValue().setUInt64Value( null );
		}
		else {
			getJavaFXEditorInitValue().setUInt64Value( popObj.getOptionalInitValue() );
		}

		if( popObj == null ) {
			getJavaFXEditorMinValue().setUInt64Value( null );
		}
		else {
			getJavaFXEditorMinValue().setUInt64Value( popObj.getOptionalMinValue() );
		}

		if( popObj == null ) {
			getJavaFXEditorMaxValue().setUInt64Value( null );
		}
		else {
			getJavaFXEditorMaxValue().setUInt64Value( popObj.getOptionalMaxValue() );
		}
	}
	...
	public void postFields()
	{
		...
		ICFBamUInt64TypeObj focus = getJavaFXFocusAsUInt64Type();
		ICFBamUInt64TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUInt64TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		editObj.setOptionalInitValue( getJavaFXEditorInitValue().getUInt64Value() );

		editObj.setOptionalMinValue( getJavaFXEditorMinValue().getUInt64Value() );

		editObj.setOptionalMaxValue( getJavaFXEditorMaxValue().getUInt64Value() );
	}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUInt64TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUInt64TypeObj)editObj.create();
