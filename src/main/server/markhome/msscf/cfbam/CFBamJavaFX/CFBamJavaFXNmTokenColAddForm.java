// Description: Java 11 JavaFX Add Form implementation for NmTokenCol.
...
/**
 *	CFBamJavaFXNmTokenColAddForm JavaFX Add Form implementation
 *	for NmTokenCol.
 */
public class CFBamJavaFXNmTokenColAddForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NmTokenCol";
	...
	public CFBamJavaFXNmTokenColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNmTokenColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokenColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNmTokenColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
