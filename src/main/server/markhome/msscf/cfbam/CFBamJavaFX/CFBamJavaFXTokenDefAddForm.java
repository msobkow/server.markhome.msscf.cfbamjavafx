// Description: Java 11 JavaFX Add Form implementation for TokenDef.
...
/**
 *	CFBamJavaFXTokenDefAddForm JavaFX Add Form implementation
 *	for TokenDef.
 */
public class CFBamJavaFXTokenDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTokenDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TokenDef";
	...
	public CFBamJavaFXTokenDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTokenDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTokenDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTokenDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTokenDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
