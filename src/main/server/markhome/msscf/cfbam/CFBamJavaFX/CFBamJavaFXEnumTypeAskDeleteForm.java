// Description: Java 11 JavaFX Ask Delete Pane implementation for EnumType.
...
/**
 *	CFBamJavaFXEnumTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for EnumType.
 */
public class CFBamJavaFXEnumTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXEnumTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete EnumType";
	...
	public CFBamJavaFXEnumTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this EnumType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamEnumTypeObj obj = getJavaFXFocusAsEnumType();
					ICFBamEnumTypeEditObj editObj = (ICFBamEnumTypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getEnumTypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsEnumType( ICFBamEnumTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXEnumTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXEnumTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
