// Description: Java 11 JavaFX Element TabPane implementation for UuidCol.
...
/**
 *	CFBamJavaFXUuidColEltTabPane JavaFX Element TabPane implementation
 *	for UuidCol.
 */
public class CFBamJavaFXUuidColEltTabPane
extends CFTabPane
implements ICFBamJavaFXUuidColPaneCommon
{
	...
	public CFBamJavaFXUuidColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUuidColObj focus = (ICFBamUuidColObj)getJavaFXFocusAsUuidCol();
			if( focus != null ) {
