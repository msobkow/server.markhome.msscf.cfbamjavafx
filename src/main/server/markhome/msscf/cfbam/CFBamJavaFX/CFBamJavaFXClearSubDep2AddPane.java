// Description: Java 11 JavaFX Add Pane implementation for ClearSubDep2.
...
/**
 *	CFBamJavaFXClearSubDep2AddPane JavaFX Add Pane implementation
 *	for ClearSubDep2.
 */
public class CFBamJavaFXClearSubDep2AddPane
extends CFSplitPane
implements ICFBamJavaFXClearSubDep2PaneCommon
{
	...
	public CFBamJavaFXClearSubDep2AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep2Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep2PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
