// Description: Java 11 JavaFX Add Pane implementation for UInt32Type.
...
/**
 *	CFBamJavaFXUInt32TypeAddPane JavaFX Add Pane implementation
 *	for UInt32Type.
 */
public class CFBamJavaFXUInt32TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt32TypePaneCommon
{
	...
	public CFBamJavaFXUInt32TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus ) {
		super();
