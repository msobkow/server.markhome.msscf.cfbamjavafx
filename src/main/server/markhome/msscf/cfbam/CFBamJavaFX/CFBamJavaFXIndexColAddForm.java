// Description: Java 11 JavaFX Add Form implementation for IndexCol.
...
/**
 *	CFBamJavaFXIndexColAddForm JavaFX Add Form implementation
 *	for IndexCol.
 */
public class CFBamJavaFXIndexColAddForm
extends CFBorderPane
implements ICFBamJavaFXIndexColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add IndexCol";
	...
	public CFBamJavaFXIndexColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getIndexColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXIndexColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getIndexColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXIndexColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXIndexColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
