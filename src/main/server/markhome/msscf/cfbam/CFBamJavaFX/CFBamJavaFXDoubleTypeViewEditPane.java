// Description: Java 11 JavaFX View/Edit Pane implementation for DoubleType.
...
/**
 *	CFBamJavaFXDoubleTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for DoubleType.
 */
public class CFBamJavaFXDoubleTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDoubleTypePaneCommon
{
	...
	public CFBamJavaFXDoubleTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDoubleTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDoubleTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
