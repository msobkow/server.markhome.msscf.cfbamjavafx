// Description: Java 11 JavaFX Add Form implementation for Int64Def.
...
/**
 *	CFBamJavaFXInt64DefAddForm JavaFX Add Form implementation
 *	for Int64Def.
 */
public class CFBamJavaFXInt64DefAddForm
extends CFBorderPane
implements ICFBamJavaFXInt64DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int64Def";
	...
	public CFBamJavaFXInt64DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt64DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt64DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt64DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt64DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
