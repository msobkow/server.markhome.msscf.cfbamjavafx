// Description: Java 11 JavaFX Ask Delete Pane implementation for TimestampType.
...
/**
 *	CFBamJavaFXTimestampTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TimestampType.
 */
public class CFBamJavaFXTimestampTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTimestampTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TimestampType";
	...
	public CFBamJavaFXTimestampTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TimestampType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTimestampTypeObj obj = getJavaFXFocusAsTimestampType();
					ICFBamTimestampTypeEditObj editObj = (ICFBamTimestampTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTimestampType( ICFBamTimestampTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTimestampTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTimestampTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
