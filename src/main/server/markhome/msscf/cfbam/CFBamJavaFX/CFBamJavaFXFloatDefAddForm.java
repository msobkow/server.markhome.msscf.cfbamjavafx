// Description: Java 11 JavaFX Add Form implementation for FloatDef.
...
/**
 *	CFBamJavaFXFloatDefAddForm JavaFX Add Form implementation
 *	for FloatDef.
 */
public class CFBamJavaFXFloatDefAddForm
extends CFBorderPane
implements ICFBamJavaFXFloatDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add FloatDef";
	...
	public CFBamJavaFXFloatDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getFloatDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXFloatDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getFloatDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXFloatDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXFloatDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
