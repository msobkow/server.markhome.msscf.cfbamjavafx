// Description: Java 11 JavaFX View/Edit Form implementation for TokenCol.
...
/**
 *	CFBamJavaFXTokenColViewEditForm JavaFX View/Edit Form implementation
 *	for TokenCol.
 */
public class CFBamJavaFXTokenColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTokenColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TokenCol";
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTokenCol() != null ) {
							if( null == getJavaFXFocusAsTokenCol().getEdit() ) {
