// Description: Java 11 JavaFX Add Pane implementation for TZTimeCol.
...
/**
 *	CFBamJavaFXTZTimeColAddPane JavaFX Add Pane implementation
 *	for TZTimeCol.
 */
public class CFBamJavaFXTZTimeColAddPane
extends CFSplitPane
implements ICFBamJavaFXTZTimeColPaneCommon
{
	...
	public CFBamJavaFXTZTimeColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
