// Description: Java 11 JavaFX View/Edit Pane implementation for BlobCol.
...
/**
 *	CFBamJavaFXBlobColViewEditPane JavaFX View/Edit Pane implementation
 *	for BlobCol.
 */
public class CFBamJavaFXBlobColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXBlobColPaneCommon
{
	...
	public CFBamJavaFXBlobColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getBlobColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBlobColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXBlobColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
