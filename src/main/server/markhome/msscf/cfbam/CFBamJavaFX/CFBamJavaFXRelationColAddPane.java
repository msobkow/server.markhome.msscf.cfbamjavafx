// Description: Java 11 JavaFX Add Pane implementation for RelationCol.
...
/**
 *	CFBamJavaFXRelationColAddPane JavaFX Add Pane implementation
 *	for RelationCol.
 */
public class CFBamJavaFXRelationColAddPane
extends CFSplitPane
implements ICFBamJavaFXRelationColPaneCommon
{
	...
	public CFBamJavaFXRelationColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
