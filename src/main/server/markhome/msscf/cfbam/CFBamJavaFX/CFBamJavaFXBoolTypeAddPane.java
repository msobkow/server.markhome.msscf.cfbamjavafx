// Description: Java 11 JavaFX Add Pane implementation for BoolType.
...
/**
 *	CFBamJavaFXBoolTypeAddPane JavaFX Add Pane implementation
 *	for BoolType.
 */
public class CFBamJavaFXBoolTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXBoolTypePaneCommon
{
	...
	public CFBamJavaFXBoolTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
