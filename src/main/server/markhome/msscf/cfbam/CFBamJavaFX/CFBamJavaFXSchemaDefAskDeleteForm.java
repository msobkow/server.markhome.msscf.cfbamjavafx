// Description: Java 11 JavaFX Ask Delete Pane implementation for SchemaDef.
...
/**
 *	CFBamJavaFXSchemaDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for SchemaDef.
 */
public class CFBamJavaFXSchemaDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXSchemaDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete SchemaDef";
	...
	public CFBamJavaFXSchemaDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this SchemaDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamSchemaDefObj obj = getJavaFXFocusAsSchemaDef();
					ICFBamSchemaDefEditObj editObj = (ICFBamSchemaDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsSchemaDef( ICFBamSchemaDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXSchemaDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
