// Description: Java 11 JavaFX Add Form implementation for DelDep.
...
/**
 *	CFBamJavaFXDelDepAddForm JavaFX Add Form implementation
 *	for DelDep.
 */
public class CFBamJavaFXDelDepAddForm
extends CFBorderPane
implements ICFBamJavaFXDelDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DelDep";
	...
	public CFBamJavaFXDelDepAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelDepObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDelDepFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelDepPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDelDepFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelDepPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelDepPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
