// Description: Java 11 JavaFX Element TabPane implementation for StringType.
...
/**
 *	CFBamJavaFXStringTypeEltTabPane JavaFX Element TabPane implementation
 *	for StringType.
 */
public class CFBamJavaFXStringTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXStringTypePaneCommon
{
	...
	public CFBamJavaFXStringTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamStringTypeObj focus = (ICFBamStringTypeObj)getJavaFXFocusAsStringType();
			if( focus != null ) {
