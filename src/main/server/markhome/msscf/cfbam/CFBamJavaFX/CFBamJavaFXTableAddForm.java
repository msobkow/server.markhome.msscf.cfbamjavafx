// Description: Java 11 JavaFX Add Form implementation for Table.
...
/**
 *	CFBamJavaFXTableAddForm JavaFX Add Form implementation
 *	for Table.
 */
public class CFBamJavaFXTableAddForm
extends CFBorderPane
implements ICFBamJavaFXTablePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Table";
	...
	public CFBamJavaFXTableAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTableFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTablePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTableFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTablePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTablePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
