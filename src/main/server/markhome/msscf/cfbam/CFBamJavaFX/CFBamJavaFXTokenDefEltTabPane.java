// Description: Java 11 JavaFX Element TabPane implementation for TokenDef.
...
/**
 *	CFBamJavaFXTokenDefEltTabPane JavaFX Element TabPane implementation
 *	for TokenDef.
 */
public class CFBamJavaFXTokenDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXTokenDefPaneCommon
{
	...
	public CFBamJavaFXTokenDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTokenDefObj focus = (ICFBamTokenDefObj)getJavaFXFocusAsTokenDef();
			if( focus != null ) {
