// Description: Java 11 JavaFX Ask Delete Pane implementation for Table.
...
/**
 *	CFBamJavaFXTableAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Table.
 */
public class CFBamJavaFXTableAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTablePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Table";
	...
	public CFBamJavaFXTableAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Table?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTableObj obj = getJavaFXFocusAsTable();
					ICFBamTableEditObj editObj = (ICFBamTableEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTableFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTable( ICFBamTableObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTablePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTablePaneCommon)attrPane).setPaneMode( value );
		}
	}
