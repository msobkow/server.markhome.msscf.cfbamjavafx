// Description: Java 11 JavaFX View/Edit Form implementation for ClearTopDep.
...
/**
 *	CFBamJavaFXClearTopDepViewEditForm JavaFX View/Edit Form implementation
 *	for ClearTopDep.
 */
public class CFBamJavaFXClearTopDepViewEditForm
extends CFBorderPane
implements ICFBamJavaFXClearTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit ClearTopDep";
	...
	public CFBamJavaFXClearTopDepViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamClearTopDepObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getClearTopDepFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearTopDepPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamClearTopDepObj argFocus = (ICFBamClearTopDepObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamClearTopDepObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsClearTopDep() != null ) {
							if( null == getJavaFXFocusAsClearTopDep().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsClearTopDep();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearTopDepPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearTopDepPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
