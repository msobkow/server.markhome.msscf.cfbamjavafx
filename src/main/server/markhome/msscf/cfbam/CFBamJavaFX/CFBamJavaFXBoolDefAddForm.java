// Description: Java 11 JavaFX Add Form implementation for BoolDef.
...
/**
 *	CFBamJavaFXBoolDefAddForm JavaFX Add Form implementation
 *	for BoolDef.
 */
public class CFBamJavaFXBoolDefAddForm
extends CFBorderPane
implements ICFBamJavaFXBoolDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add BoolDef";
	...
	public CFBamJavaFXBoolDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getBoolDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXBoolDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getBoolDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBoolDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
