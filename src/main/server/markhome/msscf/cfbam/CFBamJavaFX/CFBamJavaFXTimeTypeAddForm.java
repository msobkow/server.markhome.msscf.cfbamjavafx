// Description: Java 11 JavaFX Add Form implementation for TimeType.
...
/**
 *	CFBamJavaFXTimeTypeAddForm JavaFX Add Form implementation
 *	for TimeType.
 */
public class CFBamJavaFXTimeTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXTimeTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TimeType";
	...
	public CFBamJavaFXTimeTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTimeTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTimeTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTimeTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimeTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
