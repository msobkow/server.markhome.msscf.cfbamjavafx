// Description: Java 11 JavaFX View/Edit Pane implementation for Id16Gen.
...
/**
 *	CFBamJavaFXId16GenViewEditPane JavaFX View/Edit Pane implementation
 *	for Id16Gen.
 */
public class CFBamJavaFXId16GenViewEditPane
extends CFSplitPane
implements ICFBamJavaFXId16GenPaneCommon
{
	...
	public CFBamJavaFXId16GenViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId16GenObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getId16GenFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId16GenPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId16GenPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXId16GenPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
