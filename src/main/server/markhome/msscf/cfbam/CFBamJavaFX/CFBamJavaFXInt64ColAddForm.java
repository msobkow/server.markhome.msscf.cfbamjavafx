// Description: Java 11 JavaFX Add Form implementation for Int64Col.
...
/**
 *	CFBamJavaFXInt64ColAddForm JavaFX Add Form implementation
 *	for Int64Col.
 */
public class CFBamJavaFXInt64ColAddForm
extends CFBorderPane
implements ICFBamJavaFXInt64ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int64Col";
	...
	public CFBamJavaFXInt64ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt64ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt64ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt64ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt64ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
