// Description: Java 11 JavaFX View/Edit Pane implementation for EnumTag.
...
/**
 *	CFBamJavaFXEnumTagViewEditPane JavaFX View/Edit Pane implementation
 *	for EnumTag.
 */
public class CFBamJavaFXEnumTagViewEditPane
extends CFSplitPane
implements ICFBamJavaFXEnumTagPaneCommon
{
	...
	public CFBamJavaFXEnumTagViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTagPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
