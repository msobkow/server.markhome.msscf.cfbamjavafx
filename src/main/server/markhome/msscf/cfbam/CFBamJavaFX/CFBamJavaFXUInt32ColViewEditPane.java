// Description: Java 11 JavaFX View/Edit Pane implementation for UInt32Col.
...
/**
 *	CFBamJavaFXUInt32ColViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt32Col.
 */
public class CFBamJavaFXUInt32ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt32ColPaneCommon
{
	...
	public CFBamJavaFXUInt32ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt32ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
