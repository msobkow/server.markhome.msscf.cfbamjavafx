// Description: Java 11 JavaFX View/Edit Form implementation for EnumTag.
...
/**
 *	CFBamJavaFXEnumTagViewEditForm JavaFX View/Edit Form implementation
 *	for EnumTag.
 */
public class CFBamJavaFXEnumTagViewEditForm
extends CFBorderPane
implements ICFBamJavaFXEnumTagPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit EnumTag";
	...
	public CFBamJavaFXEnumTagViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamEnumTagObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getEnumTagFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXEnumTagPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamEnumTagObj argFocus = (ICFBamEnumTagObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamEnumTagObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsEnumTag() != null ) {
							if( null == getJavaFXFocusAsEnumTag().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTagPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXEnumTagPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
