// Description: Java 11 JavaFX Ask Delete Pane implementation for DateType.
...
/**
 *	CFBamJavaFXDateTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DateType.
 */
public class CFBamJavaFXDateTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDateTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DateType";
	...
	public CFBamJavaFXDateTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DateType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDateTypeObj obj = getJavaFXFocusAsDateType();
					ICFBamDateTypeEditObj editObj = (ICFBamDateTypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDateTypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDateType( ICFBamDateTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDateTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDateTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
