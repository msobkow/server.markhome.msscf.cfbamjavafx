// Description: Java 11 JavaFX View/Edit Form implementation for ClearSubDep2.
...
/**
 *	CFBamJavaFXClearSubDep2ViewEditForm JavaFX View/Edit Form implementation
 *	for ClearSubDep2.
 */
public class CFBamJavaFXClearSubDep2ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit ClearSubDep2";
	...
	public CFBamJavaFXClearSubDep2ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep2Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getClearSubDep2Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearSubDep2PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsClearSubDep2() != null ) {
							if( null == getJavaFXFocusAsClearSubDep2().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep2PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep2PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
