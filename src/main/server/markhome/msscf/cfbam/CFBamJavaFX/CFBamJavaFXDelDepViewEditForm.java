// Description: Java 11 JavaFX View/Edit Form implementation for DelDep.
...
/**
 *	CFBamJavaFXDelDepViewEditForm JavaFX View/Edit Form implementation
 *	for DelDep.
 */
public class CFBamJavaFXDelDepViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDelDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DelDep";
	...
	public CFBamJavaFXDelDepViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelDepObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelDepObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getDelDepFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelDepPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamDelDepObj argFocus = (ICFBamDelDepObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelDepObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDelDep() != null ) {
							if( null == getJavaFXFocusAsDelDep().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelDepPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelDepPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
