// Description: Java 11 JavaFX Ask Delete Pane implementation for TZTimeDef.
...
/**
 *	CFBamJavaFXTZTimeDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZTimeDef.
 */
public class CFBamJavaFXTZTimeDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZTimeDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZTimeDef";
	...
	public CFBamJavaFXTZTimeDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZTimeDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZTimeDefObj obj = getJavaFXFocusAsTZTimeDef();
					ICFBamTZTimeDefEditObj editObj = (ICFBamTZTimeDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZTimeDef( ICFBamTZTimeDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimeDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimeDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
