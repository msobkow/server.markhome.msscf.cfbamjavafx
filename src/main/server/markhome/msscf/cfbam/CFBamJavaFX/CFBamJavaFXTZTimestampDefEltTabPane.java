// Description: Java 11 JavaFX Element TabPane implementation for TZTimestampDef.
...
/**
 *	CFBamJavaFXTZTimestampDefEltTabPane JavaFX Element TabPane implementation
 *	for TZTimestampDef.
 */
public class CFBamJavaFXTZTimestampDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZTimestampDefPaneCommon
{
	...
	public CFBamJavaFXTZTimestampDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZTimestampDefObj focus = (ICFBamTZTimestampDefObj)getJavaFXFocusAsTZTimestampDef();
			if( focus != null ) {
