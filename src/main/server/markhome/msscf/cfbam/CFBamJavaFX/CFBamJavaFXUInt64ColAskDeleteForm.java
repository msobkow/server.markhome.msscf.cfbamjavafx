// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt64Col.
...
/**
 *	CFBamJavaFXUInt64ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt64Col.
 */
public class CFBamJavaFXUInt64ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt64ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt64Col";
	...
	public CFBamJavaFXUInt64ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus, ICFDeleteCallback callback ) {
		super();
	...
	public void setJavaFXFocusAsUInt64Col( ICFBamUInt64ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt64ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
