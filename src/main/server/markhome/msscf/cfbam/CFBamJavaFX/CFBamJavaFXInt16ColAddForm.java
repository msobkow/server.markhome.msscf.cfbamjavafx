// Description: Java 11 JavaFX Add Form implementation for Int16Col.
...
/**
 *	CFBamJavaFXInt16ColAddForm JavaFX Add Form implementation
 *	for Int16Col.
 */
public class CFBamJavaFXInt16ColAddForm
extends CFBorderPane
implements ICFBamJavaFXInt16ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int16Col";
	...
	public CFBamJavaFXInt16ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt16ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt16ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt16ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt16ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
