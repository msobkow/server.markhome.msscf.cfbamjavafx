// Description: Java 11 JavaFX View/Edit Pane implementation for TZDateCol.
...
/**
 *	CFBamJavaFXTZDateColViewEditPane JavaFX View/Edit Pane implementation
 *	for TZDateCol.
 */
public class CFBamJavaFXTZDateColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZDateColPaneCommon
{
	...
	public CFBamJavaFXTZDateColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZDateColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
