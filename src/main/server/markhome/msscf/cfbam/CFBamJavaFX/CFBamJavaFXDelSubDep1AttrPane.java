// Description: Java 11 JavaFX Attribute Pane implementation for DelSubDep1.
...
/**
 *	CFBamJavaFXDelSubDep1AttrPane JavaFX Attribute Pane implementation
 *	for DelSubDep1.
 */
public class CFBamJavaFXDelSubDep1AttrPane
extends CFGridPane
implements ICFBamJavaFXDelSubDep1PaneCommon
{
	...
	implements ICFBamJavaFXRelationChosen
	{
		...
		public void choseRelation( ICFBamRelationObj value ) {
			if( javafxReferenceLookupRelation != null ) {
				ICFBamDelSubDep1Obj cur = getJavaFXFocusAsDelSubDep1();
				if( cur != null ) {
					ICFBamDelSubDep1EditObj editObj = (ICFBamDelSubDep1EditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDelSubDep1Obj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDelSubDep1AttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep1Obj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamDelSubDep1Obj getEffJavaFXFocus() {
		ICFBamDelSubDep1Obj eff = (ICFBamDelSubDep1Obj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDelSubDep1Obj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDelSubDep1Obj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDelSubDep1EditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDelSubDep1EditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDelSubDep1EditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDelSubDep1Obj)editObj.create();
