// Description: Java 11 JavaFX Attribute Pane implementation for DelSubDep3.
...
/**
 *	CFBamJavaFXDelSubDep3AttrPane JavaFX Attribute Pane implementation
 *	for DelSubDep3.
 */
public class CFBamJavaFXDelSubDep3AttrPane
extends CFGridPane
implements ICFBamJavaFXDelSubDep3PaneCommon
{
	...
	implements ICFBamJavaFXRelationChosen
	{
		...
		public void choseRelation( ICFBamRelationObj value ) {
			if( javafxReferenceLookupRelation != null ) {
				ICFBamDelSubDep3Obj cur = getJavaFXFocusAsDelSubDep3();
				if( cur != null ) {
					ICFBamDelSubDep3EditObj editObj = (ICFBamDelSubDep3EditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDelSubDep3Obj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDelSubDep3AttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep3Obj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamDelSubDep3Obj getEffJavaFXFocus() {
		ICFBamDelSubDep3Obj eff = (ICFBamDelSubDep3Obj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDelSubDep3Obj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDelSubDep3Obj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDelSubDep3EditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDelSubDep3EditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDelSubDep3EditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDelSubDep3Obj)editObj.create();
