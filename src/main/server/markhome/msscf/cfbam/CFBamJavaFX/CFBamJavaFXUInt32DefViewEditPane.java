// Description: Java 11 JavaFX View/Edit Pane implementation for UInt32Def.
...
/**
 *	CFBamJavaFXUInt32DefViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt32Def.
 */
public class CFBamJavaFXUInt32DefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt32DefPaneCommon
{
	...
	public CFBamJavaFXUInt32DefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32DefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt32DefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt32DefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
