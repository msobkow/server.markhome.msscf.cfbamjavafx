// Description: Java 11 JavaFX View/Edit Form implementation for Id32Gen.
...
/**
 *	CFBamJavaFXId32GenViewEditForm JavaFX View/Edit Form implementation
 *	for Id32Gen.
 */
public class CFBamJavaFXId32GenViewEditForm
extends CFBorderPane
implements ICFBamJavaFXId32GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Id32Gen";
	...
	public CFBamJavaFXId32GenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId32GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamId32GenObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getId32GenFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamId32GenEditObj editObj = (ICFBamId32GenEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXId32GenPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamId32GenObj argFocus = (ICFBamId32GenObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamId32GenObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsId32Gen() != null ) {
							if( null == getJavaFXFocusAsId32Gen().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId32GenPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId32GenPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
