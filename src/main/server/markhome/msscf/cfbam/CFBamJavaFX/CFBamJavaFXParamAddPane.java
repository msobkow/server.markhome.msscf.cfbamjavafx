// Description: Java 11 JavaFX Add Pane implementation for Param.
...
/**
 *	CFBamJavaFXParamAddPane JavaFX Add Pane implementation
 *	for Param.
 */
public class CFBamJavaFXParamAddPane
extends CFSplitPane
implements ICFBamJavaFXParamPaneCommon
{
	...
	public CFBamJavaFXParamAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamParamObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXParamPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
