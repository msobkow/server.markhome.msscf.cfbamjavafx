// Description: Java 11 JavaFX Ask Delete Pane implementation for Atom.
...
/**
 *	CFBamJavaFXAtomAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Atom.
 */
public class CFBamJavaFXAtomAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXAtomPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Atom";
	...
	public CFBamJavaFXAtomAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamAtomObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Atom?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamAtomObj obj = getJavaFXFocusAsAtom();
					ICFBamAtomEditObj editObj = (ICFBamAtomEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsAtom( ICFBamAtomObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXAtomPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXAtomPaneCommon)attrPane).setPaneMode( value );
		}
	}
