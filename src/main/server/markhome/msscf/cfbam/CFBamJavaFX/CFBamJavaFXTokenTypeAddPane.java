// Description: Java 11 JavaFX Add Pane implementation for TokenType.
...
/**
 *	CFBamJavaFXTokenTypeAddPane JavaFX Add Pane implementation
 *	for TokenType.
 */
public class CFBamJavaFXTokenTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXTokenTypePaneCommon
{
	...
	public CFBamJavaFXTokenTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
