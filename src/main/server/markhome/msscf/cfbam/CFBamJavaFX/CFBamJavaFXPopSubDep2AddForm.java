// Description: Java 11 JavaFX Add Form implementation for PopSubDep2.
...
/**
 *	CFBamJavaFXPopSubDep2AddForm JavaFX Add Form implementation
 *	for PopSubDep2.
 */
public class CFBamJavaFXPopSubDep2AddForm
extends CFBorderPane
implements ICFBamJavaFXPopSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "Add PopSubDep2";
	...
	public CFBamJavaFXPopSubDep2AddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep2Obj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getPopSubDep2Factory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXPopSubDep2PaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getPopSubDep2Factory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopSubDep2PaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopSubDep2PaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
