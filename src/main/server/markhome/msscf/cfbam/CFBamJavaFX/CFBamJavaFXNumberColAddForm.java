// Description: Java 11 JavaFX Add Form implementation for NumberCol.
...
/**
 *	CFBamJavaFXNumberColAddForm JavaFX Add Form implementation
 *	for NumberCol.
 */
public class CFBamJavaFXNumberColAddForm
extends CFBorderPane
implements ICFBamJavaFXNumberColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NumberCol";
	...
	public CFBamJavaFXNumberColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNumberColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNumberColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNumberColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNumberColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
