// Description: Java 11 JavaFX Ask Delete Pane implementation for NmTokenCol.
...
/**
 *	CFBamJavaFXNmTokenColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NmTokenCol.
 */
public class CFBamJavaFXNmTokenColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NmTokenCol";
	...
	public CFBamJavaFXNmTokenColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NmTokenCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNmTokenColObj obj = getJavaFXFocusAsNmTokenCol();
					ICFBamNmTokenColEditObj editObj = (ICFBamNmTokenColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNmTokenCol( ICFBamNmTokenColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokenColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokenColPaneCommon)attrPane).setPaneMode( value );
		}
	}
