// Description: Java 11 JavaFX Ask Delete Pane implementation for FloatType.
...
/**
 *	CFBamJavaFXFloatTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for FloatType.
 */
public class CFBamJavaFXFloatTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXFloatTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete FloatType";
	...
	public CFBamJavaFXFloatTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this FloatType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamFloatTypeObj obj = getJavaFXFocusAsFloatType();
					ICFBamFloatTypeEditObj editObj = (ICFBamFloatTypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getFloatTypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsFloatType( ICFBamFloatTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXFloatTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXFloatTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
