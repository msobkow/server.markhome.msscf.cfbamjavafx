// Description: Java 11 JavaFX View/Edit Pane implementation for Int32Def.
...
/**
 *	CFBamJavaFXInt32DefViewEditPane JavaFX View/Edit Pane implementation
 *	for Int32Def.
 */
public class CFBamJavaFXInt32DefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt32DefPaneCommon
{
	...
	public CFBamJavaFXInt32DefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32DefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getInt32DefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32DefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt32DefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt32DefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
