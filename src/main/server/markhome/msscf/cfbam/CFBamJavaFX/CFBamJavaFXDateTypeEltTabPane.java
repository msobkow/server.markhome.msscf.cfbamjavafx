// Description: Java 11 JavaFX Element TabPane implementation for DateType.
...
/**
 *	CFBamJavaFXDateTypeEltTabPane JavaFX Element TabPane implementation
 *	for DateType.
 */
public class CFBamJavaFXDateTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXDateTypePaneCommon
{
	...
	public CFBamJavaFXDateTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamDateTypeObj focus = (ICFBamDateTypeObj)getJavaFXFocusAsDateType();
			if( focus != null ) {
