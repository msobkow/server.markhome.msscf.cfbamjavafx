// Description: Java 11 JavaFX Add Form implementation for UuidGen.
...
/**
 *	CFBamJavaFXUuidGenAddForm JavaFX Add Form implementation
 *	for UuidGen.
 */
public class CFBamJavaFXUuidGenAddForm
extends CFBorderPane
implements ICFBamJavaFXUuidGenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UuidGen";
	...
	public CFBamJavaFXUuidGenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidGenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuidGenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuidGenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuidGenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidGenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuidGenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
