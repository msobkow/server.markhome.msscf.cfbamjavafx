// Description: Java 11 JavaFX Element TabPane implementation for NmTokenType.
...
/**
 *	CFBamJavaFXNmTokenTypeEltTabPane JavaFX Element TabPane implementation
 *	for NmTokenType.
 */
public class CFBamJavaFXNmTokenTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXNmTokenTypePaneCommon
{
	...
	public CFBamJavaFXNmTokenTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNmTokenTypeObj focus = (ICFBamNmTokenTypeObj)getJavaFXFocusAsNmTokenType();
			if( focus != null ) {
