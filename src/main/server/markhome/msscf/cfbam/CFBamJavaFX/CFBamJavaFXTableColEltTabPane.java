// Description: Java 11 JavaFX Element TabPane implementation for TableCol.
...
/**
 *	CFBamJavaFXTableColEltTabPane JavaFX Element TabPane implementation
 *	for TableCol.
 */
public class CFBamJavaFXTableColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTableColPaneCommon
{
	...
	public CFBamJavaFXTableColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTableColObj focus = (ICFBamTableColObj)getJavaFXFocusAsTableCol();
			if( focus != null ) {
