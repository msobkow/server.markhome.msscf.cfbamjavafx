// Description: Java 11 JavaFX View/Edit Form implementation for ClearSubDep1.
...
/**
 *	CFBamJavaFXClearSubDep1ViewEditForm JavaFX View/Edit Form implementation
 *	for ClearSubDep1.
 */
public class CFBamJavaFXClearSubDep1ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit ClearSubDep1";
	...
	public CFBamJavaFXClearSubDep1ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep1Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamClearSubDep1Obj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getClearSubDep1Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamClearSubDep1Obj focus = getJavaFXFocusAsClearSubDep1();
		if( focus != null ) {
			ICFBamClearSubDep1EditObj editObj = (ICFBamClearSubDep1EditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearSubDep1PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamClearSubDep1Obj argFocus = (ICFBamClearSubDep1Obj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamClearSubDep1Obj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsClearSubDep1() != null ) {
							if( null == getJavaFXFocusAsClearSubDep1().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsClearSubDep1();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep1PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep1PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
