// Description: Java 11 JavaFX Ask Delete Pane implementation for StringCol.
...
/**
 *	CFBamJavaFXStringColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for StringCol.
 */
public class CFBamJavaFXStringColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXStringColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete StringCol";
	...
	public CFBamJavaFXStringColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this StringCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamStringColObj obj = getJavaFXFocusAsStringCol();
					ICFBamStringColEditObj editObj = (ICFBamStringColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsStringCol( ICFBamStringColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXStringColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXStringColPaneCommon)attrPane).setPaneMode( value );
		}
	}
