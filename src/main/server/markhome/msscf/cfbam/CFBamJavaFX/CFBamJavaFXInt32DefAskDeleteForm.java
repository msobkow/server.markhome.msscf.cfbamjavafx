// Description: Java 11 JavaFX Ask Delete Pane implementation for Int32Def.
...
/**
 *	CFBamJavaFXInt32DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int32Def.
 */
public class CFBamJavaFXInt32DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt32DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int32Def";
	...
	public CFBamJavaFXInt32DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int32Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt32DefObj obj = getJavaFXFocusAsInt32Def();
					ICFBamInt32DefEditObj editObj = (ICFBamInt32DefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsInt32Def( ICFBamInt32DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt32DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt32DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
