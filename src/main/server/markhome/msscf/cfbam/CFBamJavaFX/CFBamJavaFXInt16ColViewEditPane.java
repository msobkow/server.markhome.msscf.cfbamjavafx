// Description: Java 11 JavaFX View/Edit Pane implementation for Int16Col.
...
/**
 *	CFBamJavaFXInt16ColViewEditPane JavaFX View/Edit Pane implementation
 *	for Int16Col.
 */
public class CFBamJavaFXInt16ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt16ColPaneCommon
{
	...
	public CFBamJavaFXInt16ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16ColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getInt16ColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16ColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt16ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt16ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
