// Description: Java 11 JavaFX Ask Delete Pane implementation for TZTimeCol.
...
/**
 *	CFBamJavaFXTZTimeColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZTimeCol.
 */
public class CFBamJavaFXTZTimeColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZTimeColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZTimeCol";
	...
	public CFBamJavaFXTZTimeColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZTimeCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZTimeColObj obj = getJavaFXFocusAsTZTimeCol();
					ICFBamTZTimeColEditObj editObj = (ICFBamTZTimeColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZTimeCol( ICFBamTZTimeColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimeColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimeColPaneCommon)attrPane).setPaneMode( value );
		}
	}
