// Description: Java 11 JavaFX Ask Delete Pane implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt32TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int32Type";
	...
	public CFBamJavaFXInt32TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int32Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt32TypeObj obj = getJavaFXFocusAsInt32Type();
					ICFBamInt32TypeEditObj editObj = (ICFBamInt32TypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsInt32Type( ICFBamInt32TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt32TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt32TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
