// Description: Java 11 JavaFX Attribute Pane implementation for Int32Def.
...
/**
 *	CFBamJavaFXInt32DefAttrPane JavaFX Attribute Pane implementation
 *	for Int32Def.
 */
public class CFBamJavaFXInt32DefAttrPane
extends CFGridPane
implements ICFBamJavaFXInt32DefPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamInt32DefObj cur = getJavaFXFocusAsInt32Def();
				if( cur != null ) {
					ICFBamInt32DefEditObj editObj = (ICFBamInt32DefEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamInt32DefObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXInt32DefAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32DefObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamInt32DefObj getEffJavaFXFocus() {
		ICFBamInt32DefObj eff = (ICFBamInt32DefObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamInt32DefObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamInt32DefObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamInt32DefEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamInt32DefEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamInt32DefEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamInt32DefObj)editObj.create();
