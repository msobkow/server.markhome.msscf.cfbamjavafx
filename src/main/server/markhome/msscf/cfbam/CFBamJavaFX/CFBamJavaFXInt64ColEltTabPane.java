// Description: Java 11 JavaFX Element TabPane implementation for Int64Col.
...
/**
 *	CFBamJavaFXInt64ColEltTabPane JavaFX Element TabPane implementation
 *	for Int64Col.
 */
public class CFBamJavaFXInt64ColEltTabPane
extends CFTabPane
implements ICFBamJavaFXInt64ColPaneCommon
{
	...
	public CFBamJavaFXInt64ColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamInt64ColObj focus = (ICFBamInt64ColObj)getJavaFXFocusAsInt64Col();
			if( focus != null ) {
