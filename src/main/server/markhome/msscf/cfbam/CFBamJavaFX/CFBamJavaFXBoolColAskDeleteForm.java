// Description: Java 11 JavaFX Ask Delete Pane implementation for BoolCol.
...
/**
 *	CFBamJavaFXBoolColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for BoolCol.
 */
public class CFBamJavaFXBoolColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXBoolColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete BoolCol";
	...
	public CFBamJavaFXBoolColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this BoolCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamBoolColObj obj = getJavaFXFocusAsBoolCol();
					ICFBamBoolColEditObj editObj = (ICFBamBoolColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsBoolCol( ICFBamBoolColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXBoolColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXBoolColPaneCommon)attrPane).setPaneMode( value );
		}
	}
