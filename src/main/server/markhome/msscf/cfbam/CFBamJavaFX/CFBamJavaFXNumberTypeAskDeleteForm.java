// Description: Java 11 JavaFX Ask Delete Pane implementation for NumberType.
...
/**
 *	CFBamJavaFXNumberTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NumberType.
 */
public class CFBamJavaFXNumberTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNumberTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NumberType";
	...
	public CFBamJavaFXNumberTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NumberType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNumberTypeObj obj = getJavaFXFocusAsNumberType();
					ICFBamNumberTypeEditObj editObj = (ICFBamNumberTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNumberType( ICFBamNumberTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNumberTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNumberTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
