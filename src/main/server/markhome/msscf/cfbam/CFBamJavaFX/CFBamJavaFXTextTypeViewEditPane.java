// Description: Java 11 JavaFX View/Edit Pane implementation for TextType.
...
/**
 *	CFBamJavaFXTextTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for TextType.
 */
public class CFBamJavaFXTextTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTextTypePaneCommon
{
	...
	public CFBamJavaFXTextTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextTypeObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTextTypeFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTextTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTextTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
