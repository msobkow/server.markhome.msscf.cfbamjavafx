// Description: Java 11 JavaFX Add Pane implementation for StringCol.
...
/**
 *	CFBamJavaFXStringColAddPane JavaFX Add Pane implementation
 *	for StringCol.
 */
public class CFBamJavaFXStringColAddPane
extends CFSplitPane
implements ICFBamJavaFXStringColPaneCommon
{
	...
	public CFBamJavaFXStringColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
