// Description: Java 11 JavaFX Add Form implementation for Int32Col.
...
/**
 *	CFBamJavaFXInt32ColAddForm JavaFX Add Form implementation
 *	for Int32Col.
 */
public class CFBamJavaFXInt32ColAddForm
extends CFBorderPane
implements ICFBamJavaFXInt32ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int32Col";
	...
	public CFBamJavaFXInt32ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt32ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt32ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt32ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
