// Description: Java 11 JavaFX View/Edit Pane implementation for ServerListFunc.
...
/**
 *	CFBamJavaFXServerListFuncViewEditPane JavaFX View/Edit Pane implementation
 *	for ServerListFunc.
 */
public class CFBamJavaFXServerListFuncViewEditPane
extends CFSplitPane
implements ICFBamJavaFXServerListFuncPaneCommon
{
	...
	public CFBamJavaFXServerListFuncViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerListFuncPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerListFuncPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXServerListFuncPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
