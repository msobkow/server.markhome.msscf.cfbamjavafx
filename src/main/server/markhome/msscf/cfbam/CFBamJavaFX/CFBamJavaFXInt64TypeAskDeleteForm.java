// Description: Java 11 JavaFX Ask Delete Pane implementation for Int64Type.
...
/**
 *	CFBamJavaFXInt64TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int64Type.
 */
public class CFBamJavaFXInt64TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt64TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int64Type";
	...
	public CFBamJavaFXInt64TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int64Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt64TypeObj obj = getJavaFXFocusAsInt64Type();
					ICFBamInt64TypeEditObj editObj = (ICFBamInt64TypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsInt64Type( ICFBamInt64TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt64TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt64TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
