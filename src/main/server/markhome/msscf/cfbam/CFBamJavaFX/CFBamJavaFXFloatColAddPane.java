// Description: Java 11 JavaFX Add Pane implementation for FloatCol.
...
/**
 *	CFBamJavaFXFloatColAddPane JavaFX Add Pane implementation
 *	for FloatCol.
 */
public class CFBamJavaFXFloatColAddPane
extends CFSplitPane
implements ICFBamJavaFXFloatColPaneCommon
{
	...
	public CFBamJavaFXFloatColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXFloatColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
