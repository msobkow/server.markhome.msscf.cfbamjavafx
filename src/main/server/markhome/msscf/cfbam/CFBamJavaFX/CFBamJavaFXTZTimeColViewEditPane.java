// Description: Java 11 JavaFX View/Edit Pane implementation for TZTimeCol.
...
/**
 *	CFBamJavaFXTZTimeColViewEditPane JavaFX View/Edit Pane implementation
 *	for TZTimeCol.
 */
public class CFBamJavaFXTZTimeColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZTimeColPaneCommon
{
	...
	public CFBamJavaFXTZTimeColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
