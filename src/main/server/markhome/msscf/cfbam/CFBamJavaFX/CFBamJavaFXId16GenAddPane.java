// Description: Java 11 JavaFX Add Pane implementation for Id16Gen.
...
/**
 *	CFBamJavaFXId16GenAddPane JavaFX Add Pane implementation
 *	for Id16Gen.
 */
public class CFBamJavaFXId16GenAddPane
extends CFSplitPane
implements ICFBamJavaFXId16GenPaneCommon
{
	...
	public CFBamJavaFXId16GenAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId16GenObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId16GenPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
