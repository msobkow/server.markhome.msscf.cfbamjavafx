// Description: Java 11 JavaFX Add Pane implementation for Chain.
...
/**
 *	CFBamJavaFXChainAddPane JavaFX Add Pane implementation
 *	for Chain.
 */
public class CFBamJavaFXChainAddPane
extends CFSplitPane
implements ICFBamJavaFXChainPaneCommon
{
	...
	public CFBamJavaFXChainAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamChainObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXChainPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
