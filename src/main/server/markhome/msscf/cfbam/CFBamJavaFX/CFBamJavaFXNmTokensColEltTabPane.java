// Description: Java 11 JavaFX Element TabPane implementation for NmTokensCol.
...
/**
 *	CFBamJavaFXNmTokensColEltTabPane JavaFX Element TabPane implementation
 *	for NmTokensCol.
 */
public class CFBamJavaFXNmTokensColEltTabPane
extends CFTabPane
implements ICFBamJavaFXNmTokensColPaneCommon
{
	...
	public CFBamJavaFXNmTokensColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNmTokensColObj focus = (ICFBamNmTokensColObj)getJavaFXFocusAsNmTokensCol();
			if( focus != null ) {
