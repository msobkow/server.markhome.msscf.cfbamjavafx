// Description: Java 11 JavaFX Attribute Pane implementation for DelSubDep2.
...
/**
 *	CFBamJavaFXDelSubDep2AttrPane JavaFX Attribute Pane implementation
 *	for DelSubDep2.
 */
public class CFBamJavaFXDelSubDep2AttrPane
extends CFGridPane
implements ICFBamJavaFXDelSubDep2PaneCommon
{
	...
	implements ICFBamJavaFXRelationChosen
	{
		...
		public void choseRelation( ICFBamRelationObj value ) {
			if( javafxReferenceLookupRelation != null ) {
				ICFBamDelSubDep2Obj cur = getJavaFXFocusAsDelSubDep2();
				if( cur != null ) {
					ICFBamDelSubDep2EditObj editObj = (ICFBamDelSubDep2EditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDelSubDep2Obj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDelSubDep2AttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep2Obj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamDelSubDep2Obj getEffJavaFXFocus() {
		ICFBamDelSubDep2Obj eff = (ICFBamDelSubDep2Obj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDelSubDep2Obj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDelSubDep2Obj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamDelSubDep2EditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamDelSubDep2EditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamDelSubDep2EditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamDelSubDep2Obj)editObj.create();
