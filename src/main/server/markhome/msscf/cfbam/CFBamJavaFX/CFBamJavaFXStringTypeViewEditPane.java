// Description: Java 11 JavaFX View/Edit Pane implementation for StringType.
...
/**
 *	CFBamJavaFXStringTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for StringType.
 */
public class CFBamJavaFXStringTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXStringTypePaneCommon
{
	...
	public CFBamJavaFXStringTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXStringTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXStringTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
