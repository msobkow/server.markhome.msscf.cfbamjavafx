// Description: Java 11 JavaFX Element TabPane implementation for BoolType.
...
/**
 *	CFBamJavaFXBoolTypeEltTabPane JavaFX Element TabPane implementation
 *	for BoolType.
 */
public class CFBamJavaFXBoolTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXBoolTypePaneCommon
{
	...
	public CFBamJavaFXBoolTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamBoolTypeObj focus = (ICFBamBoolTypeObj)getJavaFXFocusAsBoolType();
			if( focus != null ) {
