// Description: Java 11 JavaFX Element TabPane implementation for TZDateType.
...
/**
 *	CFBamJavaFXTZDateTypeEltTabPane JavaFX Element TabPane implementation
 *	for TZDateType.
 */
public class CFBamJavaFXTZDateTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZDateTypePaneCommon
{
	...
	public CFBamJavaFXTZDateTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZDateTypeObj focus = (ICFBamTZDateTypeObj)getJavaFXFocusAsTZDateType();
			if( focus != null ) {
