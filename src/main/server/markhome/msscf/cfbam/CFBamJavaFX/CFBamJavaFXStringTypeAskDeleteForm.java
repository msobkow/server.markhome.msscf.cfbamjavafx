// Description: Java 11 JavaFX Ask Delete Pane implementation for StringType.
...
/**
 *	CFBamJavaFXStringTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for StringType.
 */
public class CFBamJavaFXStringTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXStringTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete StringType";
	...
	public CFBamJavaFXStringTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this StringType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamStringTypeObj obj = getJavaFXFocusAsStringType();
					ICFBamStringTypeEditObj editObj = (ICFBamStringTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsStringType( ICFBamStringTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXStringTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXStringTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
