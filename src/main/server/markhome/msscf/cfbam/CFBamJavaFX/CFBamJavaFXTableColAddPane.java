// Description: Java 11 JavaFX Add Pane implementation for TableCol.
...
/**
 *	CFBamJavaFXTableColAddPane JavaFX Add Pane implementation
 *	for TableCol.
 */
public class CFBamJavaFXTableColAddPane
extends CFSplitPane
implements ICFBamJavaFXTableColPaneCommon
{
	...
	public CFBamJavaFXTableColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTableColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
