// Description: Java 11 JavaFX Ask Delete Pane implementation for TableCol.
...
/**
 *	CFBamJavaFXTableColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TableCol.
 */
public class CFBamJavaFXTableColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTableColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TableCol";
	...
	public CFBamJavaFXTableColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TableCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTableColObj obj = getJavaFXFocusAsTableCol();
					ICFBamTableColEditObj editObj = (ICFBamTableColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTableCol( ICFBamTableColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTableColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTableColPaneCommon)attrPane).setPaneMode( value );
		}
	}
