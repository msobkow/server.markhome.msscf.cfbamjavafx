// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt32Col.
...
/**
 *	CFBamJavaFXUInt32ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt32Col.
 */
public class CFBamJavaFXUInt32ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt32ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt32Col";
	...
	public CFBamJavaFXUInt32ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt32Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt32ColObj obj = getJavaFXFocusAsUInt32Col();
					ICFBamUInt32ColEditObj editObj = (ICFBamUInt32ColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt32Col( ICFBamUInt32ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt32ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
