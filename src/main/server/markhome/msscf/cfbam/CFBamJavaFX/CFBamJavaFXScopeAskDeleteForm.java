// Description: Java 11 JavaFX Ask Delete Pane implementation for Scope.
...
/**
 *	CFBamJavaFXScopeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Scope.
 */
public class CFBamJavaFXScopeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXScopePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Scope";
	...
	public CFBamJavaFXScopeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamScopeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Scope?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamScopeObj obj = getJavaFXFocusAsScope();
					ICFBamScopeEditObj editObj = (ICFBamScopeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getScopeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsScope( ICFBamScopeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXScopePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXScopePaneCommon)attrPane).setPaneMode( value );
		}
	}
