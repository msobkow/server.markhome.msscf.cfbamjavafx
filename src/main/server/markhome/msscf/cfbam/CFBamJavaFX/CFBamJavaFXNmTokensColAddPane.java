// Description: Java 11 JavaFX Add Pane implementation for NmTokensCol.
...
/**
 *	CFBamJavaFXNmTokensColAddPane JavaFX Add Pane implementation
 *	for NmTokensCol.
 */
public class CFBamJavaFXNmTokensColAddPane
extends CFSplitPane
implements ICFBamJavaFXNmTokensColPaneCommon
{
	...
	public CFBamJavaFXNmTokensColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
