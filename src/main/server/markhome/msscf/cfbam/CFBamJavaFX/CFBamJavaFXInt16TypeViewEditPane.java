// Description: Java 11 JavaFX View/Edit Pane implementation for Int16Type.
...
/**
 *	CFBamJavaFXInt16TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for Int16Type.
 */
public class CFBamJavaFXInt16TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt16TypePaneCommon
{
	...
	public CFBamJavaFXInt16TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getInt16TypeFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt16TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt16TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
