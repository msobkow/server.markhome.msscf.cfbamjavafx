// Description: Java 11 JavaFX Add Pane implementation for PopDep.
...
/**
 *	CFBamJavaFXPopDepAddPane JavaFX Add Pane implementation
 *	for PopDep.
 */
public class CFBamJavaFXPopDepAddPane
extends CFSplitPane
implements ICFBamJavaFXPopDepPaneCommon
{
	...
	public CFBamJavaFXPopDepAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopDepPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
