// Description: Java 11 JavaFX View/Edit Pane implementation for Scope.
...
/**
 *	CFBamJavaFXScopeViewEditPane JavaFX View/Edit Pane implementation
 *	for Scope.
 */
public class CFBamJavaFXScopeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXScopePaneCommon
{
	...
	public CFBamJavaFXScopeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamScopeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXScopePaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
