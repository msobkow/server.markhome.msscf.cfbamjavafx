// Description: Java 11 JavaFX Ask Delete Pane implementation for UuidDef.
...
/**
 *	CFBamJavaFXUuidDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UuidDef.
 */
public class CFBamJavaFXUuidDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuidDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UuidDef";
	...
	public CFBamJavaFXUuidDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UuidDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuidDefObj obj = getJavaFXFocusAsUuidDef();
					ICFBamUuidDefEditObj editObj = (ICFBamUuidDefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getUuidDefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsUuidDef( ICFBamUuidDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuidDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUuidDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
