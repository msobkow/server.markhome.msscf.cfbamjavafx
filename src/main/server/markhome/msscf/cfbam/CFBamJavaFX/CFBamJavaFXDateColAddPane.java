// Description: Java 11 JavaFX Add Pane implementation for DateCol.
...
/**
 *	CFBamJavaFXDateColAddPane JavaFX Add Pane implementation
 *	for DateCol.
 */
public class CFBamJavaFXDateColAddPane
extends CFSplitPane
implements ICFBamJavaFXDateColPaneCommon
{
	...
	public CFBamJavaFXDateColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
