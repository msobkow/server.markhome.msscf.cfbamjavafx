// Description: Java 11 JavaFX Add Pane implementation for Int64Col.
...
/**
 *	CFBamJavaFXInt64ColAddPane JavaFX Add Pane implementation
 *	for Int64Col.
 */
public class CFBamJavaFXInt64ColAddPane
extends CFSplitPane
implements ICFBamJavaFXInt64ColPaneCommon
{
	...
	public CFBamJavaFXInt64ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
