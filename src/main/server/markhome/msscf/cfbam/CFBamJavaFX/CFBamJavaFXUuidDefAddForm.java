// Description: Java 11 JavaFX Add Form implementation for UuidDef.
...
/**
 *	CFBamJavaFXUuidDefAddForm JavaFX Add Form implementation
 *	for UuidDef.
 */
public class CFBamJavaFXUuidDefAddForm
extends CFBorderPane
implements ICFBamJavaFXUuidDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UuidDef";
	...
	public CFBamJavaFXUuidDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuidDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuidDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuidDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuidDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
