// Description: Java 11 JavaFX Ask Delete Pane implementation for TZTimeType.
...
/**
 *	CFBamJavaFXTZTimeTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZTimeType.
 */
public class CFBamJavaFXTZTimeTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZTimeTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZTimeType";
	...
	public CFBamJavaFXTZTimeTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZTimeType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZTimeTypeObj obj = getJavaFXFocusAsTZTimeType();
					ICFBamTZTimeTypeEditObj editObj = (ICFBamTZTimeTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZTimeType( ICFBamTZTimeTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimeTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimeTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
