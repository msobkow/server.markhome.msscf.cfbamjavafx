// Description: Java 11 JavaFX Add Pane implementation for TextDef.
...
/**
 *	CFBamJavaFXTextDefAddPane JavaFX Add Pane implementation
 *	for TextDef.
 */
public class CFBamJavaFXTextDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTextDefPaneCommon
{
	...
	public CFBamJavaFXTextDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
