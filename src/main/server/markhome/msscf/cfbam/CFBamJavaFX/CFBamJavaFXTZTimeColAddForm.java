// Description: Java 11 JavaFX Add Form implementation for TZTimeCol.
...
/**
 *	CFBamJavaFXTZTimeColAddForm JavaFX Add Form implementation
 *	for TZTimeCol.
 */
public class CFBamJavaFXTZTimeColAddForm
extends CFBorderPane
implements ICFBamJavaFXTZTimeColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZTimeCol";
	...
	public CFBamJavaFXTZTimeColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZTimeColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZTimeColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZTimeColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
