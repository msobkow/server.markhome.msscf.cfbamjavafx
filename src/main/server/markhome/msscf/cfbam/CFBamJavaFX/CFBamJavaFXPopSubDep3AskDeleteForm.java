// Description: Java 11 JavaFX Ask Delete Pane implementation for PopSubDep3.
...
/**
 *	CFBamJavaFXPopSubDep3AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for PopSubDep3.
 */
public class CFBamJavaFXPopSubDep3AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXPopSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete PopSubDep3";
	...
	public CFBamJavaFXPopSubDep3AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep3Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this PopSubDep3?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamPopSubDep3Obj obj = getJavaFXFocusAsPopSubDep3();
					ICFBamPopSubDep3EditObj editObj = (ICFBamPopSubDep3EditObj)obj.beginEdit();
		...
		attrPane = argSchema.getPopSubDep3Factory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsPopSubDep3( ICFBamPopSubDep3Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXPopSubDep3PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXPopSubDep3PaneCommon)attrPane).setPaneMode( value );
		}
	}
