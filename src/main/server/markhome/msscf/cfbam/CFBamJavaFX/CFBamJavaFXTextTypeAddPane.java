// Description: Java 11 JavaFX Add Pane implementation for TextType.
...
/**
 *	CFBamJavaFXTextTypeAddPane JavaFX Add Pane implementation
 *	for TextType.
 */
public class CFBamJavaFXTextTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXTextTypePaneCommon
{
	...
	public CFBamJavaFXTextTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
