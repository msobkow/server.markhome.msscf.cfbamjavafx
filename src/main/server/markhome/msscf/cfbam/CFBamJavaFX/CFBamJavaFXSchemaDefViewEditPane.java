// Description: Java 11 JavaFX View/Edit Pane implementation for SchemaDef.
...
/**
 *	CFBamJavaFXSchemaDefViewEditPane JavaFX View/Edit Pane implementation
 *	for SchemaDef.
 */
public class CFBamJavaFXSchemaDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXSchemaDefPaneCommon
{
	...
	public CFBamJavaFXSchemaDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXSchemaDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXSchemaDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
