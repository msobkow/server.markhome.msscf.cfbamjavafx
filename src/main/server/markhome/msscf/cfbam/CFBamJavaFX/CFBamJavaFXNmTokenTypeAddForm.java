// Description: Java 11 JavaFX Add Form implementation for NmTokenType.
...
/**
 *	CFBamJavaFXNmTokenTypeAddForm JavaFX Add Form implementation
 *	for NmTokenType.
 */
public class CFBamJavaFXNmTokenTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NmTokenType";
	...
	public CFBamJavaFXNmTokenTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamNmTokenTypeObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxAddPane = argSchema.getNmTokenTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamNmTokenTypeEditObj editObj = (ICFBamNmTokenTypeEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokenTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
		ICFBamNmTokenTypeObj argFocus = (ICFBamNmTokenTypeObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamNmTokenTypeObj)argFocus.read( true );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNmTokenTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
