// Description: Java 11 JavaFX Add Pane implementation for Relation.
...
/**
 *	CFBamJavaFXRelationAddPane JavaFX Add Pane implementation
 *	for Relation.
 */
public class CFBamJavaFXRelationAddPane
extends CFSplitPane
implements ICFBamJavaFXRelationPaneCommon
{
	...
	public CFBamJavaFXRelationAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
