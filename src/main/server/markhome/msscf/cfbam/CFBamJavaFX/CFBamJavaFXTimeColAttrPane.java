// Description: Java 11 JavaFX Attribute Pane implementation for TimeCol.
...
/**
 *	CFBamJavaFXTimeColAttrPane JavaFX Attribute Pane implementation
 *	for TimeCol.
 */
public class CFBamJavaFXTimeColAttrPane
extends CFGridPane
implements ICFBamJavaFXTimeColPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamTimeColObj cur = getJavaFXFocusAsTimeCol();
				if( cur != null ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamTimeColObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXTimeColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamTimeColObj getEffJavaFXFocus() {
		ICFBamTimeColObj eff = (ICFBamTimeColObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamTimeColObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamTimeColObj popObj = getEffJavaFXFocus();
