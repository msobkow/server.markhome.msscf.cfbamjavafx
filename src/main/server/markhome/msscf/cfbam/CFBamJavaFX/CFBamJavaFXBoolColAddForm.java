// Description: Java 11 JavaFX Add Form implementation for BoolCol.
...
/**
 *	CFBamJavaFXBoolColAddForm JavaFX Add Form implementation
 *	for BoolCol.
 */
public class CFBamJavaFXBoolColAddForm
extends CFBorderPane
implements ICFBamJavaFXBoolColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add BoolCol";
	...
	public CFBamJavaFXBoolColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getBoolColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXBoolColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getBoolColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBoolColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
