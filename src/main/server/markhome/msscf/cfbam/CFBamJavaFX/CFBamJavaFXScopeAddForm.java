// Description: Java 11 JavaFX Add Form implementation for Scope.
...
/**
 *	CFBamJavaFXScopeAddForm JavaFX Add Form implementation
 *	for Scope.
 */
public class CFBamJavaFXScopeAddForm
extends CFBorderPane
implements ICFBamJavaFXScopePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Scope";
	...
	public CFBamJavaFXScopeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamScopeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getScopeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXScopePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getScopeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXScopePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXScopePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
