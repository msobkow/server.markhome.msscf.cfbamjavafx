// Description: Java 11 JavaFX Add Pane implementation for TZTimeDef.
...
/**
 *	CFBamJavaFXTZTimeDefAddPane JavaFX Add Pane implementation
 *	for TZTimeDef.
 */
public class CFBamJavaFXTZTimeDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTZTimeDefPaneCommon
{
	...
	public CFBamJavaFXTZTimeDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
