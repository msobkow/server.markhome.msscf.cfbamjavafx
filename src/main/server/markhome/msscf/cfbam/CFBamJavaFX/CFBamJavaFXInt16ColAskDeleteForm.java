// Description: Java 11 JavaFX Ask Delete Pane implementation for Int16Col.
...
/**
 *	CFBamJavaFXInt16ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int16Col.
 */
public class CFBamJavaFXInt16ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt16ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int16Col";
	...
	public CFBamJavaFXInt16ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int16Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt16ColObj obj = getJavaFXFocusAsInt16Col();
					ICFBamInt16ColEditObj editObj = (ICFBamInt16ColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getInt16ColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsInt16Col( ICFBamInt16ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt16ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt16ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
