// Description: Java 11 JavaFX Add Form implementation for StringDef.
...
/**
 *	CFBamJavaFXStringDefAddForm JavaFX Add Form implementation
 *	for StringDef.
 */
public class CFBamJavaFXStringDefAddForm
extends CFBorderPane
implements ICFBamJavaFXStringDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add StringDef";
	...
	public CFBamJavaFXStringDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getStringDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXStringDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getStringDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXStringDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
