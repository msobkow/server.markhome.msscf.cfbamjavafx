// Description: Java 11 JavaFX View/Edit Pane implementation for Int64Col.
...
/**
 *	CFBamJavaFXInt64ColViewEditPane JavaFX View/Edit Pane implementation
 *	for Int64Col.
 */
public class CFBamJavaFXInt64ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt64ColPaneCommon
{
	...
	public CFBamJavaFXInt64ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getInt64ColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64ColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt64ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt64ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
