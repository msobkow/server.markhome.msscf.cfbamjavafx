// Description: Java 11 JavaFX View/Edit Pane implementation for ClearSubDep1.
...
/**
 *	CFBamJavaFXClearSubDep1ViewEditPane JavaFX View/Edit Pane implementation
 *	for ClearSubDep1.
 */
public class CFBamJavaFXClearSubDep1ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXClearSubDep1PaneCommon
{
	...
	public CFBamJavaFXClearSubDep1ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep1Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep1PaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep1PaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep1PaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
