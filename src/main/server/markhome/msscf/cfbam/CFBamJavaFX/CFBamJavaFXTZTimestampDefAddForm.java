// Description: Java 11 JavaFX Add Form implementation for TZTimestampDef.
...
/**
 *	CFBamJavaFXTZTimestampDefAddForm JavaFX Add Form implementation
 *	for TZTimestampDef.
 */
public class CFBamJavaFXTZTimestampDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTZTimestampDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZTimestampDef";
	...
	public CFBamJavaFXTZTimestampDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZTimestampDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZTimestampDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZTimestampDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimestampDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
