// Description: Java 11 JavaFX Add Pane implementation for Scope.
...
/**
 *	CFBamJavaFXScopeAddPane JavaFX Add Pane implementation
 *	for Scope.
 */
public class CFBamJavaFXScopeAddPane
extends CFSplitPane
implements ICFBamJavaFXScopePaneCommon
{
	...
	public CFBamJavaFXScopeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamScopeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXScopePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
