// Description: Java 11 JavaFX Ask Delete Pane implementation for NmTokenDef.
...
/**
 *	CFBamJavaFXNmTokenDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NmTokenDef.
 */
public class CFBamJavaFXNmTokenDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NmTokenDef";
	...
	public CFBamJavaFXNmTokenDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NmTokenDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNmTokenDefObj obj = getJavaFXFocusAsNmTokenDef();
					ICFBamNmTokenDefEditObj editObj = (ICFBamNmTokenDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNmTokenDef( ICFBamNmTokenDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokenDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokenDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
