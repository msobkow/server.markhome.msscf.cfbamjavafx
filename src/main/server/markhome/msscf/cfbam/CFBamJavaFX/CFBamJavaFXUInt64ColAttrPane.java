// Description: Java 11 JavaFX Attribute Pane implementation for UInt64Col.
...
/**
 *	CFBamJavaFXUInt64ColAttrPane JavaFX Attribute Pane implementation
 *	for UInt64Col.
 */
public class CFBamJavaFXUInt64ColAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt64ColPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUInt64ColObj cur = getJavaFXFocusAsUInt64Col();
				if( cur != null ) {
					ICFBamUInt64ColEditObj editObj = (ICFBamUInt64ColEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUInt64ColObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXUInt64ColAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamUInt64ColObj getEffJavaFXFocus() {
		ICFBamUInt64ColObj eff = (ICFBamUInt64ColObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUInt64ColObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUInt64ColObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamUInt64ColEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUInt64ColEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUInt64ColEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUInt64ColObj)editObj.create();
