// Description: Java 11 JavaFX View/Edit Pane implementation for TextDef.
...
/**
 *	CFBamJavaFXTextDefViewEditPane JavaFX View/Edit Pane implementation
 *	for TextDef.
 */
public class CFBamJavaFXTextDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTextDefPaneCommon
{
	...
	public CFBamJavaFXTextDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextDefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTextDefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTextDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTextDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
