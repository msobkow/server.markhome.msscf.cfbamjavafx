// Description: Java 11 JavaFX View/Edit Pane implementation for DelSubDep3.
...
/**
 *	CFBamJavaFXDelSubDep3ViewEditPane JavaFX View/Edit Pane implementation
 *	for DelSubDep3.
 */
public class CFBamJavaFXDelSubDep3ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDelSubDep3PaneCommon
{
	...
	public CFBamJavaFXDelSubDep3ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep3Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep3PaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
