// Description: Java 11 JavaFX Add Pane implementation for BlobType.
...
/**
 *	CFBamJavaFXBlobTypeAddPane JavaFX Add Pane implementation
 *	for BlobType.
 */
public class CFBamJavaFXBlobTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXBlobTypePaneCommon
{
	...
	public CFBamJavaFXBlobTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
