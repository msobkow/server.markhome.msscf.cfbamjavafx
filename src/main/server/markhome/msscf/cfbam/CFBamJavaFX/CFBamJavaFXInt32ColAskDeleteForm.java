// Description: Java 11 JavaFX Ask Delete Pane implementation for Int32Col.
...
/**
 *	CFBamJavaFXInt32ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int32Col.
 */
public class CFBamJavaFXInt32ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt32ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int32Col";
	...
	public CFBamJavaFXInt32ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int32Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt32ColObj obj = getJavaFXFocusAsInt32Col();
					ICFBamInt32ColEditObj editObj = (ICFBamInt32ColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsInt32Col( ICFBamInt32ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt32ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt32ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
