// Description: Java 11 JavaFX Add Form implementation for TextDef.
...
/**
 *	CFBamJavaFXTextDefAddForm JavaFX Add Form implementation
 *	for TextDef.
 */
public class CFBamJavaFXTextDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTextDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TextDef";
	...
	public CFBamJavaFXTextDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTextDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTextDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTextDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTextDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
