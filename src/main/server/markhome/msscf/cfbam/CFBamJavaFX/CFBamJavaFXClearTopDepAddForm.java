// Description: Java 11 JavaFX Add Form implementation for ClearTopDep.
...
/**
 *	CFBamJavaFXClearTopDepAddForm JavaFX Add Form implementation
 *	for ClearTopDep.
 */
public class CFBamJavaFXClearTopDepAddForm
extends CFBorderPane
implements ICFBamJavaFXClearTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ClearTopDep";
	...
	public CFBamJavaFXClearTopDepAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getClearTopDepFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXClearTopDepPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getClearTopDepFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearTopDepPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearTopDepPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
