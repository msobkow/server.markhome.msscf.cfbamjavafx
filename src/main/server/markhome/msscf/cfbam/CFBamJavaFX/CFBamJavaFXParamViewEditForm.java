// Description: Java 11 JavaFX View/Edit Form implementation for Param.
...
/**
 *	CFBamJavaFXParamViewEditForm JavaFX View/Edit Form implementation
 *	for Param.
 */
public class CFBamJavaFXParamViewEditForm
extends CFBorderPane
implements ICFBamJavaFXParamPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Param";
	...
	public CFBamJavaFXParamViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamParamObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamParamObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getParamFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXParamPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamParamObj argFocus = (ICFBamParamObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamParamObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsParam() != null ) {
							if( null == getJavaFXFocusAsParam().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXParamPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXParamPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
