// Description: Java 11 JavaFX Add Form implementation for SchemaRef.
...
/**
 *	CFBamJavaFXSchemaRefAddForm JavaFX Add Form implementation
 *	for SchemaRef.
 */
public class CFBamJavaFXSchemaRefAddForm
extends CFBorderPane
implements ICFBamJavaFXSchemaRefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add SchemaRef";
	...
	public CFBamJavaFXSchemaRefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaRefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSchemaRefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXSchemaRefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSchemaRefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaRefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXSchemaRefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
