// Description: Java 11 JavaFX Ask Delete Pane implementation for IndexCol.
...
/**
 *	CFBamJavaFXIndexColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for IndexCol.
 */
public class CFBamJavaFXIndexColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXIndexColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete IndexCol";
	...
	public CFBamJavaFXIndexColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this IndexCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamIndexColObj obj = getJavaFXFocusAsIndexCol();
					ICFBamIndexColEditObj editObj = (ICFBamIndexColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getIndexColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsIndexCol( ICFBamIndexColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXIndexColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXIndexColPaneCommon)attrPane).setPaneMode( value );
		}
	}
