// Description: Java 11 JavaFX View/Edit Pane implementation for TimestampType.
...
/**
 *	CFBamJavaFXTimestampTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for TimestampType.
 */
public class CFBamJavaFXTimestampTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTimestampTypePaneCommon
{
	...
	public CFBamJavaFXTimestampTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimestampTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTimestampTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
