// Description: Java 11 JavaFX Add Form implementation for NumberType.
...
/**
 *	CFBamJavaFXNumberTypeAddForm JavaFX Add Form implementation
 *	for NumberType.
 */
public class CFBamJavaFXNumberTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXNumberTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NumberType";
	...
	public CFBamJavaFXNumberTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNumberTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNumberTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNumberTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNumberTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
