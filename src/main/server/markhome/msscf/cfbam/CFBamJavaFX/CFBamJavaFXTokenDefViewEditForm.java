// Description: Java 11 JavaFX View/Edit Form implementation for TokenDef.
...
/**
 *	CFBamJavaFXTokenDefViewEditForm JavaFX View/Edit Form implementation
 *	for TokenDef.
 */
public class CFBamJavaFXTokenDefViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTokenDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TokenDef";
	...
	public CFBamJavaFXTokenDefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenDefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getTokenDefFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTokenDefPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTokenDef() != null ) {
							if( null == getJavaFXFocusAsTokenDef().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsTokenDef();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenDefPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTokenDefPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
