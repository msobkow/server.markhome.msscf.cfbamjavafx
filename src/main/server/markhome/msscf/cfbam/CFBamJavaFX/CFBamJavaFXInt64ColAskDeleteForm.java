// Description: Java 11 JavaFX Ask Delete Pane implementation for Int64Col.
...
/**
 *	CFBamJavaFXInt64ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int64Col.
 */
public class CFBamJavaFXInt64ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt64ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int64Col";
	...
	public CFBamJavaFXInt64ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int64Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt64ColObj obj = getJavaFXFocusAsInt64Col();
					ICFBamInt64ColEditObj editObj = (ICFBamInt64ColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsInt64Col( ICFBamInt64ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt64ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt64ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
