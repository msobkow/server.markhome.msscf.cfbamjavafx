// Description: Java 11 JavaFX View/Edit Pane implementation for UInt16Col.
...
/**
 *	CFBamJavaFXUInt16ColViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt16Col.
 */
public class CFBamJavaFXUInt16ColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt16ColPaneCommon
{
	...
	public CFBamJavaFXUInt16ColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16ColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt16ColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt16ColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
