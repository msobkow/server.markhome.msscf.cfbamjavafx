// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt64Def.
...
/**
 *	CFBamJavaFXUInt64DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt64Def.
 */
public class CFBamJavaFXUInt64DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt64DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt64Def";
	...
	public CFBamJavaFXUInt64DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt64Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt64DefObj obj = getJavaFXFocusAsUInt64Def();
					ICFBamUInt64DefEditObj editObj = (ICFBamUInt64DefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt64Def( ICFBamUInt64DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt64DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUInt64DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
