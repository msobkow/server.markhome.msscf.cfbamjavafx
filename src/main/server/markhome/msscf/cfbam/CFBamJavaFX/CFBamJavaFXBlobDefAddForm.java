// Description: Java 11 JavaFX Add Form implementation for BlobDef.
...
/**
 *	CFBamJavaFXBlobDefAddForm JavaFX Add Form implementation
 *	for BlobDef.
 */
public class CFBamJavaFXBlobDefAddForm
extends CFBorderPane
implements ICFBamJavaFXBlobDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add BlobDef";
	...
	public CFBamJavaFXBlobDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getBlobDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXBlobDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getBlobDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBlobDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
