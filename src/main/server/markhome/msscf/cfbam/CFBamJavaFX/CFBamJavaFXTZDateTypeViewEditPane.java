// Description: Java 11 JavaFX View/Edit Pane implementation for TZDateType.
...
/**
 *	CFBamJavaFXTZDateTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for TZDateType.
 */
public class CFBamJavaFXTZDateTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZDateTypePaneCommon
{
	...
	public CFBamJavaFXTZDateTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZDateTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
