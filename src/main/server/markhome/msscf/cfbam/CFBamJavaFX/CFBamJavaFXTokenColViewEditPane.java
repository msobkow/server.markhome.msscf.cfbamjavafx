// Description: Java 11 JavaFX View/Edit Pane implementation for TokenCol.
...
/**
 *	CFBamJavaFXTokenColViewEditPane JavaFX View/Edit Pane implementation
 *	for TokenCol.
 */
public class CFBamJavaFXTokenColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTokenColPaneCommon
{
	...
	public CFBamJavaFXTokenColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTokenColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTokenColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTokenColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
