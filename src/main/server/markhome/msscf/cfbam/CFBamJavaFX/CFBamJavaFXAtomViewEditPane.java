// Description: Java 11 JavaFX View/Edit Pane implementation for Atom.
...
/**
 *	CFBamJavaFXAtomViewEditPane JavaFX View/Edit Pane implementation
 *	for Atom.
 */
public class CFBamJavaFXAtomViewEditPane
extends CFSplitPane
implements ICFBamJavaFXAtomPaneCommon
{
	...
	public CFBamJavaFXAtomViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamAtomObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getAtomFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXAtomPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXAtomPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXAtomPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
