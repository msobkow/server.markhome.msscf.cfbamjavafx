// Description: Java 11 JavaFX Add Pane implementation for UInt16Type.
...
/**
 *	CFBamJavaFXUInt16TypeAddPane JavaFX Add Pane implementation
 *	for UInt16Type.
 */
public class CFBamJavaFXUInt16TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt16TypePaneCommon
{
	...
	public CFBamJavaFXUInt16TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
