// Description: Java 11 JavaFX View/Edit Pane implementation for NmTokenType.
...
/**
 *	CFBamJavaFXNmTokenTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for NmTokenType.
 */
public class CFBamJavaFXNmTokenTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNmTokenTypePaneCommon
{
	...
	public CFBamJavaFXNmTokenTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
