// Description: Java 11 JavaFX Add Pane implementation for UuidCol.
...
/**
 *	CFBamJavaFXUuidColAddPane JavaFX Add Pane implementation
 *	for UuidCol.
 */
public class CFBamJavaFXUuidColAddPane
extends CFSplitPane
implements ICFBamJavaFXUuidColPaneCommon
{
	...
	public CFBamJavaFXUuidColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
