// Description: Java 11 JavaFX Add Form implementation for FloatType.
...
/**
 *	CFBamJavaFXFloatTypeAddForm JavaFX Add Form implementation
 *	for FloatType.
 */
public class CFBamJavaFXFloatTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXFloatTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add FloatType";
	...
	public CFBamJavaFXFloatTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getFloatTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXFloatTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getFloatTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXFloatTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXFloatTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
