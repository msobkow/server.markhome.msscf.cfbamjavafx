// Description: Java 11 JavaFX Attribute Pane implementation for Index.
...
/**
 *	CFBamJavaFXIndexAttrPane JavaFX Attribute Pane implementation
 *	for Index.
 */
public class CFBamJavaFXIndexAttrPane
extends CFGridPane
implements ICFBamJavaFXIndexPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamIndexObj cur = getJavaFXFocusAsIndex();
				if( cur != null ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamIndexObj focus = getEffJavaFXFocus();
	...
	protected class IsUniqueCFLabel
		extends CFLabel
	{
		public IsUniqueCFLabel() {
			super();
			setText( "Is Unique" );
		}
	}

	protected class IsUniqueEditor
		extends CFBoolEditor
	{
		public IsUniqueEditor() {
			super();
			setIsNullable( false );
			setFieldName( "Is Unique" );
		}
	}

	protected class IsDbMappedCFLabel
		extends CFLabel
	{
		public IsDbMappedCFLabel() {
			super();
			setText( "Is Db Mapped" );
		}
	}

	protected class IsDbMappedEditor
		extends CFBoolEditor
	{
		public IsDbMappedEditor() {
			super();
			setIsNullable( false );
			setFieldName( "Is Db Mapped" );
		}
	}
	...
	protected IsUniqueCFLabel javafxLabelIsUnique = null;
	protected IsUniqueEditor javafxEditorIsUnique = null;
	protected IsDbMappedCFLabel javafxLabelIsDbMapped = null;
	protected IsDbMappedEditor javafxEditorIsDbMapped = null;

	public CFBamJavaFXIndexAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamIndexObj getEffJavaFXFocus() {
		ICFBamIndexObj eff = (ICFBamIndexObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamIndexObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	public IsUniqueCFLabel getJavaFXLabelIsUnique() {
		if( javafxLabelIsUnique == null ) {
			javafxLabelIsUnique = new IsUniqueCFLabel();
		}
		return( javafxLabelIsUnique );
	}

	public void setJavaFXLabelIsUnique( IsUniqueCFLabel value ) {
		javafxLabelIsUnique = value;
	}

	public IsUniqueEditor getJavaFXEditorIsUnique() {
		if( javafxEditorIsUnique == null ) {
			javafxEditorIsUnique = new IsUniqueEditor();
		}
		return( javafxEditorIsUnique );
	}

	public void setJavaFXEditorIsUnique( IsUniqueEditor value ) {
		javafxEditorIsUnique = value;
	}

	public IsDbMappedCFLabel getJavaFXLabelIsDbMapped() {
		if( javafxLabelIsDbMapped == null ) {
			javafxLabelIsDbMapped = new IsDbMappedCFLabel();
		}
		return( javafxLabelIsDbMapped );
	}

	public void setJavaFXLabelIsDbMapped( IsDbMappedCFLabel value ) {
		javafxLabelIsDbMapped = value;
	}

	public IsDbMappedEditor getJavaFXEditorIsDbMapped() {
		if( javafxEditorIsDbMapped == null ) {
			javafxEditorIsDbMapped = new IsDbMappedEditor();
		}
		return( javafxEditorIsDbMapped );
	}

	public void setJavaFXEditorIsDbMapped( IsDbMappedEditor value ) {
		javafxEditorIsDbMapped = value;
	}

	public void populateFields()
	{
		ICFBamIndexObj popObj = getEffJavaFXFocus();
		...
		if( popObj == null ) {
			getJavaFXEditorIsUnique().setBooleanValue( null );
		}
		else {
			getJavaFXEditorIsUnique().setBooleanValue( popObj.getRequiredIsUnique() );
		}

		if( popObj == null ) {
			getJavaFXEditorIsDbMapped().setBooleanValue( null );
		}
		else {
			getJavaFXEditorIsDbMapped().setBooleanValue( popObj.getRequiredIsDbMapped() );
		}
	}
	...
	public void postFields()
	{
		...
		editObj.setRequiredIsUnique( getJavaFXEditorIsUnique().getBooleanValue() );

		editObj.setRequiredIsDbMapped( getJavaFXEditorIsDbMapped().getBooleanValue() );
	}
	...
	public void adjustComponentEnableStates() {
		...
		if( javafxEditorIsUnique != null ) {
			javafxEditorIsUnique.setDisable( ! isEditing );
		}
		if( javafxEditorIsDbMapped != null ) {
			javafxEditorIsDbMapped.setDisable( ! isEditing );
		}
	}
}
