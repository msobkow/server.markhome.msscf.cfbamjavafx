// Description: Java 11 JavaFX Add Form implementation for UuidType.
...
/**
 *	CFBamJavaFXUuidTypeAddForm JavaFX Add Form implementation
 *	for UuidType.
 */
public class CFBamJavaFXUuidTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXUuidTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UuidType";
	...
	public CFBamJavaFXUuidTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUuidTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUuidTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUuidTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUuidTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
