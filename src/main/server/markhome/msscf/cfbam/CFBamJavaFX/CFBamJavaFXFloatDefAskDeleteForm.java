// Description: Java 11 JavaFX Ask Delete Pane implementation for FloatDef.
...
/**
 *	CFBamJavaFXFloatDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for FloatDef.
 */
public class CFBamJavaFXFloatDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXFloatDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete FloatDef";
	...
	public CFBamJavaFXFloatDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this FloatDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamFloatDefObj obj = getJavaFXFocusAsFloatDef();
					ICFBamFloatDefEditObj editObj = (ICFBamFloatDefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getFloatDefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsFloatDef( ICFBamFloatDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXFloatDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXFloatDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
