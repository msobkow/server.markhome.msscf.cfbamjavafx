// Description: Java 11 JavaFX Add Pane implementation for ServerObjFunc.
...
/**
 *	CFBamJavaFXServerObjFuncAddPane JavaFX Add Pane implementation
 *	for ServerObjFunc.
 */
public class CFBamJavaFXServerObjFuncAddPane
extends CFSplitPane
implements ICFBamJavaFXServerObjFuncPaneCommon
{
	...
	public CFBamJavaFXServerObjFuncAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerObjFuncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerObjFuncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
