// Description: Java 11 JavaFX Add Form implementation for DateCol.
...
/**
 *	CFBamJavaFXDateColAddForm JavaFX Add Form implementation
 *	for DateCol.
 */
public class CFBamJavaFXDateColAddForm
extends CFBorderPane
implements ICFBamJavaFXDateColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DateCol";
	...
	public CFBamJavaFXDateColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDateColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDateColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDateColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDateColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
