// Description: Java 11 JavaFX Add Pane implementation for Atom.
...
/**
 *	CFBamJavaFXAtomAddPane JavaFX Add Pane implementation
 *	for Atom.
 */
public class CFBamJavaFXAtomAddPane
extends CFSplitPane
implements ICFBamJavaFXAtomPaneCommon
{
	...
	public CFBamJavaFXAtomAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamAtomObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXAtomPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
