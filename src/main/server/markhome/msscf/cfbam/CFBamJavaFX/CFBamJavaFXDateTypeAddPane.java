// Description: Java 11 JavaFX Add Pane implementation for DateType.
...
/**
 *	CFBamJavaFXDateTypeAddPane JavaFX Add Pane implementation
 *	for DateType.
 */
public class CFBamJavaFXDateTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXDateTypePaneCommon
{
	...
	public CFBamJavaFXDateTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
