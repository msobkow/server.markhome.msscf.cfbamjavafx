// Description: Java 11 JavaFX Ask Delete Pane implementation for TZTimestampDef.
...
/**
 *	CFBamJavaFXTZTimestampDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZTimestampDef.
 */
public class CFBamJavaFXTZTimestampDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZTimestampDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZTimestampDef";
	...
	public CFBamJavaFXTZTimestampDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZTimestampDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZTimestampDefObj obj = getJavaFXFocusAsTZTimestampDef();
					ICFBamTZTimestampDefEditObj editObj = (ICFBamTZTimestampDefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTZTimestampDefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTZTimestampDef( ICFBamTZTimestampDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimestampDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimestampDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
