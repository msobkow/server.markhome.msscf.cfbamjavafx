// Description: Java 11 JavaFX Ask Delete Pane implementation for ClearDep.
...
/**
 *	CFBamJavaFXClearDepAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ClearDep.
 */
public class CFBamJavaFXClearDepAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXClearDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ClearDep";
	...
	public CFBamJavaFXClearDepAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearDepObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ClearDep?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamClearDepObj obj = getJavaFXFocusAsClearDep();
					ICFBamClearDepEditObj editObj = (ICFBamClearDepEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getClearDepFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsClearDep( ICFBamClearDepObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXClearDepPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXClearDepPaneCommon)attrPane).setPaneMode( value );
		}
	}
