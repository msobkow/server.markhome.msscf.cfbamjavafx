// Description: Java 11 JavaFX Ask Delete Pane implementation for EnumDef.
...
/**
 *	CFBamJavaFXEnumDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for EnumDef.
 */
public class CFBamJavaFXEnumDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXEnumDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete EnumDef";
	...
	public CFBamJavaFXEnumDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this EnumDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamEnumDefObj obj = getJavaFXFocusAsEnumDef();
					ICFBamEnumDefEditObj editObj = (ICFBamEnumDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsEnumDef( ICFBamEnumDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXEnumDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXEnumDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
