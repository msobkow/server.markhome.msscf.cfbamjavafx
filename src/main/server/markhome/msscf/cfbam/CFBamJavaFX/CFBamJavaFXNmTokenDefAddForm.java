// Description: Java 11 JavaFX Add Form implementation for NmTokenDef.
...
/**
 *	CFBamJavaFXNmTokenDefAddForm JavaFX Add Form implementation
 *	for NmTokenDef.
 */
public class CFBamJavaFXNmTokenDefAddForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NmTokenDef";
	...
	public CFBamJavaFXNmTokenDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNmTokenDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokenDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNmTokenDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
