// Description: Java 11 JavaFX Element TabPane implementation for TZTimeDef.
...
/**
 *	CFBamJavaFXTZTimeDefEltTabPane JavaFX Element TabPane implementation
 *	for TZTimeDef.
 */
public class CFBamJavaFXTZTimeDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZTimeDefPaneCommon
{
	...
	public CFBamJavaFXTZTimeDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZTimeDefObj focus = (ICFBamTZTimeDefObj)getJavaFXFocusAsTZTimeDef();
			if( focus != null ) {
