// Description: Java 11 JavaFX Element TabPane implementation for Int64Type.
...
/**
 *	CFBamJavaFXInt64TypeEltTabPane JavaFX Element TabPane implementation
 *	for Int64Type.
 */
public class CFBamJavaFXInt64TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXInt64TypePaneCommon
{
	...
	public CFBamJavaFXInt64TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamInt64TypeObj focus = (ICFBamInt64TypeObj)getJavaFXFocusAsInt64Type();
			if( focus != null ) {
