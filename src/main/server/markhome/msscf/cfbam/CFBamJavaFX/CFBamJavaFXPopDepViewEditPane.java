// Description: Java 11 JavaFX View/Edit Pane implementation for PopDep.
...
/**
 *	CFBamJavaFXPopDepViewEditPane JavaFX View/Edit Pane implementation
 *	for PopDep.
 */
public class CFBamJavaFXPopDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXPopDepPaneCommon
{
	...
	public CFBamJavaFXPopDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopDepPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
