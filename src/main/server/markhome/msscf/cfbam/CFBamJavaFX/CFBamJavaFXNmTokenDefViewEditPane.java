// Description: Java 11 JavaFX View/Edit Pane implementation for NmTokenDef.
...
/**
 *	CFBamJavaFXNmTokenDefViewEditPane JavaFX View/Edit Pane implementation
 *	for NmTokenDef.
 */
public class CFBamJavaFXNmTokenDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNmTokenDefPaneCommon
{
	...
	public CFBamJavaFXNmTokenDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
