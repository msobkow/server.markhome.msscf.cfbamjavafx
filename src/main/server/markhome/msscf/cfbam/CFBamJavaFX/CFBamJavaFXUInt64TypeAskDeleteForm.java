// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt64Type.
...
/**
 *	CFBamJavaFXUInt64TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt64Type.
 */
public class CFBamJavaFXUInt64TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt64TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt64Type";
	...
	public CFBamJavaFXUInt64TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt64Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt64TypeObj obj = getJavaFXFocusAsUInt64Type();
					ICFBamUInt64TypeEditObj editObj = (ICFBamUInt64TypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt64Type( ICFBamUInt64TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt64TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUInt64TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
