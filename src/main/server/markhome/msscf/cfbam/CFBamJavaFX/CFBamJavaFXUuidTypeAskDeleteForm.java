// Description: Java 11 JavaFX Ask Delete Pane implementation for UuidType.
...
/**
 *	CFBamJavaFXUuidTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UuidType.
 */
public class CFBamJavaFXUuidTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUuidTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UuidType";
	...
	public CFBamJavaFXUuidTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UuidType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUuidTypeObj obj = getJavaFXFocusAsUuidType();
					ICFBamUuidTypeEditObj editObj = (ICFBamUuidTypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getUuidTypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsUuidType( ICFBamUuidTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUuidTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUuidTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
