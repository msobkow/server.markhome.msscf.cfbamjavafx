// Description: Java 11 JavaFX Add Pane implementation for TimeCol.
...
/**
 *	CFBamJavaFXTimeColAddPane JavaFX Add Pane implementation
 *	for TimeCol.
 */
public class CFBamJavaFXTimeColAddPane
extends CFSplitPane
implements ICFBamJavaFXTimeColPaneCommon
{
	...
	public CFBamJavaFXTimeColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
