// Description: Java 11 JavaFX Element TabPane implementation for NmTokensDef.
...
/**
 *	CFBamJavaFXNmTokensDefEltTabPane JavaFX Element TabPane implementation
 *	for NmTokensDef.
 */
public class CFBamJavaFXNmTokensDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXNmTokensDefPaneCommon
{
	...
	public CFBamJavaFXNmTokensDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNmTokensDefObj focus = (ICFBamNmTokensDefObj)getJavaFXFocusAsNmTokensDef();
			if( focus != null ) {
