// Description: Java 11 JavaFX Add Form implementation for TZTimeType.
...
/**
 *	CFBamJavaFXTZTimeTypeAddForm JavaFX Add Form implementation
 *	for TZTimeType.
 */
public class CFBamJavaFXTZTimeTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXTZTimeTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZTimeType";
	...
	public CFBamJavaFXTZTimeTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZTimeTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZTimeTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZTimeTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
