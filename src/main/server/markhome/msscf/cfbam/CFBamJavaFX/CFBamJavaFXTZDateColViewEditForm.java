// Description: Java 11 JavaFX View/Edit Form implementation for TZDateCol.
...
/**
 *	CFBamJavaFXTZDateColViewEditForm JavaFX View/Edit Form implementation
 *	for TZDateCol.
 */
...
implements ICFBamJavaFXTZDateColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TZDateCol";
	...
	public CFBamJavaFXTZDateColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getTZDateColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZDateColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTZDateCol() != null ) {
							if( null == getJavaFXFocusAsTZDateCol().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
