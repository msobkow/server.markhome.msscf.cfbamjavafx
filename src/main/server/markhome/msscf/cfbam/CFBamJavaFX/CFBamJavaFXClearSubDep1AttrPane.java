// Description: Java 11 JavaFX Attribute Pane implementation for ClearSubDep1.
...
/**
 *	CFBamJavaFXClearSubDep1AttrPane JavaFX Attribute Pane implementation
 *	for ClearSubDep1.
 */
public class CFBamJavaFXClearSubDep1AttrPane
extends CFGridPane
implements ICFBamJavaFXClearSubDep1PaneCommon
{
	...
	implements ICFBamJavaFXRelationChosen
	{
		...
		public void choseRelation( ICFBamRelationObj value ) {
			if( javafxReferenceLookupRelation != null ) {
				ICFBamClearSubDep1Obj cur = getJavaFXFocusAsClearSubDep1();
				if( cur != null ) {
					ICFBamClearSubDep1EditObj editObj = (ICFBamClearSubDep1EditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamClearSubDep1Obj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXClearSubDep1AttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep1Obj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamClearSubDep1Obj getEffJavaFXFocus() {
		ICFBamClearSubDep1Obj eff = (ICFBamClearSubDep1Obj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamClearSubDep1Obj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamClearSubDep1Obj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamClearSubDep1EditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamClearSubDep1EditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamClearSubDep1EditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamClearSubDep1Obj)editObj.create();
