// Description: Java 11 JavaFX Element TabPane implementation for TokenCol.
...
/**
 *	CFBamJavaFXTokenColEltTabPane JavaFX Element TabPane implementation
 *	for TokenCol.
 */
public class CFBamJavaFXTokenColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTokenColPaneCommon
{
	...
	public CFBamJavaFXTokenColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTokenColObj focus = (ICFBamTokenColObj)getJavaFXFocusAsTokenCol();
			if( focus != null ) {
