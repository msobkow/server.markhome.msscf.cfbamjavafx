// Description: Java 11 JavaFX Ask Delete Pane implementation for DateCol.
...
/**
 *	CFBamJavaFXDateColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DateCol.
 */
public class CFBamJavaFXDateColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDateColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DateCol";
	...
	public CFBamJavaFXDateColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DateCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDateColObj obj = getJavaFXFocusAsDateCol();
					ICFBamDateColEditObj editObj = (ICFBamDateColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsDateCol( ICFBamDateColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDateColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDateColPaneCommon)attrPane).setPaneMode( value );
		}
	}
