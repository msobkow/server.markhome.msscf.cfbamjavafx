// Description: Java 11 JavaFX Element TabPane implementation for UInt32Def.
...
/**
 *	CFBamJavaFXUInt32DefEltTabPane JavaFX Element TabPane implementation
 *	for UInt32Def.
 */
public class CFBamJavaFXUInt32DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt32DefPaneCommon
{
	...
	public CFBamJavaFXUInt32DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt32DefObj focus = (ICFBamUInt32DefObj)getJavaFXFocusAsUInt32Def();
			if( focus != null ) {
