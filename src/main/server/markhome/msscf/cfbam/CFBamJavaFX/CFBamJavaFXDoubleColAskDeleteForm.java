// Description: Java 11 JavaFX Ask Delete Pane implementation for DoubleCol.
...
/**
 *	CFBamJavaFXDoubleColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DoubleCol.
 */
public class CFBamJavaFXDoubleColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDoubleColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DoubleCol";
	...
	public CFBamJavaFXDoubleColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DoubleCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDoubleColObj obj = getJavaFXFocusAsDoubleCol();
					ICFBamDoubleColEditObj editObj = (ICFBamDoubleColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDoubleColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDoubleCol( ICFBamDoubleColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDoubleColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDoubleColPaneCommon)attrPane).setPaneMode( value );
		}
	}
