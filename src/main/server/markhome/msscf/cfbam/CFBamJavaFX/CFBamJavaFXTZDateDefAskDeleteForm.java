// Description: Java 11 JavaFX Ask Delete Pane implementation for TZDateDef.
...
/**
 *	CFBamJavaFXTZDateDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZDateDef.
 */
public class CFBamJavaFXTZDateDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZDateDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZDateDef";
	...
	public CFBamJavaFXTZDateDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZDateDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZDateDefObj obj = getJavaFXFocusAsTZDateDef();
					ICFBamTZDateDefEditObj editObj = (ICFBamTZDateDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZDateDef( ICFBamTZDateDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZDateDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZDateDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
