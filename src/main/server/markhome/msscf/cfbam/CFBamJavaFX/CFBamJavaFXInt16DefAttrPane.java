// Description: Java 11 JavaFX Attribute Pane implementation for Int16Def.
...
/**
 *	CFBamJavaFXInt16DefAttrPane JavaFX Attribute Pane implementation
 *	for Int16Def.
 */
public class CFBamJavaFXInt16DefAttrPane
extends CFGridPane
implements ICFBamJavaFXInt16DefPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamInt16DefObj cur = getJavaFXFocusAsInt16Def();
				if( cur != null ) {
					ICFBamInt16DefEditObj editObj = (ICFBamInt16DefEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamInt16DefObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXInt16DefAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16DefObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamInt16DefObj getEffJavaFXFocus() {
		ICFBamInt16DefObj eff = (ICFBamInt16DefObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamInt16DefObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamInt16DefObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamInt16DefObj focus = getJavaFXFocusAsInt16Def();
		ICFBamInt16DefEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamInt16DefEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamInt16DefEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamInt16DefObj)editObj.create();
