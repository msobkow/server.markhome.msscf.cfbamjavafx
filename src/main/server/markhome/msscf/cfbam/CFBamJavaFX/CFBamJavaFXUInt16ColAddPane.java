// Description: Java 11 JavaFX Add Pane implementation for UInt16Col.
...
/**
 *	CFBamJavaFXUInt16ColAddPane JavaFX Add Pane implementation
 *	for UInt16Col.
 */
public class CFBamJavaFXUInt16ColAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt16ColPaneCommon
{
	...
	public CFBamJavaFXUInt16ColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16ColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
