// Description: Java 11 JavaFX Ask Delete Pane implementation for RelationCol.
...
/**
 *	CFBamJavaFXRelationColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for RelationCol.
 */
public class CFBamJavaFXRelationColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXRelationColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete RelationCol";
	...
	public CFBamJavaFXRelationColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this RelationCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamRelationColObj obj = getJavaFXFocusAsRelationCol();
					ICFBamRelationColEditObj editObj = (ICFBamRelationColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getRelationColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsRelationCol( ICFBamRelationColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXRelationColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXRelationColPaneCommon)attrPane).setPaneMode( value );
		}
	}
