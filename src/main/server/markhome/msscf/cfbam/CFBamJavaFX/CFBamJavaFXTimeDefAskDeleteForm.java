// Description: Java 11 JavaFX Ask Delete Pane implementation for TimeDef.
...
/**
 *	CFBamJavaFXTimeDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TimeDef.
 */
public class CFBamJavaFXTimeDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTimeDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TimeDef";
	...
	public CFBamJavaFXTimeDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TimeDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTimeDefObj obj = getJavaFXFocusAsTimeDef();
					ICFBamTimeDefEditObj editObj = (ICFBamTimeDefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTimeDefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTimeDef( ICFBamTimeDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTimeDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTimeDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
