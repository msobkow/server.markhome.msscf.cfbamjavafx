// Description: Java 11 JavaFX Add Form implementation for Chain.
...
/**
 *	CFBamJavaFXChainAddForm JavaFX Add Form implementation
 *	for Chain.
 */
public class CFBamJavaFXChainAddForm
extends CFBorderPane
implements ICFBamJavaFXChainPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Chain";
	...
	public CFBamJavaFXChainAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamChainObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getChainFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXChainPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getChainFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXChainPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXChainPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
