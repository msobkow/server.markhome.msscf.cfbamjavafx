// Description: Java 11 JavaFX View/Edit Pane implementation for DelSubDep2.
...
/**
 *	CFBamJavaFXDelSubDep2ViewEditPane JavaFX View/Edit Pane implementation
 *	for DelSubDep2.
 */
public class CFBamJavaFXDelSubDep2ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDelSubDep2PaneCommon
{
	...
	public CFBamJavaFXDelSubDep2ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep2Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep2PaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep2PaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep2PaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
