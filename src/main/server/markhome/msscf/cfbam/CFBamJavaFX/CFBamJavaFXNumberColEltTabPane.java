// Description: Java 11 JavaFX Element TabPane implementation for NumberCol.
...
/**
 *	CFBamJavaFXNumberColEltTabPane JavaFX Element TabPane implementation
 *	for NumberCol.
 */
public class CFBamJavaFXNumberColEltTabPane
extends CFTabPane
implements ICFBamJavaFXNumberColPaneCommon
{
	...
	public CFBamJavaFXNumberColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamNumberColObj focus = (ICFBamNumberColObj)getJavaFXFocusAsNumberCol();
			if( focus != null ) {
