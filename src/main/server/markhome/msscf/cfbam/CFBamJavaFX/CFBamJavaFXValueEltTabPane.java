// Description: Java 11 JavaFX Element TabPane implementation for Value.
...
/**
 *	CFBamJavaFXValueEltTabPane JavaFX Element TabPane implementation
 *	for Value.
 */
public class CFBamJavaFXValueEltTabPane
extends CFTabPane
implements ICFBamJavaFXValuePaneCommon
{
	...
	public CFBamJavaFXValueEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamValueObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamValueObj focus = (ICFBamValueObj)getJavaFXFocusAsValue();
			if( focus != null ) {
