// Description: Java 11 JavaFX View/Edit Form implementation for NmTokenType.
...
/**
 *	CFBamJavaFXNmTokenTypeViewEditForm JavaFX View/Edit Form implementation
 *	for NmTokenType.
 */
public class CFBamJavaFXNmTokenTypeViewEditForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit NmTokenType";
	...
	public CFBamJavaFXNmTokenTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokenTypePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenTypePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenTypePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
