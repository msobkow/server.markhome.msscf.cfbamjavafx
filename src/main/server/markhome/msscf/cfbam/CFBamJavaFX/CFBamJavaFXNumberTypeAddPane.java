// Description: Java 11 JavaFX Add Pane implementation for NumberType.
...
/**
 *	CFBamJavaFXNumberTypeAddPane JavaFX Add Pane implementation
 *	for NumberType.
 */
public class CFBamJavaFXNumberTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXNumberTypePaneCommon
{
	...
	public CFBamJavaFXNumberTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
