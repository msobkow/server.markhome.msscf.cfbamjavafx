// Description: Java 11 JavaFX Add Form implementation for Id16Gen.
...
/**
 *	CFBamJavaFXId16GenAddForm JavaFX Add Form implementation
 *	for Id16Gen.
 */
public class CFBamJavaFXId16GenAddForm
extends CFBorderPane
implements ICFBamJavaFXId16GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Id16Gen";
	...
	public CFBamJavaFXId16GenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId16GenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getId16GenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXId16GenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getId16GenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId16GenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId16GenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
