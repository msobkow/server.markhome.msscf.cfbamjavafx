// Description: Java 11 JavaFX View/Edit Form implementation for ServerMethod.
...
/**
 *	CFBamJavaFXServerMethodViewEditForm JavaFX View/Edit Form implementation
 *	for ServerMethod.
 */
public class CFBamJavaFXServerMethodViewEditForm
extends CFBorderPane
implements ICFBamJavaFXServerMethodPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit ServerMethod";
	...
	public CFBamJavaFXServerMethodViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerMethodObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getServerMethodFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamServerMethodEditObj editObj = (ICFBamServerMethodEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXServerMethodPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsServerMethod() != null ) {
							if( null == getJavaFXFocusAsServerMethod().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsServerMethod();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerMethodPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerMethodPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
