// Description: Java 11 JavaFX View/Edit Pane implementation for BoolDef.
...
/**
 *	CFBamJavaFXBoolDefViewEditPane JavaFX View/Edit Pane implementation
 *	for BoolDef.
 */
public class CFBamJavaFXBoolDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXBoolDefPaneCommon
{
	...
	public CFBamJavaFXBoolDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolDefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getBoolDefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBoolDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXBoolDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
