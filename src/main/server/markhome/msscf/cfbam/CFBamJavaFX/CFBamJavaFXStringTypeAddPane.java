// Description: Java 11 JavaFX Add Pane implementation for StringType.
...
/**
 *	CFBamJavaFXStringTypeAddPane JavaFX Add Pane implementation
 *	for StringType.
 */
public class CFBamJavaFXStringTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXStringTypePaneCommon
{
	...
	public CFBamJavaFXStringTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
