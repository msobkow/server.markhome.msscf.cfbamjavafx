// Description: Java 11 JavaFX View/Edit Pane implementation for TokenType.
...
/**
 *	CFBamJavaFXTokenTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for TokenType.
 */
public class CFBamJavaFXTokenTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTokenTypePaneCommon
{
	...
	public CFBamJavaFXTokenTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTokenTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTokenTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
