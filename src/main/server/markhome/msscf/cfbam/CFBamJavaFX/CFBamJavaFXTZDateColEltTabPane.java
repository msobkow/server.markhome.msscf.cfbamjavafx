// Description: Java 11 JavaFX Element TabPane implementation for TZDateCol.
...
/**
 *	CFBamJavaFXTZDateColEltTabPane JavaFX Element TabPane implementation
 *	for TZDateCol.
 */
public class CFBamJavaFXTZDateColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZDateColPaneCommon
{
	...
	public CFBamJavaFXTZDateColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZDateColObj focus = (ICFBamTZDateColObj)getJavaFXFocusAsTZDateCol();
			if( focus != null ) {
