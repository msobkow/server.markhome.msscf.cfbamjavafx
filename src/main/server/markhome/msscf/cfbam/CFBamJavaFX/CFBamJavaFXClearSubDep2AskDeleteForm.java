// Description: Java 11 JavaFX Ask Delete Pane implementation for ClearSubDep2.
...
/**
 *	CFBamJavaFXClearSubDep2AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ClearSubDep2.
 */
public class CFBamJavaFXClearSubDep2AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ClearSubDep2";
	...
	public CFBamJavaFXClearSubDep2AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep2Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ClearSubDep2?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamClearSubDep2Obj obj = getJavaFXFocusAsClearSubDep2();
					ICFBamClearSubDep2EditObj editObj = (ICFBamClearSubDep2EditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsClearSubDep2( ICFBamClearSubDep2Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXClearSubDep2PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXClearSubDep2PaneCommon)attrPane).setPaneMode( value );
		}
	}
