// Description: Java 11 JavaFX Add Pane implementation for FloatType.
...
/**
 *	CFBamJavaFXFloatTypeAddPane JavaFX Add Pane implementation
 *	for FloatType.
 */
public class CFBamJavaFXFloatTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXFloatTypePaneCommon
{
	...
	public CFBamJavaFXFloatTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXFloatTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
