// Description: Java 11 JavaFX Attribute Pane implementation for EnumTag.
...
/**
 *	CFBamJavaFXEnumTagAttrPane JavaFX Attribute Pane implementation
 *	for EnumTag.
 */
public class CFBamJavaFXEnumTagAttrPane
extends CFGridPane
implements ICFBamJavaFXEnumTagPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamEnumTagObj cur = getJavaFXFocusAsEnumTag();
				if( cur != null ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamEnumTagObj focus = getEffJavaFXFocus();
		...
		extends CFInt64Editor
	{
		public IdEditor() {
			super();
			setMinValue( CFBamEnumTagBuff.ID_MIN_VALUE );
			setFieldName( "Id" );
		}
	}

	protected class EnumCodeCFLabel
		extends CFLabel
	{
		public EnumCodeCFLabel() {
			super();
			setText( "EnumCode" );
		}
	}

	protected class EnumCodeEditor
		extends CFInt16Editor
	{
		public EnumCodeEditor() {
			super();
			setMinValue( CFBamEnumTagBuff.ENUMCODE_MIN_VALUE );
			setMaxValue( CFBamEnumTagBuff.ENUMCODE_MAX_VALUE );
			setFieldName( "EnumCode" );
		}
	}
	...
	protected EnumCodeCFLabel javafxLabelEnumCode = null;
	protected EnumCodeEditor javafxEditorEnumCode = null;
	protected NameCFLabel javafxLabelName = null;
	protected NameEditor javafxEditorName = null;

	public CFBamJavaFXEnumTagAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamEnumTagObj getEffJavaFXFocus() {
		ICFBamEnumTagObj eff = (ICFBamEnumTagObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamEnumTagObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	public EnumCodeCFLabel getJavaFXLabelEnumCode() {
		if( javafxLabelEnumCode == null ) {
			javafxLabelEnumCode = new EnumCodeCFLabel();
		}
		return( javafxLabelEnumCode );
	}

	public void setJavaFXLabelEnumCode( EnumCodeCFLabel value ) {
		javafxLabelEnumCode = value;
	}

	public EnumCodeEditor getJavaFXEditorEnumCode() {
		if( javafxEditorEnumCode == null ) {
			javafxEditorEnumCode = new EnumCodeEditor();
		}
		return( javafxEditorEnumCode );
	}

	public void setJavaFXEditorEnumCode( EnumCodeEditor value ) {
		javafxEditorEnumCode = value;
	}
	...
	{
		ICFBamEnumTagObj popObj = getEffJavaFXFocus();
		...
		if( popObj == null ) {
			getJavaFXEditorEnumCode().setInt16Value( null );
		}
		else {
			getJavaFXEditorEnumCode().setInt16Value( popObj.getOptionalEnumCode() );
		}
	...
	public void postFields()
	{
		...
		ICFBamEnumTagObj focus = getJavaFXFocusAsEnumTag();
		...
		editObj.setOptionalEnumCode( getJavaFXEditorEnumCode().getInt16Value() );
	...
	public void adjustComponentEnableStates() {
		...
		if( javafxEditorEnumCode != null ) {
			javafxEditorEnumCode.setDisable( ! isEditing );
		}
		if( javafxEditorName != null ) {
