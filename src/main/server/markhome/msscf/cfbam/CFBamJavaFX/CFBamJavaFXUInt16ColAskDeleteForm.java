// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt16Col.
...
/**
 *	CFBamJavaFXUInt16ColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt16Col.
 */
public class CFBamJavaFXUInt16ColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt16ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt16Col";
	...
	public CFBamJavaFXUInt16ColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt16Col?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt16ColObj obj = getJavaFXFocusAsUInt16Col();
					ICFBamUInt16ColEditObj editObj = (ICFBamUInt16ColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt16Col( ICFBamUInt16ColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt16ColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUInt16ColPaneCommon)attrPane).setPaneMode( value );
		}
	}
