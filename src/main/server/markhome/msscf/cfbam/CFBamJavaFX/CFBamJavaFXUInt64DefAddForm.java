// Description: Java 11 JavaFX Add Form implementation for UInt64Def.
...
/**
 *	CFBamJavaFXUInt64DefAddForm JavaFX Add Form implementation
 *	for UInt64Def.
 */
public class CFBamJavaFXUInt64DefAddForm
extends CFBorderPane
implements ICFBamJavaFXUInt64DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UInt64Def";
	...
	public CFBamJavaFXUInt64DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUInt64DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt64DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUInt64DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt64DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
