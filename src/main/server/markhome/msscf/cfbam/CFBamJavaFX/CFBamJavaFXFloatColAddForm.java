// Description: Java 11 JavaFX Add Form implementation for FloatCol.
...
/**
 *	CFBamJavaFXFloatColAddForm JavaFX Add Form implementation
 *	for FloatCol.
 */
public class CFBamJavaFXFloatColAddForm
extends CFBorderPane
implements ICFBamJavaFXFloatColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add FloatCol";
	...
	public CFBamJavaFXFloatColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getFloatColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXFloatColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getFloatColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXFloatColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXFloatColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
