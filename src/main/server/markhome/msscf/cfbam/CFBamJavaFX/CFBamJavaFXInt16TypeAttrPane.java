// Description: Java 11 JavaFX Attribute Pane implementation for Int16Type.
...
/**
 *	CFBamJavaFXInt16TypeAttrPane JavaFX Attribute Pane implementation
 *	for Int16Type.
 */
public class CFBamJavaFXInt16TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXInt16TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamInt16TypeObj cur = getJavaFXFocusAsInt16Type();
				if( cur != null ) {
					ICFBamInt16TypeEditObj editObj = (ICFBamInt16TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamInt16TypeObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXInt16TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamInt16TypeObj getEffJavaFXFocus() {
		ICFBamInt16TypeObj eff = (ICFBamInt16TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamInt16TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamInt16TypeObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamInt16TypeObj focus = getJavaFXFocusAsInt16Type();
		ICFBamInt16TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamInt16TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamInt16TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamInt16TypeObj)editObj.create();
