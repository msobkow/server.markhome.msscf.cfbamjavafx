// Description: Java 11 JavaFX View/Edit Pane implementation for DateDef.
...
/**
 *	CFBamJavaFXDateDefViewEditPane JavaFX View/Edit Pane implementation
 *	for DateDef.
 */
public class CFBamJavaFXDateDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXDateDefPaneCommon
{
	...
	public CFBamJavaFXDateDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateDefObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getDateDefFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDateDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXDateDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
