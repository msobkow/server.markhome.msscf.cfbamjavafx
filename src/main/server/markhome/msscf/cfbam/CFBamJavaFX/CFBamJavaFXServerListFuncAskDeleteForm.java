// Description: Java 11 JavaFX Ask Delete Pane implementation for ServerListFunc.
...
/**
 *	CFBamJavaFXServerListFuncAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ServerListFunc.
 */
public class CFBamJavaFXServerListFuncAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXServerListFuncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ServerListFunc";
	...
	public CFBamJavaFXServerListFuncAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ServerListFunc?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamServerListFuncObj obj = getJavaFXFocusAsServerListFunc();
					ICFBamServerListFuncEditObj editObj = (ICFBamServerListFuncEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsServerListFunc( ICFBamServerListFuncObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXServerListFuncPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXServerListFuncPaneCommon)attrPane).setPaneMode( value );
		}
	}
