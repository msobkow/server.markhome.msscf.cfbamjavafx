// Description: Java 11 JavaFX Add Pane implementation for EnumTag.
...
/**
 *	CFBamJavaFXEnumTagAddPane JavaFX Add Pane implementation
 *	for EnumTag.
 */
public class CFBamJavaFXEnumTagAddPane
extends CFSplitPane
implements ICFBamJavaFXEnumTagPaneCommon
{
	...
	public CFBamJavaFXEnumTagAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTagObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTagPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
