// Description: Java 11 JavaFX Add Form implementation for DelSubDep3.
...
/**
 *	CFBamJavaFXDelSubDep3AddForm JavaFX Add Form implementation
 *	for DelSubDep3.
 */
public class CFBamJavaFXDelSubDep3AddForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DelSubDep3";
	...
	public CFBamJavaFXDelSubDep3AddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep3Obj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDelSubDep3Factory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelSubDep3PaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDelSubDep3Factory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep3PaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep3PaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
