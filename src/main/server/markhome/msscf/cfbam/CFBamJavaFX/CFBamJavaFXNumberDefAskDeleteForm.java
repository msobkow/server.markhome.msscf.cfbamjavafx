// Description: Java 11 JavaFX Ask Delete Pane implementation for NumberDef.
...
/**
 *	CFBamJavaFXNumberDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NumberDef.
 */
public class CFBamJavaFXNumberDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNumberDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NumberDef";
	...
	public CFBamJavaFXNumberDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NumberDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNumberDefObj obj = getJavaFXFocusAsNumberDef();
					ICFBamNumberDefEditObj editObj = (ICFBamNumberDefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNumberDef( ICFBamNumberDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNumberDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNumberDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
