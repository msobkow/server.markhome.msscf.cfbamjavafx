// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt16Def.
...
/**
 *	CFBamJavaFXUInt16DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt16Def.
 */
public class CFBamJavaFXUInt16DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt16DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt16Def";
	...
	public CFBamJavaFXUInt16DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt16Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt16DefObj obj = getJavaFXFocusAsUInt16Def();
					ICFBamUInt16DefEditObj editObj = (ICFBamUInt16DefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt16Def( ICFBamUInt16DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt16DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUInt16DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
