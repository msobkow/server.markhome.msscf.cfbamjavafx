// Description: Java 11 JavaFX Ask Delete Pane implementation for PopSubDep1.
...
/**
 *	CFBamJavaFXPopSubDep1AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for PopSubDep1.
 */
public class CFBamJavaFXPopSubDep1AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXPopSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete PopSubDep1";
	...
	public CFBamJavaFXPopSubDep1AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep1Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this PopSubDep1?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamPopSubDep1Obj obj = getJavaFXFocusAsPopSubDep1();
					ICFBamPopSubDep1EditObj editObj = (ICFBamPopSubDep1EditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsPopSubDep1( ICFBamPopSubDep1Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXPopSubDep1PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
