// Description: Java 11 JavaFX Ask Delete Pane implementation for NmTokensType.
...
/**
 *	CFBamJavaFXNmTokensTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NmTokensType.
 */
public class CFBamJavaFXNmTokensTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNmTokensTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NmTokensType";
	...
	public CFBamJavaFXNmTokensTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NmTokensType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNmTokensTypeObj obj = getJavaFXFocusAsNmTokensType();
					ICFBamNmTokensTypeEditObj editObj = (ICFBamNmTokensTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNmTokensType( ICFBamNmTokensTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokensTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokensTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
