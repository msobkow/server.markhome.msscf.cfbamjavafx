// Description: Java 11 JavaFX Element TabPane implementation for TZTimestampCol.
...
/**
 *	CFBamJavaFXTZTimestampColEltTabPane JavaFX Element TabPane implementation
 *	for TZTimestampCol.
 */
public class CFBamJavaFXTZTimestampColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTZTimestampColPaneCommon
{
	...
	public CFBamJavaFXTZTimestampColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTZTimestampColObj focus = (ICFBamTZTimestampColObj)getJavaFXFocusAsTZTimestampCol();
			if( focus != null ) {
