// Description: Java 11 JavaFX View/Edit Form implementation for Int32Def.
...
/**
 *	CFBamJavaFXInt32DefViewEditForm JavaFX View/Edit Form implementation
 *	for Int32Def.
 */
public class CFBamJavaFXInt32DefViewEditForm
extends CFBorderPane
implements ICFBamJavaFXInt32DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Int32Def";
	...
	public CFBamJavaFXInt32DefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32DefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getInt32DefFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt32DefPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsInt32Def() != null ) {
							if( null == getJavaFXFocusAsInt32Def().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32DefPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt32DefPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
