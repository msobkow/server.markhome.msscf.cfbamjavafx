// Description: Java 11 JavaFX Add Form implementation for TZDateDef.
...
/**
 *	CFBamJavaFXTZDateDefAddForm JavaFX Add Form implementation
 *	for TZDateDef.
 */
public class CFBamJavaFXTZDateDefAddForm
extends CFBorderPane
implements ICFBamJavaFXTZDateDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TZDateDef";
	...
	public CFBamJavaFXTZDateDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTZDateDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTZDateDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTZDateDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
