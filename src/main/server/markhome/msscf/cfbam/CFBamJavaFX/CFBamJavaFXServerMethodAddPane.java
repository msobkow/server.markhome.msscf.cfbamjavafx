// Description: Java 11 JavaFX Add Pane implementation for ServerMethod.
...
/**
 *	CFBamJavaFXServerMethodAddPane JavaFX Add Pane implementation
 *	for ServerMethod.
 */
public class CFBamJavaFXServerMethodAddPane
extends CFSplitPane
implements ICFBamJavaFXServerMethodPaneCommon
{
	...
	public CFBamJavaFXServerMethodAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerMethodObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerMethodPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
