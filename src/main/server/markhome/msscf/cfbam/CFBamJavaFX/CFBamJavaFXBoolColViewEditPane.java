// Description: Java 11 JavaFX View/Edit Pane implementation for BoolCol.
...
/**
 *	CFBamJavaFXBoolColViewEditPane JavaFX View/Edit Pane implementation
 *	for BoolCol.
 */
public class CFBamJavaFXBoolColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXBoolColPaneCommon
{
	...
	public CFBamJavaFXBoolColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getBoolColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBoolColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXBoolColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXBoolColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
