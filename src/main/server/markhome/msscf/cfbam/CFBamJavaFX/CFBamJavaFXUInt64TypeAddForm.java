// Description: Java 11 JavaFX Add Form implementation for UInt64Type.
...
/**
 *	CFBamJavaFXUInt64TypeAddForm JavaFX Add Form implementation
 *	for UInt64Type.
 */
public class CFBamJavaFXUInt64TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXUInt64TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UInt64Type";
	...
	public CFBamJavaFXUInt64TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUInt64TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt64TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUInt64TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt64TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
