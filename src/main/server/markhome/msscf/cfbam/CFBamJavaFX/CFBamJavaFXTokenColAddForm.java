// Description: Java 11 JavaFX Add Form implementation for TokenCol.
...
/**
 *	CFBamJavaFXTokenColAddForm JavaFX Add Form implementation
 *	for TokenCol.
 */
public class CFBamJavaFXTokenColAddForm
extends CFBorderPane
implements ICFBamJavaFXTokenColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TokenCol";
	...
	public CFBamJavaFXTokenColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTokenColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamTokenColEditObj editObj = (ICFBamTokenColEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTokenColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						focus = getJavaFXFocusAsTokenCol();
						CFBorderPane frame = javafxSchema.getTokenColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTokenColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTokenColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
