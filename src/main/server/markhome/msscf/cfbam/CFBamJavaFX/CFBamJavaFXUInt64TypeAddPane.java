// Description: Java 11 JavaFX Add Pane implementation for UInt64Type.
...
/**
 *	CFBamJavaFXUInt64TypeAddPane JavaFX Add Pane implementation
 *	for UInt64Type.
 */
public class CFBamJavaFXUInt64TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXUInt64TypePaneCommon
{
	...
	public CFBamJavaFXUInt64TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
