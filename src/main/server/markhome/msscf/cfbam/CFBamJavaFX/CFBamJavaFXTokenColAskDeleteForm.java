// Description: Java 11 JavaFX Ask Delete Pane implementation for TokenCol.
...
/**
 *	CFBamJavaFXTokenColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TokenCol.
 */
public class CFBamJavaFXTokenColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTokenColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TokenCol";
	...
	public CFBamJavaFXTokenColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTokenColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TokenCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTokenColObj obj = getJavaFXFocusAsTokenCol();
					ICFBamTokenColEditObj editObj = (ICFBamTokenColEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTokenCol( ICFBamTokenColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTokenColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTokenColPaneCommon)attrPane).setPaneMode( value );
		}
	}
