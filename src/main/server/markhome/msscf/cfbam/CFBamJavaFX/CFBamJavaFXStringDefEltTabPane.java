// Description: Java 11 JavaFX Element TabPane implementation for StringDef.
...
/**
 *	CFBamJavaFXStringDefEltTabPane JavaFX Element TabPane implementation
 *	for StringDef.
 */
public class CFBamJavaFXStringDefEltTabPane
extends CFTabPane
implements ICFBamJavaFXStringDefPaneCommon
{
	...
	public CFBamJavaFXStringDefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringDefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamStringDefObj focus = (ICFBamStringDefObj)getJavaFXFocusAsStringDef();
			if( focus != null ) {
