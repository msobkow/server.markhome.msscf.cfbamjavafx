// Description: Java 11 JavaFX View/Edit Form implementation for RelationCol.
...
/**
 *	CFBamJavaFXRelationColViewEditForm JavaFX View/Edit Form implementation
 *	for RelationCol.
 */
public class CFBamJavaFXRelationColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXRelationColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit RelationCol";
	...
	public CFBamJavaFXRelationColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamRelationColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamRelationColObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getRelationColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXRelationColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamRelationColObj argFocus = (ICFBamRelationColObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamRelationColObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsRelationCol() != null ) {
							if( null == getJavaFXFocusAsRelationCol().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsRelationCol();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXRelationColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXRelationColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
