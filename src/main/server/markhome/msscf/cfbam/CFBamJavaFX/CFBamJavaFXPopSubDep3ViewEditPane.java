// Description: Java 11 JavaFX View/Edit Pane implementation for PopSubDep3.
...
/**
 *	CFBamJavaFXPopSubDep3ViewEditPane JavaFX View/Edit Pane implementation
 *	for PopSubDep3.
 */
public class CFBamJavaFXPopSubDep3ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXPopSubDep3PaneCommon
{
	...
	public CFBamJavaFXPopSubDep3ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep3Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopSubDep3PaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
