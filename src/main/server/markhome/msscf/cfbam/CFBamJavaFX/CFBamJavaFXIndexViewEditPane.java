// Description: Java 11 JavaFX View/Edit Pane implementation for Index.
...
/**
 *	CFBamJavaFXIndexViewEditPane JavaFX View/Edit Pane implementation
 *	for Index.
 */
public class CFBamJavaFXIndexViewEditPane
extends CFSplitPane
implements ICFBamJavaFXIndexPaneCommon
{
	...
	public CFBamJavaFXIndexViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus ) {
		...
		eltTabPane = argSchema.getIndexFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXIndexPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXIndexPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXIndexPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
