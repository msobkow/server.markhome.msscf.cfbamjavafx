// Description: Java 11 JavaFX View/Edit Form implementation for UInt32Col.
...
/**
 *	CFBamJavaFXUInt32ColViewEditForm JavaFX View/Edit Form implementation
 *	for UInt32Col.
 */
public class CFBamJavaFXUInt32ColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXUInt32ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit UInt32Col";
	...
	public CFBamJavaFXUInt32ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamUInt32ColObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getUInt32ColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamUInt32ColEditObj editObj = (ICFBamUInt32ColEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt32ColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamUInt32ColObj argFocus = (ICFBamUInt32ColObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamUInt32ColObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsUInt32Col() != null ) {
							if( null == getJavaFXFocusAsUInt32Col().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsUInt32Col();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt32ColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt32ColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
