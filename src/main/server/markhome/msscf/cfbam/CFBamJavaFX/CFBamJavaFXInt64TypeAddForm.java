// Description: Java 11 JavaFX Add Form implementation for Int64Type.
...
/**
 *	CFBamJavaFXInt64TypeAddForm JavaFX Add Form implementation
 *	for Int64Type.
 */
public class CFBamJavaFXInt64TypeAddForm
extends CFBorderPane
implements ICFBamJavaFXInt64TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int64Type";
	...
	public CFBamJavaFXInt64TypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt64TypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt64TypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt64TypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt64TypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt64TypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
