// Description: Java 11 JavaFX View/Edit Pane implementation for NumberDef.
...
/**
 *	CFBamJavaFXNumberDefViewEditPane JavaFX View/Edit Pane implementation
 *	for NumberDef.
 */
public class CFBamJavaFXNumberDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNumberDefPaneCommon
{
	...
	public CFBamJavaFXNumberDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNumberDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNumberDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
