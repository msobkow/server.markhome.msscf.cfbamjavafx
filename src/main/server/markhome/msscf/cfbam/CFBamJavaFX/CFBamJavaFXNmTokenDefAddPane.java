// Description: Java 11 JavaFX Add Pane implementation for NmTokenDef.
...
/**
 *	CFBamJavaFXNmTokenDefAddPane JavaFX Add Pane implementation
 *	for NmTokenDef.
 */
public class CFBamJavaFXNmTokenDefAddPane
extends CFSplitPane
implements ICFBamJavaFXNmTokenDefPaneCommon
{
	...
	public CFBamJavaFXNmTokenDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
