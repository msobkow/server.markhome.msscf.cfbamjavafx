// Description: Java 11 JavaFX Ask Delete Pane implementation for TZTimestampType.
...
/**
 *	CFBamJavaFXTZTimestampTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZTimestampType.
 */
public class CFBamJavaFXTZTimestampTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZTimestampTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZTimestampType";
	...
	public CFBamJavaFXTZTimestampTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZTimestampType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZTimestampTypeObj obj = getJavaFXFocusAsTZTimestampType();
					ICFBamTZTimestampTypeEditObj editObj = (ICFBamTZTimestampTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZTimestampType( ICFBamTZTimestampTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZTimestampTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
