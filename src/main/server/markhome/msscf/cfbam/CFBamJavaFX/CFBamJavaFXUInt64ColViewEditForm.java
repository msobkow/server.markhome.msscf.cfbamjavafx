// Description: Java 11 JavaFX View/Edit Form implementation for UInt64Col.
...
/**
 *	CFBamJavaFXUInt64ColViewEditForm JavaFX View/Edit Form implementation
 *	for UInt64Col.
 */
public class CFBamJavaFXUInt64ColViewEditForm
extends CFBorderPane
implements ICFBamJavaFXUInt64ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit UInt64Col";
	...
	public CFBamJavaFXUInt64ColViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64ColObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getUInt64ColFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt64ColPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsUInt64Col() != null ) {
							if( null == getJavaFXFocusAsUInt64Col().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64ColPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt64ColPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
