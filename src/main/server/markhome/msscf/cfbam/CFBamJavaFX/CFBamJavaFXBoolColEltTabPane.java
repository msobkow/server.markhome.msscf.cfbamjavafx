// Description: Java 11 JavaFX Element TabPane implementation for BoolCol.
...
/**
 *	CFBamJavaFXBoolColEltTabPane JavaFX Element TabPane implementation
 *	for BoolCol.
 */
public class CFBamJavaFXBoolColEltTabPane
extends CFTabPane
implements ICFBamJavaFXBoolColPaneCommon
{
	...
	public CFBamJavaFXBoolColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamBoolColObj focus = (ICFBamBoolColObj)getJavaFXFocusAsBoolCol();
			if( focus != null ) {
