// Description: Java 11 JavaFX Add Pane implementation for ServerProc.
...
/**
 *	CFBamJavaFXServerProcAddPane JavaFX Add Pane implementation
 *	for ServerProc.
 */
public class CFBamJavaFXServerProcAddPane
extends CFSplitPane
implements ICFBamJavaFXServerProcPaneCommon
{
	...
	public CFBamJavaFXServerProcAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerProcObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerProcPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
