// Description: Java 11 JavaFX Ask Delete Pane implementation for Id32Gen.
...
/**
 *	CFBamJavaFXId32GenAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Id32Gen.
 */
public class CFBamJavaFXId32GenAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXId32GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Id32Gen";
	...
	public CFBamJavaFXId32GenAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId32GenObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Id32Gen?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamId32GenObj obj = getJavaFXFocusAsId32Gen();
					ICFBamId32GenEditObj editObj = (ICFBamId32GenEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getId32GenFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsId32Gen( ICFBamId32GenObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXId32GenPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXId32GenPaneCommon)attrPane).setPaneMode( value );
		}
	}
