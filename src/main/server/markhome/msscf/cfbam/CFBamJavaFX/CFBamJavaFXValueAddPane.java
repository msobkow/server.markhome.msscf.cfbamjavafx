// Description: Java 11 JavaFX Add Pane implementation for Value.
...
/**
 *	CFBamJavaFXValueAddPane JavaFX Add Pane implementation
 *	for Value.
 */
public class CFBamJavaFXValueAddPane
extends CFSplitPane
implements ICFBamJavaFXValuePaneCommon
{
	...
	public CFBamJavaFXValueAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamValueObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXValuePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
