// Description: Java 11 JavaFX View/Edit Pane implementation for Chain.
...
/**
 *	CFBamJavaFXChainViewEditPane JavaFX View/Edit Pane implementation
 *	for Chain.
 */
public class CFBamJavaFXChainViewEditPane
extends CFSplitPane
implements ICFBamJavaFXChainPaneCommon
{
	...
	public CFBamJavaFXChainViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamChainObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXChainPaneCommon)attrPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
