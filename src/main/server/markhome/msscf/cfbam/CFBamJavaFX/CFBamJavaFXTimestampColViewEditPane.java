// Description: Java 11 JavaFX View/Edit Pane implementation for TimestampCol.
...
/**
 *	CFBamJavaFXTimestampColViewEditPane JavaFX View/Edit Pane implementation
 *	for TimestampCol.
 */
public class CFBamJavaFXTimestampColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTimestampColPaneCommon
{
	...
	public CFBamJavaFXTimestampColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimestampColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTimestampColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
