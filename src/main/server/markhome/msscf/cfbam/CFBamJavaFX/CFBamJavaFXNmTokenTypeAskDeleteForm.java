// Description: Java 11 JavaFX Ask Delete Pane implementation for NmTokenType.
...
/**
 *	CFBamJavaFXNmTokenTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for NmTokenType.
 */
public class CFBamJavaFXNmTokenTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXNmTokenTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete NmTokenType";
	...
	public CFBamJavaFXNmTokenTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this NmTokenType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamNmTokenTypeObj obj = getJavaFXFocusAsNmTokenType();
					ICFBamNmTokenTypeEditObj editObj = (ICFBamNmTokenTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsNmTokenType( ICFBamNmTokenTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokenTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXNmTokenTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
