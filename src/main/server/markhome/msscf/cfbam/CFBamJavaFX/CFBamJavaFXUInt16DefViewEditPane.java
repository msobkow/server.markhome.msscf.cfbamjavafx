// Description: Java 11 JavaFX View/Edit Pane implementation for UInt16Def.
...
/**
 *	CFBamJavaFXUInt16DefViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt16Def.
 */
public class CFBamJavaFXUInt16DefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt16DefPaneCommon
{
	...
	public CFBamJavaFXUInt16DefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16DefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt16DefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt16DefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
