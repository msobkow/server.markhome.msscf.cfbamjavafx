// Description: Java 11 JavaFX Add Pane implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypeAddPane JavaFX Add Pane implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypeAddPane
extends CFSplitPane
implements ICFBamJavaFXInt32TypePaneCommon
{
	...
	public CFBamJavaFXInt32TypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32TypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
