// Description: Java 11 JavaFX Add Pane implementation for ServerListFunc.
...
/**
 *	CFBamJavaFXServerListFuncAddPane JavaFX Add Pane implementation
 *	for ServerListFunc.
 */
public class CFBamJavaFXServerListFuncAddPane
extends CFSplitPane
implements ICFBamJavaFXServerListFuncPaneCommon
{
	...
	public CFBamJavaFXServerListFuncAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerListFuncPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
