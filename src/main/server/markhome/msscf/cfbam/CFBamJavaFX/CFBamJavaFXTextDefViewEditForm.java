// Description: Java 11 JavaFX View/Edit Form implementation for TextDef.
...
/**
 *	CFBamJavaFXTextDefViewEditForm JavaFX View/Edit Form implementation
 *	for TextDef.
 */
public class CFBamJavaFXTextDefViewEditForm
extends CFBorderPane
implements ICFBamJavaFXTextDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit TextDef";
	...
	public CFBamJavaFXTextDefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextDefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTextDefObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getTextDefFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		...
		if( focus != null ) {
			ICFBamTextDefEditObj editObj = (ICFBamTextDefEditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTextDefPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamTextDefObj argFocus = (ICFBamTextDefObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamTextDefObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsTextDef() != null ) {
							if( null == getJavaFXFocusAsTextDef().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextDefPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTextDefPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
