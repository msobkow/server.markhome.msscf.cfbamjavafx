// Description: Java 11 JavaFX View/Edit Pane implementation for Table.
...
/**
 *	CFBamJavaFXTableViewEditPane JavaFX View/Edit Pane implementation
 *	for Table.
 */
public class CFBamJavaFXTableViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTablePaneCommon
{
	...
	public CFBamJavaFXTableViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTableFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTablePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTablePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTablePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
