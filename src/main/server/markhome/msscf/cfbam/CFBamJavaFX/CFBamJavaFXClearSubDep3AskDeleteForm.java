// Description: Java 11 JavaFX Ask Delete Pane implementation for ClearSubDep3.
...
/**
 *	CFBamJavaFXClearSubDep3AskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ClearSubDep3.
 */
public class CFBamJavaFXClearSubDep3AskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXClearSubDep3PaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ClearSubDep3";
	...
	public CFBamJavaFXClearSubDep3AskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep3Obj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ClearSubDep3?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamClearSubDep3Obj obj = getJavaFXFocusAsClearSubDep3();
					ICFBamClearSubDep3EditObj editObj = (ICFBamClearSubDep3EditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsClearSubDep3( ICFBamClearSubDep3Obj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXClearSubDep3PaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
