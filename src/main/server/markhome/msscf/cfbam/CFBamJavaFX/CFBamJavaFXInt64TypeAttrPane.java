// Description: Java 11 JavaFX Attribute Pane implementation for Int64Type.
...
/**
 *	CFBamJavaFXInt64TypeAttrPane JavaFX Attribute Pane implementation
 *	for Int64Type.
 */
public class CFBamJavaFXInt64TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXInt64TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamInt64TypeObj cur = getJavaFXFocusAsInt64Type();
				if( cur != null ) {
					ICFBamInt64TypeEditObj editObj = (ICFBamInt64TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamInt64TypeObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXInt64TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
		...
		setJavaFXFocusAsInt64Type( argFocus );
	...
	public ICFBamInt64TypeObj getEffJavaFXFocus() {
		ICFBamInt64TypeObj eff = (ICFBamInt64TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamInt64TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamInt64TypeObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamInt64TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamInt64TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamInt64TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamInt64TypeObj)editObj.create();
