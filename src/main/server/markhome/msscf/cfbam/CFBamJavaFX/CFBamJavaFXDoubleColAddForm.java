// Description: Java 11 JavaFX Add Form implementation for DoubleCol.
...
/**
 *	CFBamJavaFXDoubleColAddForm JavaFX Add Form implementation
 *	for DoubleCol.
 */
public class CFBamJavaFXDoubleColAddForm
extends CFBorderPane
implements ICFBamJavaFXDoubleColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DoubleCol";
	...
	public CFBamJavaFXDoubleColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDoubleColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDoubleColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDoubleColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDoubleColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDoubleColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
