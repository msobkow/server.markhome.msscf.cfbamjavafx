// Description: Java 11 JavaFX Add Form implementation for SchemaDef.
...
/**
 *	CFBamJavaFXSchemaDefAddForm JavaFX Add Form implementation
 *	for SchemaDef.
 */
public class CFBamJavaFXSchemaDefAddForm
extends CFBorderPane
implements ICFBamJavaFXSchemaDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add SchemaDef";
	...
	public CFBamJavaFXSchemaDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getSchemaDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXSchemaDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getSchemaDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXSchemaDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
