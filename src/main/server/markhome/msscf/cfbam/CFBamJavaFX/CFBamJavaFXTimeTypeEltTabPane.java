// Description: Java 11 JavaFX Element TabPane implementation for TimeType.
...
/**
 *	CFBamJavaFXTimeTypeEltTabPane JavaFX Element TabPane implementation
 *	for TimeType.
 */
public class CFBamJavaFXTimeTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXTimeTypePaneCommon
{
	...
	public CFBamJavaFXTimeTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTimeTypeObj focus = (ICFBamTimeTypeObj)getJavaFXFocusAsTimeType();
			if( focus != null ) {
