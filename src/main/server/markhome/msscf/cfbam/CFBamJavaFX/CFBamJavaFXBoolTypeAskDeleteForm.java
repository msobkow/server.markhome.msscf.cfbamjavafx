// Description: Java 11 JavaFX Ask Delete Pane implementation for BoolType.
...
/**
 *	CFBamJavaFXBoolTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for BoolType.
 */
public class CFBamJavaFXBoolTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXBoolTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete BoolType";
	...
	public CFBamJavaFXBoolTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBoolTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this BoolType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamBoolTypeObj obj = getJavaFXFocusAsBoolType();
					ICFBamBoolTypeEditObj editObj = (ICFBamBoolTypeEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getBoolTypeFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsBoolType( ICFBamBoolTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXBoolTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXBoolTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
