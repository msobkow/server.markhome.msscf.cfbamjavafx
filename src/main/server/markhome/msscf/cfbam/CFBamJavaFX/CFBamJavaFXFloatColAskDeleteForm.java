// Description: Java 11 JavaFX Ask Delete Pane implementation for FloatCol.
...
/**
 *	CFBamJavaFXFloatColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for FloatCol.
 */
public class CFBamJavaFXFloatColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXFloatColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete FloatCol";
	...
	public CFBamJavaFXFloatColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamFloatColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this FloatCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamFloatColObj obj = getJavaFXFocusAsFloatCol();
					ICFBamFloatColEditObj editObj = (ICFBamFloatColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getFloatColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsFloatCol( ICFBamFloatColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXFloatColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXFloatColPaneCommon)attrPane).setPaneMode( value );
		}
	}
