// Description: Java 11 JavaFX Add Pane implementation for TZTimestampType.
...
/**
 *	CFBamJavaFXTZTimestampTypeAddPane JavaFX Add Pane implementation
 *	for TZTimestampType.
 */
public class CFBamJavaFXTZTimestampTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXTZTimestampTypePaneCommon
{
	...
	public CFBamJavaFXTZTimestampTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimestampTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimestampTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
