// Description: Java 11 JavaFX Element TabPane implementation for UInt16Def.
...
/**
 *	CFBamJavaFXUInt16DefEltTabPane JavaFX Element TabPane implementation
 *	for UInt16Def.
 */
public class CFBamJavaFXUInt16DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt16DefPaneCommon
{
	...
	public CFBamJavaFXUInt16DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt16DefObj focus = (ICFBamUInt16DefObj)getJavaFXFocusAsUInt16Def();
			if( focus != null ) {
