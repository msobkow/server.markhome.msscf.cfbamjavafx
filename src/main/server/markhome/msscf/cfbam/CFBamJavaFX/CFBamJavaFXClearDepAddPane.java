// Description: Java 11 JavaFX Add Pane implementation for ClearDep.
...
/**
 *	CFBamJavaFXClearDepAddPane JavaFX Add Pane implementation
 *	for ClearDep.
 */
public class CFBamJavaFXClearDepAddPane
extends CFSplitPane
implements ICFBamJavaFXClearDepPaneCommon
{
	...
	public CFBamJavaFXClearDepAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearDepPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
