// Description: Java 11 JavaFX Ask Delete Pane implementation for Int64Def.
...
/**
 *	CFBamJavaFXInt64DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int64Def.
 */
public class CFBamJavaFXInt64DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt64DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int64Def";
	...
	public CFBamJavaFXInt64DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int64Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt64DefObj obj = getJavaFXFocusAsInt64Def();
					ICFBamInt64DefEditObj editObj = (ICFBamInt64DefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsInt64Def( ICFBamInt64DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt64DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt64DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
