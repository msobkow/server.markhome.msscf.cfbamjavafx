// Description: Java 11 JavaFX Element TabPane implementation for EnumType.
...
/**
 *	CFBamJavaFXEnumTypeEltTabPane JavaFX Element TabPane implementation
 *	for EnumType.
 */
public class CFBamJavaFXEnumTypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXEnumTypePaneCommon
{
	...
	public CFBamJavaFXEnumTypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamEnumTypeObj focus = (ICFBamEnumTypeObj)getJavaFXFocusAsEnumType();
			if( focus != null ) {
