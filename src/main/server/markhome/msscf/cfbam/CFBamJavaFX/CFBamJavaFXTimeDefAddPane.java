// Description: Java 11 JavaFX Add Pane implementation for TimeDef.
...
/**
 *	CFBamJavaFXTimeDefAddPane JavaFX Add Pane implementation
 *	for TimeDef.
 */
public class CFBamJavaFXTimeDefAddPane
extends CFSplitPane
implements ICFBamJavaFXTimeDefPaneCommon
{
	...
	public CFBamJavaFXTimeDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimeDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
