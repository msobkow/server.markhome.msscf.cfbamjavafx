// Description: Java 11 JavaFX View/Edit Form implementation for EnumType.
...
/**
 *	CFBamJavaFXEnumTypeViewEditForm JavaFX View/Edit Form implementation
 *	for EnumType.
 */
public class CFBamJavaFXEnumTypeViewEditForm
extends CFBorderPane
implements ICFBamJavaFXEnumTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit EnumType";
	...
	public CFBamJavaFXEnumTypeViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		javafxViewEditPane = argSchema.getEnumTypeFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXEnumTypePaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsEnumType() != null ) {
							if( null == getJavaFXFocusAsEnumType().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumTypePaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXEnumTypePaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
