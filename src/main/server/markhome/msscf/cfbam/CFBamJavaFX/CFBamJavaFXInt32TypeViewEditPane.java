// Description: Java 11 JavaFX View/Edit Pane implementation for Int32Type.
...
/**
 *	CFBamJavaFXInt32TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for Int32Type.
 */
public class CFBamJavaFXInt32TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXInt32TypePaneCommon
{
	...
	public CFBamJavaFXInt32TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt32TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt32TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt32TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXInt32TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
