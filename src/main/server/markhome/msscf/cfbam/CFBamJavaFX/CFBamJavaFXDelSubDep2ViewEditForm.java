// Description: Java 11 JavaFX View/Edit Form implementation for DelSubDep2.
...
/**
 *	CFBamJavaFXDelSubDep2ViewEditForm JavaFX View/Edit Form implementation
 *	for DelSubDep2.
 */
public class CFBamJavaFXDelSubDep2ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep2PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DelSubDep2";
	...
	public CFBamJavaFXDelSubDep2ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep2Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelSubDep2Obj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getDelSubDep2Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamDelSubDep2Obj focus = getJavaFXFocusAsDelSubDep2();
		if( focus != null ) {
			ICFBamDelSubDep2EditObj editObj = (ICFBamDelSubDep2EditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelSubDep2PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamDelSubDep2Obj argFocus = (ICFBamDelSubDep2Obj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelSubDep2Obj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDelSubDep2() != null ) {
							if( null == getJavaFXFocusAsDelSubDep2().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsDelSubDep2();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep2PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep2PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
