// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt16Type.
...
/**
 *	CFBamJavaFXUInt16TypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt16Type.
 */
public class CFBamJavaFXUInt16TypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt16TypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt16Type";
	...
	public CFBamJavaFXUInt16TypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16TypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt16Type?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt16TypeObj obj = getJavaFXFocusAsUInt16Type();
					ICFBamUInt16TypeEditObj editObj = (ICFBamUInt16TypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt16Type( ICFBamUInt16TypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt16TypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUInt16TypePaneCommon)attrPane).setPaneMode( value );
		}
	}
