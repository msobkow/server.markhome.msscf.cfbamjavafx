// Description: Java 11 JavaFX Ask Delete Pane implementation for PopDep.
...
/**
 *	CFBamJavaFXPopDepAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for PopDep.
 */
public class CFBamJavaFXPopDepAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXPopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete PopDep";
	...
	public CFBamJavaFXPopDepAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopDepObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this PopDep?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamPopDepObj obj = getJavaFXFocusAsPopDep();
					ICFBamPopDepEditObj editObj = (ICFBamPopDepEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsPopDep( ICFBamPopDepObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXPopDepPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXPopDepPaneCommon)attrPane).setPaneMode( value );
		}
	}
