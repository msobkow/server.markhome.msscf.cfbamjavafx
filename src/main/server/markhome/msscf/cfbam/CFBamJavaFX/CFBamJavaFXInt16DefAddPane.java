// Description: Java 11 JavaFX Add Pane implementation for Int16Def.
...
/**
 *	CFBamJavaFXInt16DefAddPane JavaFX Add Pane implementation
 *	for Int16Def.
 */
public class CFBamJavaFXInt16DefAddPane
extends CFSplitPane
implements ICFBamJavaFXInt16DefPaneCommon
{
	...
	public CFBamJavaFXInt16DefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16DefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
