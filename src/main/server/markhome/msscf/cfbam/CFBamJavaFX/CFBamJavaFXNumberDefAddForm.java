// Description: Java 11 JavaFX Add Form implementation for NumberDef.
...
/**
 *	CFBamJavaFXNumberDefAddForm JavaFX Add Form implementation
 *	for NumberDef.
 */
public class CFBamJavaFXNumberDefAddForm
extends CFBorderPane
implements ICFBamJavaFXNumberDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NumberDef";
	...
	public CFBamJavaFXNumberDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNumberDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNumberDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNumberDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNumberDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
