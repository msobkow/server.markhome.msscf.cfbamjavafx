// Description: Java 11 JavaFX Element TabPane implementation for UInt64Type.
...
/**
 *	CFBamJavaFXUInt64TypeEltTabPane JavaFX Element TabPane implementation
 *	for UInt64Type.
 */
public class CFBamJavaFXUInt64TypeEltTabPane
extends CFTabPane
implements ICFBamJavaFXUInt64TypePaneCommon
{
	...
	public CFBamJavaFXUInt64TypeEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamUInt64TypeObj focus = (ICFBamUInt64TypeObj)getJavaFXFocusAsUInt64Type();
			if( focus != null ) {
