// Description: Java 11 JavaFX Ask Delete Pane implementation for DoubleType.
...
/**
 *	CFBamJavaFXDoubleTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DoubleType.
 */
public class CFBamJavaFXDoubleTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDoubleTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DoubleType";
	...
	public CFBamJavaFXDoubleTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DoubleType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDoubleTypeObj obj = getJavaFXFocusAsDoubleType();
					ICFBamDoubleTypeEditObj editObj = (ICFBamDoubleTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsDoubleType( ICFBamDoubleTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDoubleTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDoubleTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
