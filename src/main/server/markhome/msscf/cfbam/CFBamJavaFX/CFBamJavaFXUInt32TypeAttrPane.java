// Description: Java 11 JavaFX Attribute Pane implementation for UInt32Type.
...
/**
 *	CFBamJavaFXUInt32TypeAttrPane JavaFX Attribute Pane implementation
 *	for UInt32Type.
 */
public class CFBamJavaFXUInt32TypeAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt32TypePaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUInt32TypeObj cur = getJavaFXFocusAsUInt32Type();
				if( cur != null ) {
					ICFBamUInt32TypeEditObj editObj = (ICFBamUInt32TypeEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUInt32TypeObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXUInt32TypeAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32TypeObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamUInt32TypeObj getEffJavaFXFocus() {
		ICFBamUInt32TypeObj eff = (ICFBamUInt32TypeObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUInt32TypeObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUInt32TypeObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamUInt32TypeEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUInt32TypeEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUInt32TypeEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUInt32TypeObj)editObj.create();
