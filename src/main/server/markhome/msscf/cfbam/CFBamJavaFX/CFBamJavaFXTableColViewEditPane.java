// Description: Java 11 JavaFX View/Edit Pane implementation for TableCol.
...
/**
 *	CFBamJavaFXTableColViewEditPane JavaFX View/Edit Pane implementation
 *	for TableCol.
 */
public class CFBamJavaFXTableColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTableColPaneCommon
{
	...
	public CFBamJavaFXTableColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTableColObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getTableColFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTableColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTableColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTableColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
