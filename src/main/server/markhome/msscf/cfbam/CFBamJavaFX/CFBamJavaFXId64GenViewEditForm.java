// Description: Java 11 JavaFX View/Edit Form implementation for Id64Gen.
...
/**
 *	CFBamJavaFXId64GenViewEditForm JavaFX View/Edit Form implementation
 *	for Id64Gen.
 */
public class CFBamJavaFXId64GenViewEditForm
extends CFBorderPane
implements ICFBamJavaFXId64GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit Id64Gen";
	...
	public CFBamJavaFXId64GenViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamId64GenObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getId64GenFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXId64GenPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamId64GenObj argFocus = (ICFBamId64GenObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamId64GenObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsId64Gen() != null ) {
							if( null == getJavaFXFocusAsId64Gen().getEdit() ) {
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId64GenPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId64GenPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
