// Description: Java 11 JavaFX View/Edit Pane implementation for ClearSubDep2.
...
/**
 *	CFBamJavaFXClearSubDep2ViewEditPane JavaFX View/Edit Pane implementation
 *	for ClearSubDep2.
 */
public class CFBamJavaFXClearSubDep2ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXClearSubDep2PaneCommon
{
	...
	public CFBamJavaFXClearSubDep2ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep2Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearSubDep2PaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep2PaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXClearSubDep2PaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
