// Description: Java 11 JavaFX Add Form implementation for DelTopDep.
...
/**
 *	CFBamJavaFXDelTopDepAddForm JavaFX Add Form implementation
 *	for DelTopDep.
 */
public class CFBamJavaFXDelTopDepAddForm
extends CFBorderPane
implements ICFBamJavaFXDelTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add DelTopDep";
	...
	public CFBamJavaFXDelTopDepAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getDelTopDepFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelTopDepPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getDelTopDepFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelTopDepPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelTopDepPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
