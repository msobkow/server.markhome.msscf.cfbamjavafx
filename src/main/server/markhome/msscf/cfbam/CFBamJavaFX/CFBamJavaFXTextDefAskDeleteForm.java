// Description: Java 11 JavaFX Ask Delete Pane implementation for TextDef.
...
/**
 *	CFBamJavaFXTextDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TextDef.
 */
public class CFBamJavaFXTextDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTextDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TextDef";
	...
	public CFBamJavaFXTextDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TextDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTextDefObj obj = getJavaFXFocusAsTextDef();
					ICFBamTextDefEditObj editObj = (ICFBamTextDefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTextDefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTextDef( ICFBamTextDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTextDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTextDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
