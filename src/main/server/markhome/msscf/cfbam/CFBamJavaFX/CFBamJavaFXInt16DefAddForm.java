// Description: Java 11 JavaFX Add Form implementation for Int16Def.
...
/**
 *	CFBamJavaFXInt16DefAddForm JavaFX Add Form implementation
 *	for Int16Def.
 */
public class CFBamJavaFXInt16DefAddForm
extends CFBorderPane
implements ICFBamJavaFXInt16DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Int16Def";
	...
	public CFBamJavaFXInt16DefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16DefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getInt16DefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXInt16DefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getInt16DefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXInt16DefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXInt16DefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
