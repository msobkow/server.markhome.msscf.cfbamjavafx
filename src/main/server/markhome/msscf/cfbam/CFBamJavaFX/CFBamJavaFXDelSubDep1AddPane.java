// Description: Java 11 JavaFX Add Pane implementation for DelSubDep1.
...
/**
 *	CFBamJavaFXDelSubDep1AddPane JavaFX Add Pane implementation
 *	for DelSubDep1.
 */
public class CFBamJavaFXDelSubDep1AddPane
extends CFSplitPane
implements ICFBamJavaFXDelSubDep1PaneCommon
{
	...
	public CFBamJavaFXDelSubDep1AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep1Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep1PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
