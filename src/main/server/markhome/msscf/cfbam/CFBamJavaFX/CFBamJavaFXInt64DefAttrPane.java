// Description: Java 11 JavaFX Attribute Pane implementation for Int64Def.
...
/**
 *	CFBamJavaFXInt64DefAttrPane JavaFX Attribute Pane implementation
 *	for Int64Def.
 */
public class CFBamJavaFXInt64DefAttrPane
extends CFGridPane
implements ICFBamJavaFXInt64DefPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamInt64DefObj cur = getJavaFXFocusAsInt64Def();
				if( cur != null ) {
					ICFBamInt64DefEditObj editObj = (ICFBamInt64DefEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamInt64DefObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXInt64DefAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt64DefObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamInt64DefObj getEffJavaFXFocus() {
		ICFBamInt64DefObj eff = (ICFBamInt64DefObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamInt64DefObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamInt64DefObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamInt64DefEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamInt64DefEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamInt64DefEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamInt64DefObj)editObj.create();
