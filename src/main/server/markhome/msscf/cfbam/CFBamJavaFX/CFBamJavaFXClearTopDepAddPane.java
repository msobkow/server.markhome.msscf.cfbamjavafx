// Description: Java 11 JavaFX Add Pane implementation for ClearTopDep.
...
/**
 *	CFBamJavaFXClearTopDepAddPane JavaFX Add Pane implementation
 *	for ClearTopDep.
 */
public class CFBamJavaFXClearTopDepAddPane
extends CFSplitPane
implements ICFBamJavaFXClearTopDepPaneCommon
{
	...
	public CFBamJavaFXClearTopDepAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXClearTopDepPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
