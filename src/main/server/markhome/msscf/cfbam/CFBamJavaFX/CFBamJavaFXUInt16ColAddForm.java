// Description: Java 11 JavaFX Add Form implementation for UInt16Col.
...
/**
 *	CFBamJavaFXUInt16ColAddForm JavaFX Add Form implementation
 *	for UInt16Col.
 */
public class CFBamJavaFXUInt16ColAddForm
extends CFBorderPane
implements ICFBamJavaFXUInt16ColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add UInt16Col";
	...
	public CFBamJavaFXUInt16ColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt16ColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getUInt16ColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXUInt16ColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getUInt16ColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt16ColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt16ColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
