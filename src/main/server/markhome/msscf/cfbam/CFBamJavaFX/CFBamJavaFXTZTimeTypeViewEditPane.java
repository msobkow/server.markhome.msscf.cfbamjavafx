// Description: Java 11 JavaFX View/Edit Pane implementation for TZTimeType.
...
/**
 *	CFBamJavaFXTZTimeTypeViewEditPane JavaFX View/Edit Pane implementation
 *	for TZTimeType.
 */
public class CFBamJavaFXTZTimeTypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZTimeTypePaneCommon
{
	...
	public CFBamJavaFXTZTimeTypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZTimeTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZTimeTypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeTypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZTimeTypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
