// Description: Java 11 JavaFX Add Form implementation for ServerListFunc.
...
/**
 *	CFBamJavaFXServerListFuncAddForm JavaFX Add Form implementation
 *	for ServerListFunc.
 */
public class CFBamJavaFXServerListFuncAddForm
extends CFBorderPane
implements ICFBamJavaFXServerListFuncPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add ServerListFunc";
	...
	public CFBamJavaFXServerListFuncAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamServerListFuncObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getServerListFuncFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXServerListFuncPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getServerListFuncFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXServerListFuncPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXServerListFuncPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
