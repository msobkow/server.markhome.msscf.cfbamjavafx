// Description: Java 11 JavaFX View/Edit Pane implementation for UInt64Def.
...
/**
 *	CFBamJavaFXUInt64DefViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt64Def.
 */
public class CFBamJavaFXUInt64DefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt64DefPaneCommon
{
	...
	public CFBamJavaFXUInt64DefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64DefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64DefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt64DefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt64DefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
