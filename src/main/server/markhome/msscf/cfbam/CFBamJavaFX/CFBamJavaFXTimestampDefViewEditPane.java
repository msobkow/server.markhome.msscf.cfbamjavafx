// Description: Java 11 JavaFX View/Edit Pane implementation for TimestampDef.
...
/**
 *	CFBamJavaFXTimestampDefViewEditPane JavaFX View/Edit Pane implementation
 *	for TimestampDef.
 */
public class CFBamJavaFXTimestampDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTimestampDefPaneCommon
{
	...
	public CFBamJavaFXTimestampDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTimestampDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTimestampDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
