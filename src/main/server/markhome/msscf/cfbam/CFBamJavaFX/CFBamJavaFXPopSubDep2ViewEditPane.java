// Description: Java 11 JavaFX View/Edit Pane implementation for PopSubDep2.
...
/**
 *	CFBamJavaFXPopSubDep2ViewEditPane JavaFX View/Edit Pane implementation
 *	for PopSubDep2.
 */
public class CFBamJavaFXPopSubDep2ViewEditPane
extends CFSplitPane
implements ICFBamJavaFXPopSubDep2PaneCommon
{
	...
	public CFBamJavaFXPopSubDep2ViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopSubDep2Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopSubDep2PaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopSubDep2PaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXPopSubDep2PaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
