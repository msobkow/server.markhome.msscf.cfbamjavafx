// Description: Java 11 JavaFX View/Edit Pane implementation for NmTokenCol.
...
/**
 *	CFBamJavaFXNmTokenColViewEditPane JavaFX View/Edit Pane implementation
 *	for NmTokenCol.
 */
public class CFBamJavaFXNmTokenColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXNmTokenColPaneCommon
{
	...
	public CFBamJavaFXNmTokenColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokenColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokenColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXNmTokenColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
