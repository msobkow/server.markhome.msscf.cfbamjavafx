// Description: Java 11 JavaFX View/Edit Form implementation for SchemaDef.
...
/**
 *	CFBamJavaFXSchemaDefViewEditForm JavaFX View/Edit Form implementation
 *	for SchemaDef.
 */
public class CFBamJavaFXSchemaDefViewEditForm
extends CFBorderPane
implements ICFBamJavaFXSchemaDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit SchemaDef";
	...
	public CFBamJavaFXSchemaDefViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamSchemaDefObj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamSchemaDefObj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getSchemaDefFactory().newViewEditPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXSchemaDefPaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamSchemaDefObj argFocus = (ICFBamSchemaDefObj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamSchemaDefObj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsSchemaDef() != null ) {
							if( null == getJavaFXFocusAsSchemaDef().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsSchemaDef();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXSchemaDefPaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXSchemaDefPaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
