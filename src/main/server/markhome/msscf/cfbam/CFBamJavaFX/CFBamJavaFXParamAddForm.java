// Description: Java 11 JavaFX Add Form implementation for Param.
...
/**
 *	CFBamJavaFXParamAddForm JavaFX Add Form implementation
 *	for Param.
 */
public class CFBamJavaFXParamAddForm
extends CFBorderPane
implements ICFBamJavaFXParamPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Param";
	...
	public CFBamJavaFXParamAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamParamObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getParamFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXParamPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getParamFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXParamPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXParamPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
