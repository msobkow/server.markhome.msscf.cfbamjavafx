// Description: Java 11 JavaFX Attribute Pane implementation for ClearTopDep.
 ...
 *	for ClearTopDep.
 */
public class CFBamJavaFXClearTopDepAttrPane
extends CFGridPane
implements ICFBamJavaFXClearTopDepPaneCommon
{
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamClearTopDepObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXClearTopDepAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamClearTopDepObj getEffJavaFXFocus() {
		ICFBamClearTopDepObj eff = (ICFBamClearTopDepObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamClearTopDepObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamClearTopDepObj popObj = getEffJavaFXFocus();
