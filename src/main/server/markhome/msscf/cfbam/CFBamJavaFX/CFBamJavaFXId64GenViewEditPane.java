// Description: Java 11 JavaFX View/Edit Pane implementation for Id64Gen.
...
/**
 *	CFBamJavaFXId64GenViewEditPane JavaFX View/Edit Pane implementation
 *	for Id64Gen.
 */
public class CFBamJavaFXId64GenViewEditPane
extends CFSplitPane
implements ICFBamJavaFXId64GenPaneCommon
{
	...
	public CFBamJavaFXId64GenViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus ) {
		super();
		...
		eltTabPane = argSchema.getId64GenFactory().newEltTabPane( cfFormManager, argFocus );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId64GenPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId64GenPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXId64GenPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
