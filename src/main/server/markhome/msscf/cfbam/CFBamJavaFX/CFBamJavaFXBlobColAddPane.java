// Description: Java 11 JavaFX Add Pane implementation for BlobCol.
...
/**
 *	CFBamJavaFXBlobColAddPane JavaFX Add Pane implementation
 *	for BlobCol.
 */
public class CFBamJavaFXBlobColAddPane
extends CFSplitPane
implements ICFBamJavaFXBlobColPaneCommon
{
	...
	public CFBamJavaFXBlobColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamBlobColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXBlobColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
