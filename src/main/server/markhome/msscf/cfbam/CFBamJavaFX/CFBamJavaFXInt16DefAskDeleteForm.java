// Description: Java 11 JavaFX Ask Delete Pane implementation for Int16Def.
...
/**
 *	CFBamJavaFXInt16DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for Int16Def.
 */
public class CFBamJavaFXInt16DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXInt16DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete Int16Def";
	...
	public CFBamJavaFXInt16DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this Int16Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamInt16DefObj obj = getJavaFXFocusAsInt16Def();
					ICFBamInt16DefEditObj editObj = (ICFBamInt16DefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getInt16DefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsInt16Def( ICFBamInt16DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXInt16DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXInt16DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
