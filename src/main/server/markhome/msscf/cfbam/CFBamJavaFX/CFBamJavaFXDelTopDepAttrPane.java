// Description: Java 11 JavaFX Attribute Pane implementation for DelTopDep.
 ...
 *	for DelTopDep.
 */
public class CFBamJavaFXDelTopDepAttrPane
extends CFGridPane
implements ICFBamJavaFXDelTopDepPaneCommon
{
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamDelTopDepObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXDelTopDepAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelTopDepObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamDelTopDepObj getEffJavaFXFocus() {
		ICFBamDelTopDepObj eff = (ICFBamDelTopDepObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamDelTopDepObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamDelTopDepObj popObj = getEffJavaFXFocus();
