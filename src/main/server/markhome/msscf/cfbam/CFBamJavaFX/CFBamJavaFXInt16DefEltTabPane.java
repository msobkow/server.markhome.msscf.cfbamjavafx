// Description: Java 11 JavaFX Element TabPane implementation for Int16Def.
...
/**
 *	CFBamJavaFXInt16DefEltTabPane JavaFX Element TabPane implementation
 *	for Int16Def.
 */
public class CFBamJavaFXInt16DefEltTabPane
extends CFTabPane
implements ICFBamJavaFXInt16DefPaneCommon
{
	...
	public CFBamJavaFXInt16DefEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamInt16DefObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamInt16DefObj focus = (ICFBamInt16DefObj)getJavaFXFocusAsInt16Def();
			if( focus != null ) {
