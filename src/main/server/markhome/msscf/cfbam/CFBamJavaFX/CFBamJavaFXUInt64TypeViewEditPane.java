// Description: Java 11 JavaFX View/Edit Pane implementation for UInt64Type.
...
/**
 *	CFBamJavaFXUInt64TypeViewEditPane JavaFX View/Edit Pane implementation
 *	for UInt64Type.
 */
public class CFBamJavaFXUInt64TypeViewEditPane
extends CFSplitPane
implements ICFBamJavaFXUInt64TypePaneCommon
{
	...
	public CFBamJavaFXUInt64TypeViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64TypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUInt64TypePaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXUInt64TypePaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXUInt64TypePaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
