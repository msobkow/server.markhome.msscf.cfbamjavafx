// Description: Java 11 JavaFX Add Pane implementation for NmTokensDef.
...
/**
 *	CFBamJavaFXNmTokensDefAddPane JavaFX Add Pane implementation
 *	for NmTokensDef.
 */
public class CFBamJavaFXNmTokensDefAddPane
extends CFSplitPane
implements ICFBamJavaFXNmTokensDefPaneCommon
{
	...
	public CFBamJavaFXNmTokensDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
