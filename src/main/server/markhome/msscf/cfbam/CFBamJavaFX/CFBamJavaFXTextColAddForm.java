// Description: Java 11 JavaFX Add Form implementation for TextCol.
...
/**
 *	CFBamJavaFXTextColAddForm JavaFX Add Form implementation
 *	for TextCol.
 */
public class CFBamJavaFXTextColAddForm
extends CFBorderPane
implements ICFBamJavaFXTextColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add TextCol";
	...
	public CFBamJavaFXTextColAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTextColObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getTextColFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXTextColPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getTextColFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTextColPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTextColPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
