// Description: Java 11 JavaFX Attribute Pane implementation for UInt64Def.
...
/**
 *	CFBamJavaFXUInt64DefAttrPane JavaFX Attribute Pane implementation
 *	for UInt64Def.
 */
public class CFBamJavaFXUInt64DefAttrPane
extends CFGridPane
implements ICFBamJavaFXUInt64DefPaneCommon
{
	...
	implements ICFBamJavaFXSchemaDefChosen
	{
		...
		public void choseSchemaDef( ICFBamSchemaDefObj value ) {
			if( javafxReferenceLookupDefSchema != null ) {
				ICFBamUInt64DefObj cur = getJavaFXFocusAsUInt64Def();
				if( cur != null ) {
					ICFBamUInt64DefEditObj editObj = (ICFBamUInt64DefEditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamUInt64DefObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXUInt64DefAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt64DefObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamUInt64DefObj getEffJavaFXFocus() {
		ICFBamUInt64DefObj eff = (ICFBamUInt64DefObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamUInt64DefObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamUInt64DefObj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamUInt64DefObj focus = getJavaFXFocusAsUInt64Def();
		ICFBamUInt64DefEditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamUInt64DefEditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamUInt64DefEditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamUInt64DefObj)editObj.create();
