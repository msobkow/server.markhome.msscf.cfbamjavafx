// Description: Java 11 JavaFX Ask Delete Pane implementation for TimeCol.
...
/**
 *	CFBamJavaFXTimeColAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TimeCol.
 */
public class CFBamJavaFXTimeColAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTimeColPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TimeCol";
	...
	public CFBamJavaFXTimeColAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TimeCol?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTimeColObj obj = getJavaFXFocusAsTimeCol();
					ICFBamTimeColEditObj editObj = (ICFBamTimeColEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getTimeColFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsTimeCol( ICFBamTimeColObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTimeColPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTimeColPaneCommon)attrPane).setPaneMode( value );
		}
	}
