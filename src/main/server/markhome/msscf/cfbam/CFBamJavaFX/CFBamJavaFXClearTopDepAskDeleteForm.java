// Description: Java 11 JavaFX Ask Delete Pane implementation for ClearTopDep.
...
/**
 *	CFBamJavaFXClearTopDepAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for ClearTopDep.
 */
public class CFBamJavaFXClearTopDepAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXClearTopDepPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete ClearTopDep";
	...
	public CFBamJavaFXClearTopDepAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearTopDepObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this ClearTopDep?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamClearTopDepObj obj = getJavaFXFocusAsClearTopDep();
					ICFBamClearTopDepEditObj editObj = (ICFBamClearTopDepEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsClearTopDep( ICFBamClearTopDepObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXClearTopDepPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXClearTopDepPaneCommon)attrPane).setPaneMode( value );
		}
	}
