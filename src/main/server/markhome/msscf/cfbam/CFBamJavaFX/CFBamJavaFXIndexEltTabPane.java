// Description: Java 11 JavaFX Element TabPane implementation for Index.
...
/**
 *	CFBamJavaFXIndexEltTabPane JavaFX Element TabPane implementation
 *	for Index.
 */
public class CFBamJavaFXIndexEltTabPane
extends CFTabPane
implements ICFBamJavaFXIndexPaneCommon
{
	...
	public CFBamJavaFXIndexEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamIndexObj argFocus ) {
		super();
	...
	public CFBorderPane getTabViewComponentsColumnsListPane() {
		if( tabViewComponentsColumnsListPane == null ) {
			...
			tabViewComponentsColumnsListPane = javafxSchema.getIndexColFactory().newListPane( cfFormManager, javafxContainer, null, dataCollection, new RefreshComponentsColumnsList(), true );
		}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( tabViewComponentsColumnsListPane != null ) {
			((ICFBamJavaFXIndexColPaneCommon)tabViewComponentsColumnsListPane).setPaneMode( value );
		}
	}
}
