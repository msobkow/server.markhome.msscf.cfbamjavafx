// Description: Java 11 JavaFX Add Form implementation for NmTokensType.
...
/**
 *	CFBamJavaFXNmTokensTypeAddForm JavaFX Add Form implementation
 *	for NmTokensType.
 */
public class CFBamJavaFXNmTokensTypeAddForm
extends CFBorderPane
implements ICFBamJavaFXNmTokensTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Add NmTokensType";
	...
	public CFBamJavaFXNmTokensTypeAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNmTokensTypeObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getNmTokensTypeFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXNmTokensTypePaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getNmTokensTypeFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNmTokensTypePaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXNmTokensTypePaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
