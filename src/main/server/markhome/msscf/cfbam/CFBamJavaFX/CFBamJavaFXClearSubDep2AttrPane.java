// Description: Java 11 JavaFX Attribute Pane implementation for ClearSubDep2.
...
/**
 *	CFBamJavaFXClearSubDep2AttrPane JavaFX Attribute Pane implementation
 *	for ClearSubDep2.
 */
public class CFBamJavaFXClearSubDep2AttrPane
extends CFGridPane
implements ICFBamJavaFXClearSubDep2PaneCommon
{
	...
	implements ICFBamJavaFXRelationChosen
	{
		...
		public void choseRelation( ICFBamRelationObj value ) {
			if( javafxReferenceLookupRelation != null ) {
				ICFBamClearSubDep2Obj cur = getJavaFXFocusAsClearSubDep2();
				if( cur != null ) {
					ICFBamClearSubDep2EditObj editObj = (ICFBamClearSubDep2EditObj)cur.getEdit();
					if( null != editObj ) {
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamClearSubDep2Obj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXClearSubDep2AttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamClearSubDep2Obj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamClearSubDep2Obj getEffJavaFXFocus() {
		ICFBamClearSubDep2Obj eff = (ICFBamClearSubDep2Obj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamClearSubDep2Obj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamClearSubDep2Obj popObj = getEffJavaFXFocus();
	...
	public void postFields()
	{
		...
		ICFBamClearSubDep2EditObj editObj;
		if( focus != null ) {
			editObj = (ICFBamClearSubDep2EditObj)(focus.getEdit());
		}
		else {
			editObj = null;
		}
		...
		switch( value ) {
					...
					case View:
						if( editObj == null ) {
							if( focus != null ) {
								...
								editObj = (ICFBamClearSubDep2EditObj)focus.beginEdit();
								if( editObj == null ) {
									throw new CFLibUsageException( getClass(),
										S_ProcName,
			...
			case Update:
				...
				if( editObj != null ) {
					postFields();
					if( editObj.getIsNew() ) {
						focus = (ICFBamClearSubDep2Obj)editObj.create();
