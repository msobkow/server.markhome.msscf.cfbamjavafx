// Description: Java 11 JavaFX Ask Delete Pane implementation for UInt32Def.
...
/**
 *	CFBamJavaFXUInt32DefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for UInt32Def.
 */
public class CFBamJavaFXUInt32DefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXUInt32DefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete UInt32Def";
	...
	public CFBamJavaFXUInt32DefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUInt32DefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this UInt32Def?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamUInt32DefObj obj = getJavaFXFocusAsUInt32Def();
					ICFBamUInt32DefEditObj editObj = (ICFBamUInt32DefEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsUInt32Def( ICFBamUInt32DefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXUInt32DefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXUInt32DefPaneCommon)attrPane).setPaneMode( value );
		}
	}
