// Description: Java 11 JavaFX Add Pane implementation for DelSubDep2.
...
/**
 *	CFBamJavaFXDelSubDep2AddPane JavaFX Add Pane implementation
 *	for DelSubDep2.
 */
public class CFBamJavaFXDelSubDep2AddPane
extends CFSplitPane
implements ICFBamJavaFXDelSubDep2PaneCommon
{
	...
	public CFBamJavaFXDelSubDep2AddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep2Obj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep2PaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
