// Description: Java 11 JavaFX View/Edit Pane implementation for StringCol.
...
/**
 *	CFBamJavaFXStringColViewEditPane JavaFX View/Edit Pane implementation
 *	for StringCol.
 */
public class CFBamJavaFXStringColViewEditPane
extends CFSplitPane
implements ICFBamJavaFXStringColPaneCommon
{
	...
	public CFBamJavaFXStringColViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamStringColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXStringColPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXStringColPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXStringColPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
