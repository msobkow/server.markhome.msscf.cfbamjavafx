// Description: Java 11 JavaFX Add Pane implementation for DateDef.
...
/**
 *	CFBamJavaFXDateDefAddPane JavaFX Add Pane implementation
 *	for DateDef.
 */
public class CFBamJavaFXDateDefAddPane
extends CFSplitPane
implements ICFBamJavaFXDateDefPaneCommon
{
	...
	public CFBamJavaFXDateDefAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDateDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDateDefPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
