// Description: Java 11 JavaFX Add Pane implementation for UuidType.
...
/**
 *	CFBamJavaFXUuidTypeAddPane JavaFX Add Pane implementation
 *	for UuidType.
 */
public class CFBamJavaFXUuidTypeAddPane
extends CFSplitPane
implements ICFBamJavaFXUuidTypePaneCommon
{
	...
	public CFBamJavaFXUuidTypeAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamUuidTypeObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXUuidTypePaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
