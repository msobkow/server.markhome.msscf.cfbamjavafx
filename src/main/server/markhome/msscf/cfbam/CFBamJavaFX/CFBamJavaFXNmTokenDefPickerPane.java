// Description: Java 11 JavaFX Picker of Obj Pane implementation for NmTokenDef.
...
/**
 *	CFBamJavaFXNmTokenDefPickerPane JavaFX Pick Obj Pane implementation
 *	for NmTokenDef.
 */
public class CFBamJavaFXNmTokenDefPickerPane
extends CFBorderPane
implements ICFBamJavaFXNmTokenDefPaneList
{
	public static String S_FormName = "Choose NmTokenDef";
	...
	protected ICFBamJavaFXNmTokenDefChosen invokeWhenChosen = null;
	protected ICFBamScopeObj javafxContainer = null;
	protected CFButton buttonCancel = null;
	protected CFButton buttonChooseNone = null;
	protected CFButton buttonChooseSelected = null;
	protected ScrollPane scrollMenu = null;
	public CFBamJavaFXNmTokenDefPickerPane( ICFFormManager formManager,
		...
		buttonChooseNone.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseNmTokenDef( null );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
		...
		buttonChooseSelected.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					...
					invokeWhenChosen.choseNmTokenDef( selectedInstance );
					cfFormManager.closeCurrentForm();
				}
				catch( Throwable t ) {
					CFConsole.formException( S_FormName, ((CFButton)e.getSource()).getText(), t );
