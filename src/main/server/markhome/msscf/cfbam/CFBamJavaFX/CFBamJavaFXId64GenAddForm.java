// Description: Java 11 JavaFX Add Form implementation for Id64Gen.
...
/**
 *	CFBamJavaFXId64GenAddForm JavaFX Add Form implementation
 *	for Id64Gen.
 */
public class CFBamJavaFXId64GenAddForm
extends CFBorderPane
implements ICFBamJavaFXId64GenPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add Id64Gen";
	...
	public CFBamJavaFXId64GenAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getId64GenFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXId64GenPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getId64GenFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXId64GenPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXId64GenPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
