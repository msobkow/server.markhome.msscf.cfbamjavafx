// Description: Java 11 JavaFX View/Edit Form implementation for DelSubDep1.
...
/**
 *	CFBamJavaFXDelSubDep1ViewEditForm JavaFX View/Edit Form implementation
 *	for DelSubDep1.
 */
public class CFBamJavaFXDelSubDep1ViewEditForm
extends CFBorderPane
implements ICFBamJavaFXDelSubDep1PaneCommon,
	ICFForm
{
	public static String S_FormName = "View/Edit DelSubDep1";
	...
	public CFBamJavaFXDelSubDep1ViewEditForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDelSubDep1Obj argFocus, ICFFormClosedCallback closeCallback, boolean cameFromAdd ) {
		super();
		...
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelSubDep1Obj)argFocus.read( true );
			javaFXFocus = argFocus;
		}
		javafxViewEditPane = argSchema.getDelSubDep1Factory().newViewEditPane( cfFormManager, argFocus );
	...
	public void forceCancelAndClose() {
		ICFBamDelSubDep1Obj focus = getJavaFXFocusAsDelSubDep1();
		if( focus != null ) {
			ICFBamDelSubDep1EditObj editObj = (ICFBamDelSubDep1EditObj)focus.getEdit();
			if( editObj != null ) {
				if( editObj.getIsNew() ) {
					editObj.endEdit();
					editObj = null;
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXDelSubDep1PaneCommon)javafxViewEditPane).setJavaFXFocus( value );
		ICFBamDelSubDep1Obj argFocus = (ICFBamDelSubDep1Obj)value;
		if( ( argFocus != null ) && ( ! argFocus.getIsNew() ) ) {
			argFocus = (ICFBamDelSubDep1Obj)argFocus.read( true );
		...
		if( hboxMenu == null ) {
			...
			buttonEdit.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						if( getJavaFXFocusAsDelSubDep1() != null ) {
							if( null == getJavaFXFocusAsDelSubDep1().getEdit() ) {
			...
			buttonClose.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						cfFormManager.closeCurrentForm();
						if( formClosedCallback != null ) {
							focus = getJavaFXFocusAsDelSubDep1();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXDelSubDep1PaneCommon)javafxViewEditPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXDelSubDep1PaneCommon)javafxViewEditPane).setPaneMode( oldMode );
			throw t;
		}
		adjustButtons();
	}
