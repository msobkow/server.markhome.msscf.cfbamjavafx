// Description: Java 11 JavaFX Add Form implementation for EnumDef.
...
/**
 *	CFBamJavaFXEnumDefAddForm JavaFX Add Form implementation
 *	for EnumDef.
 */
public class CFBamJavaFXEnumDefAddForm
extends CFBorderPane
implements ICFBamJavaFXEnumDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Add EnumDef";
	...
	public CFBamJavaFXEnumDefAddForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamEnumDefObj argFocus, ICFFormClosedCallback closeCallback, boolean argAllowSave ) {
		super();
		...
		javafxAddPane = argSchema.getEnumDefFactory().newAddPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocus( ICFLibAnyObj value ) {
		...
		((ICFBamJavaFXEnumDefPaneCommon)javafxAddPane).setJavaFXFocus( value );
			...
			buttonSave.setOnAction( new EventHandler<ActionEvent>() {
				@Override public void handle( ActionEvent e ) {
					...
					try {
						...
						CFBorderPane frame = javafxSchema.getEnumDefFactory().newViewEditForm( cfFormManager, focus, formClosedCallback, true );
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXEnumDefPaneCommon)javafxAddPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXEnumDefPaneCommon)javafxAddPane).setPaneMode( oldMode );
			throw t;
		}
