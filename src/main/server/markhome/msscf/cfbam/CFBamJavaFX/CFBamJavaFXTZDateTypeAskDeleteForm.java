// Description: Java 11 JavaFX Ask Delete Pane implementation for TZDateType.
...
/**
 *	CFBamJavaFXTZDateTypeAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for TZDateType.
 */
public class CFBamJavaFXTZDateTypeAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXTZDateTypePaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete TZDateType";
	...
	public CFBamJavaFXTZDateTypeAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateTypeObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this TZDateType?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamTZDateTypeObj obj = getJavaFXFocusAsTZDateType();
					ICFBamTZDateTypeEditObj editObj = (ICFBamTZDateTypeEditObj)obj.beginEdit();
	...
	public void setJavaFXFocusAsTZDateType( ICFBamTZDateTypeObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXTZDateTypePaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXTZDateTypePaneCommon)attrPane).setPaneMode( value );
		}
	}
