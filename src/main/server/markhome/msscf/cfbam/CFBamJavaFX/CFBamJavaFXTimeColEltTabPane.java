// Description: Java 11 JavaFX Element TabPane implementation for TimeCol.
...
/**
 *	CFBamJavaFXTimeColEltTabPane JavaFX Element TabPane implementation
 *	for TimeCol.
 */
public class CFBamJavaFXTimeColEltTabPane
extends CFTabPane
implements ICFBamJavaFXTimeColPaneCommon
{
	...
	public CFBamJavaFXTimeColEltTabPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimeColObj argFocus ) {
		super();
	...
	implements ICFRefreshCallback
	{
		...
		public void refreshMe() {
			...
			ICFBamTimeColObj focus = (ICFBamTimeColObj)getJavaFXFocusAsTimeCol();
			if( focus != null ) {
