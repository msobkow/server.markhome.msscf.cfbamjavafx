// Description: Java 11 JavaFX Ask Delete Pane implementation for DoubleDef.
...
/**
 *	CFBamJavaFXDoubleDefAskDeleteForm JavaFX Ask Delete Pane implementation
 *	for DoubleDef.
 */
public class CFBamJavaFXDoubleDefAskDeleteForm
extends CFBorderPane
implements ICFBamJavaFXDoubleDefPaneCommon,
	ICFForm
{
	public static String S_FormName = "Ask Delete DoubleDef";
	...
	public CFBamJavaFXDoubleDefAskDeleteForm( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamDoubleDefObj argFocus, ICFDeleteCallback callback ) {
		super();
		...
		textAreaMessage.setText( "Are you sure you want to delete this DoubleDef?" );
		...
		buttonOk.setOnAction( new EventHandler<ActionEvent>() {
			@Override public void handle( ActionEvent e ) {
				...
				try {
					ICFBamDoubleDefObj obj = getJavaFXFocusAsDoubleDef();
					ICFBamDoubleDefEditObj editObj = (ICFBamDoubleDefEditObj)obj.beginEdit();
		...
		attrPane = argSchema.getDoubleDefFactory().newAttrPane( cfFormManager, argFocus );
	...
	public void setJavaFXFocusAsDoubleDef( ICFBamDoubleDefObj value ) {
		javaFXFocus = value;
		if( attrPane != null ) {
			((ICFBamJavaFXDoubleDefPaneCommon)attrPane).setJavaFXFocus( value );
		}
	}
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		if( attrPane != null ) {
			((ICFBamJavaFXDoubleDefPaneCommon)attrPane).setPaneMode( value );
		}
	}
