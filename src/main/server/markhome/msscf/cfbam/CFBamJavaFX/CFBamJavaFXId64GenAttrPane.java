// Description: Java 11 JavaFX Attribute Pane implementation for Id64Gen.
 ...
 *	for Id64Gen.
 */
public class CFBamJavaFXId64GenAttrPane
extends CFGridPane
implements ICFBamJavaFXId64GenPaneCommon
{
	...
	implements ICFReferenceCallback
	{
		public void chose( ICFLibAnyObj value ) {
			...
			ICFBamId64GenObj focus = getEffJavaFXFocus();
	...
	public CFBamJavaFXId64GenAttrPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamId64GenObj argFocus ) {
		super();
		Control ctrl;
		CFLabel label;
	...
	public ICFBamId64GenObj getEffJavaFXFocus() {
		ICFBamId64GenObj eff = (ICFBamId64GenObj)getJavaFXFocus();
		if( eff != null ) {
			if( null != eff.getEdit() ) {
				eff = (ICFBamId64GenObj)eff.getEdit();
			}
		}
		return( eff );
	}
	...
	{
		ICFBamId64GenObj popObj = getEffJavaFXFocus();
