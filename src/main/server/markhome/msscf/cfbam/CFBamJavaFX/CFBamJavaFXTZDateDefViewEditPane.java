// Description: Java 11 JavaFX View/Edit Pane implementation for TZDateDef.
...
/**
 *	CFBamJavaFXTZDateDefViewEditPane JavaFX View/Edit Pane implementation
 *	for TZDateDef.
 */
public class CFBamJavaFXTZDateDefViewEditPane
extends CFSplitPane
implements ICFBamJavaFXTZDateDefPaneCommon
{
	...
	public CFBamJavaFXTZDateDefViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTZDateDefObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTZDateDefPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXTZDateDefPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXTZDateDefPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
