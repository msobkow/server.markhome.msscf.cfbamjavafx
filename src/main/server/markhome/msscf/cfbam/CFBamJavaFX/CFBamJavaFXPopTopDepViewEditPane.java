// Description: Java 11 JavaFX View/Edit Pane implementation for PopTopDep.
...
/**
 *	CFBamJavaFXPopTopDepViewEditPane JavaFX View/Edit Pane implementation
 *	for PopTopDep.
 */
public class CFBamJavaFXPopTopDepViewEditPane
extends CFSplitPane
implements ICFBamJavaFXPopTopDepPaneCommon
{
	...
	public CFBamJavaFXPopTopDepViewEditPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamPopTopDepObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXPopTopDepPaneCommon)eltTabPane).setPaneMode( value );
		}
		catch( Throwable t ) {
			super.setPaneMode( oldMode );
			((ICFBamJavaFXPopTopDepPaneCommon)attrPane).setPaneMode( oldMode );
			((ICFBamJavaFXPopTopDepPaneCommon)eltTabPane).setPaneMode( oldMode );
			throw t;
		}
	}
}
