// Description: Java 11 JavaFX Add Pane implementation for NumberCol.
...
/**
 *	CFBamJavaFXNumberColAddPane JavaFX Add Pane implementation
 *	for NumberCol.
 */
public class CFBamJavaFXNumberColAddPane
extends CFSplitPane
implements ICFBamJavaFXNumberColPaneCommon
{
	...
	public CFBamJavaFXNumberColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamNumberColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXNumberColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
