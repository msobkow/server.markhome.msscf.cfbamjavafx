// Description: Java 11 JavaFX Add Pane implementation for TimestampCol.
...
/**
 *	CFBamJavaFXTimestampColAddPane JavaFX Add Pane implementation
 *	for TimestampCol.
 */
public class CFBamJavaFXTimestampColAddPane
extends CFSplitPane
implements ICFBamJavaFXTimestampColPaneCommon
{
	...
	public CFBamJavaFXTimestampColAddPane( ICFFormManager formManager, ICFBamJavaFXSchema argSchema, ICFBamTimestampColObj argFocus ) {
		super();
	...
	public void setPaneMode( CFPane.PaneMode value ) {
		...
		try {
			...
			((ICFBamJavaFXTimestampColPaneCommon)attrPane).setPaneMode( oldValue );
			throw t;
		}
	}
}
